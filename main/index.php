        ...
        <div id="main-aplikasi">
            ...
            <div id="content" style="visibility: hidden; clear: both ;">
                ...
                <div id="metro-sections-container" class="metro" style="height:calc(100% - 114px);">
                    ...
                    <div class="metro-sections" style="height:calc(100% - 100px);" >
                        <!-- <div class="metro-section ko_container ui-sortable"> -->
                        <div class="metro-section ko_container ui-sortable"  data-bind="sortable: { data: tiles }">
                            <?php if ($userLogin->aksesPegawai == 'YES') { ?>
                            <div id="simpeg" class="tile  bg-color-white">
                                <div class="tile-icon-large ">
                                    <a href="../simpeg/index.php"><img src="../WEB-INF/images/app-simpeg.jpg"></a>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div id="keuangan" class="tile  bg-color-white">
                                <div class="tile-icon-large ">
                                    <a href="../keuangan/index.php"><img src="../WEB-INF/images/app-keuangan.jpg"></a>
                                </div>
                            </div>
                            <?php } ?>
                            <?php if ($userLogin->aksesFixedAsset == 'YES') { ?>
                            <div id="inventaris" class="tile  bg-color-white">
                                <div class="tile-icon-large ">
                                    <a href="../inventaris/index.php"> <img src="../WEB-INF/images/app-inventaris.jpg"></a>
                                </div>
                            </div>
                            <?php } ?>
                            <?php if ($userLogin->aksesPembayaran == 'YES') { ?>
                            <div id="pembayaran" class="tile  bg-color-white">
                                <div class="tile-icon-large ">
                                    <a href="../pembayaran/index.php"><img src="../WEB-INF/images/app-pembayaran.jpg"></a>
                                </div>
                            </div>
                            <?php } ?>
                            <?php if ($userLogin->aksesPengaturan == 'YES') { ?>
                            <div id="pengaturan" class="tile  bg-color-white">
                                <div class="tile-icon-large ">
                                    <a href="../intranet/index.php"><img src="../WEB-INF/images/app-pengaturan.jpg"></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
