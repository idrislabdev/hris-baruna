...
<div id="kontainer" style="background:#383838;">
    ...
    <div id="side-kiri-main">
    	<div class="logo-pel-main"><a href="index.php"><img src="../WEB-INF/images/logo-pel-main.png" /></a></div>
    ...
    <div id="side-kanan-main">
    	<div id="main-informasi">
        	<div id="main-berita">
            	<div class="main-informasi-judul">Berita Terbaru <span><a href="#" class="md-trigger md-setperspective" data-modal="modal-berita" title="lihat semua berita"><img src="../WEB-INF/images/panah-judul-main.png" /></a></span></div>
                <?
            ...
            <?php /*?><div class="md-overlay"></div><!-- the overlay element -->
            <div class="md-modal md-effect-19" id="modal-berita">
                <div class="md-content" style="width:100%; height:600px;">
                    <h3>Berita</h3>
                    <div>
