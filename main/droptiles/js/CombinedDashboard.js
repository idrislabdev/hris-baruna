...
window.TileBuilders = {
    ...
    simpeg: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "simpeg",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-simpeg.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../simpeg/index.php'"
        };
    },
    
    penghasilan: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "penghasilan",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-pelaporan.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-penghasilan.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../penghasilan/index.php'"
        };
    },
    
    presensi: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "presensi",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-operasional.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-presensi.png',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../presensi/index.php'"
        };
    },
    
    pembayaran: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "anggaran",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-operasional.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-pembayaran.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../pembayaran/index.php'"
        };
    },

    keuangan: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "keuangan",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-operasional.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-keuangan.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../keuangan/index.php'"
        };
    },
    ...
    pengaturan: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-operasional.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-pengaturan.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../intranet/index.php'"
        };
    },

    inventaris: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "inventaris",
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB-INF/images/app-operasional.jpg'></div>",
            iconSrc: '../WEB-INF/images/app-inventaris.jpg',
            //appUrl: 'gaji/index.php'
            appUrl: "javascript:top.document.location.href='../inventaris/index.php'"
        };
    },
