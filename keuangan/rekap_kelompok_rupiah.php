...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rekap_kelompok_rupiah_rpt.php?reqPeriode='+ $("#reqPeriode").val()+'&reqUmurPiutang='+ $("#reqUmurPiutang").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rekap_kelompok_rupiah_excel.php?reqPeriode='+ $("#reqPeriode").val()+'&reqUmurPiutang='+ $("#reqUmurPiutang").val(), 'Cetak');
				newWindow.focus();
			  });
	});
</script>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekapitulasi Aging Piutang Aktif Per Debitur (Rupiah)</span>
            </div>            
            </td>
        </tr>
    </table>
	...
	<table>  
        ...
        <tr>           
             <td>Peny. Umur Piutang</td>
			 <td>
             	<input type="text" style="width:100px;" name="reqUmurPiutang" id="reqUmurPiutang" value="0">
             </td>			
        </tr> 
        <tr>
