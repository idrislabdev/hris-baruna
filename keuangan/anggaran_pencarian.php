...
<title>anggaran pencarian</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-anggaran/anggaran_pencarian_json.php",
			...
			/* Click event handler */
			  ...
			  var anSelectedData = '';
			  var anSelectedId = '';
			  var anSelectedBukuPusat = '';
			  var anSelectedPosition = '';
			  
			  var anSelectedNama = '';
			  var anSelectedBukuBesar = '';
			  var anSelectedEmail = '';
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedBukuPusat = element[2];
					  anSelectedBukuBesar = element[4];
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSet(anSelectedId, anSelectedBukuPusat, anSelectedBukuBesar);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Anggaran</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Jumlah&nbsp;Triwulan&nbsp;I</th>
            <th width="100px">Jumlah&nbsp;Triwulan&nbsp;II</th>
            <th width="100px">Jumlah&nbsp;Triwulan&nbsp;III</th>
            <th width="100px">Jumlah&nbsp;Triwulan&nbsp;IV</th>
        </tr>
    </thead>
    </table>
    </div>    
