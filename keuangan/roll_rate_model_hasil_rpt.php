...
//------  Variables ------
$file_name	= "HASIL_PERHITUNGAN_PENYISIHAN_PIUTANG";
...
$zz = $creport->ParameterFields(1)->SetCurrentValue($reqBulan);
$zz = $creport->ParameterFields(2)->SetCurrentValue($reqKdValuta);
$zz = $creport->ParameterFields(3)->SetCurrentValue($reqTahun);
...
$name = $file_name."_".$reqKdValuta."_".$reqBulan."_".$reqTahun.".pdf";
