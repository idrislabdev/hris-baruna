...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-keuangansiuk/jurnal_pengeluaran_barang_gudang_add.php',
				onSubmit:function(){
				...
				success:function(data){
					...
					document.location.href = 'jurnal_pengeluaran_barang_gudang_add.php?reqId='+data[0];
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Jurnal Pengeluaran Barang Gudang (JPP)</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
            ...
            <td>Valuta</td>
			 <td>
				 <select name="reqValutaNama" id="reqValutaNama" tabindex="6">
                <?
        ...
        <tr>           
			 ...
			 <td>
				<input name="reqBuktiPendukung" id="reqBuktiPendukung" class="easyui-validatebox" style="width:150px" type="text" value="<?=$tempBuktiPendukung?>" tabindex="1"/>&nbsp;&nbsp;
                Bukti&nbsp;Pendukung 2 <input name="reqBuktiPendukung2" class="easyui-validatebox" style="width:150px" type="text" value="<?=$tempBuktiPendukung2?>" tabindex="2"/>
			</td>
            <td>Kurs&nbsp;Valuta</td>
			 <td>
        ...
        <tr>           
            ...
            <td>No Faktur Pajak</td>
			 <td>
				<input name="reqNoFakturPajak" class="easyui-validatebox" style="width:150px" type="text" value="<?=$tempNoFakturPajak?>" tabindex="7"/>
			</td>
        </tr>
        <tr>           
        ...
        <tr>           
			 ...
			 <td>
  	  	        <textarea name="reqUraian" id="reqUraian" style="width:433px; height:80px;" tabindex="5"><?=$tempUraian?></textarea>
			</td>
            <td valign="top">Keterangan</td>
			 <td>
				<textarea name="reqKeteranganJurnal" style="width:400px; height:80px;" tabindex="8"><?=$tempKeteranganJurnal?></textarea>
   			</td>
        </tr>
        </thead>
    </table>
          ...
          ?>
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    "
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_BUKU_BESAR")?>" style="width:208px" />
                  </td>
                  <td>
                    ...
                    "
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_SUB_BANTU")?>" style="width:208px" />
                  </td>
                  <td>
                    ...
                    "
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_BUKU_PUSAT")?>" style="width:208px" />
                  </td>
                  <td>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    validType:['exists[\'#reqBukuPusat<?=$checkbox_index?>\']']<?php */?>
                    "
                    value="" style="width:208px" tabindex="11"/>
                  </td>
                  <td>
                    <input type="text" name="reqKeterangan[]" class="easyui-validatebox" style="width:98%;" tabindex="12"/>
                  </td>
                  <td>
                    <input type="text" name="reqDebet[]" id="reqDebet<?=$checkbox_index?>" style="text-align:right;" OnFocus="FormatAngka('reqDebet<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqDebet<?=$checkbox_index?>'); hitungDebetTotal('dataTableRowDinamis');setTimeout(setCheckBalance, 1000);" OnBlur="FormatUang('reqDebet<?=$checkbox_index?>')" tabindex="13"/>
                  </td>
                  <td>
                    <input type="text" name="reqKredit[]" id="reqKredit<?=$checkbox_index?>" style="text-align:right;" OnFocus="FormatAngka('reqKredit<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqKredit<?=$checkbox_index?>'); hitungKreditTotal('dataTableRowDinamis');setTimeout(setCheckBalance, 1000);" OnBlur="FormatUang('reqKredit<?=$checkbox_index?>')" tabindex="14"/>
                  </td>
                  <td align="center">
                  <label>
                  <a style="cursor:pointer" onclick="deleteRowDrawTablePhp('dataTableRowDinamis', this)"><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a>
