...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			sDeleteURL: "../json-keuangansiuk/delete.php?reqMode=jurnal_pengeluaran_kas_bank",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
			   ...
			   $('#btnHapus').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-keuangansiuk/delete.php?reqMode=jurnal_pengeluaran_kas_bank&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, function (data) 
					{
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-keuangansiuk/jurnal_pengeluaran_kas_bank_json.php?reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Pengeluaran Kas - Bank</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" id="btnCopyJurnal" title="Copy Jurnal">Copy Jurnal</a>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Kurs&nbsp;Valuta</th>   
            <th width="100px">Jumlah</th>
            <th width="70px">No&nbsp;Posting</th>  
