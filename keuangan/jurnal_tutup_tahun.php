...
<title>jurnal tutup tahun</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/jurnal_tutup_tahun_json.php",			  
			...
			$("#btnRincianJurnal").click();	
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
			       ...
			       if(anSelectedNoPosting == '')
					  window.parent.OpenDHTML('jurnal_tutup_tahun_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
		  	      else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KBBT_JUR_BB&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=JURNAL_JRR_TUTUP&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  $('#btnCetakBuktiJurnal').on('click', function () {
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Rupa-Rupa (JRR) Untuk Tutup Tahun</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jurnal_tutup_tahun_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <?php /*?><a href="#" id="btnCetakBuktiJurnal" title="Cetak Bukti Jurnal">Cetak Bukti Jurnal</a><?php */?>
    ...
    <thead>
        <tr>
            ...
            <th width="120px">Tanggal&nbsp;Transaksi</th>
