...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_posting_ajp_ajt_json.php?reqJurnal=<?=$reqJurnal?>&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			sDeleteURL: "../json-keuangansiuk/delete.php?reqMode=proses_posting_ajp_ajt",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('proses_posting_ajp_ajt_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $("#reqJurnal").change(function() { 
				 ...
				 if($('#reqTanggalAkhirAproval').datebox('getValue').length == 10)
					...
					oTable.fnReloadAjax("../json-keuangansiuk/proses_posting_ajp_ajt_json.php?reqJurnal=" + val_jurnal + "&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/proses_posting_ajp_ajt_json.php?reqJurnal="+ $("#reqJurnal").val());
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
<?php /*?>            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('proses_posting_ajp_ajt_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
