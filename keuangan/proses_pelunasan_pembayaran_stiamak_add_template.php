...
$kptt_nota_d->selectDaftarTagihanSPPKelas(array("KD_SUB_BANTU" => $reqId, "A.DEPARTEMEN_ID" => "16"));
$kptt_nota_d->firstRow();
if($kptt_nota_d->getField("NO_NOTA") == "")
{
?>
<tr>
	<td colspan="8" align="center" style="color:#FF0004; font-size:13px"><span class="blink"><strong> KARTU <?=$reqId?> DENGAN NOMINAL <?=numberToIna($reqNilai)?> TIDAK MEMILIKI TAGIHAN</strong></span></td>
</tr>
<?	
}
else
