...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
                $('#btnCetak').live('click', function () {
                    /*$.getJSON('penjualan_non_tunai_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(),
                    function(data){
                    ...
                    newWindow = window.open('penjualan_non_tunai_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
                    newWindow.focus();                
                    window.parent.divwin.close();   
                });
                $('#btnCetakPdf').live('click', function () {
                    newWindow = window.open('jurnal_penjualan_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val(), 'Pdf');
                    newWindow.focus();  
               ...
               $('#btnExcel').live('click', function () {
                    newWindow = window.open('penjualan_non_tunai_excel.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Cetak');
                    newWindow.focus();  
                    window.parent.divwin.close();       
              });
              
              $('#btnCetakPreview').live('click', function () {
                    OpenDHTMLPopup('penjualan_non_tunai_preview.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Rincian Jurnal', 900, 600)    
              });
...
<div id="wadah">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Bukti Transaski SBPP (JPJ)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <?php /*?><input type="button" id="btnExcel" value="Excel"><?php */?>
