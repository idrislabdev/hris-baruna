...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pembatalan_sudah_cetak_pencarian_json.php?reqId=<?=$reqId?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedNoPel = element[0];
					  anSelectedNama = element[1];
					  anSelectedBadanUsaha = element[2];
					  anSelectedId = element[3];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPPKB(anSelectedId, anSelectedNoPel, anSelectedNama, anSelectedBadanUsaha);	
