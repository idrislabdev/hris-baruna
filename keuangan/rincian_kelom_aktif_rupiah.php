...
<title>rincian kelom aktif rupiah</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rincian_kelom_aktif_rupiah_rpt.php?reqPeriode='+ $("#reqPeriode").val()+'&reqKelompok='+ $("#reqKelompok").val()+'&reqKartu='+ $("#reqKartu").val()+'&reqSdKartu='+ $("#reqSdKartu").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  
			   $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rincian_kelom_aktif_rupiah_excel.php?reqPeriode='+ $("#reqPeriode").val()+'&reqKelompok='+ $("#reqKelompok").val()+'&reqKartu='+ $("#reqKartu").val()+'&reqSdKartu='+ $("#reqSdKartu").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Piutang Aktif Per Debitur / Kelompok Usaha (Rupiah)</span>
            </div>            
            </td>
        </tr>
    </table>
