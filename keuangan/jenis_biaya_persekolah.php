    ...
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				$.getJSON('../json-keuangansiuk/jenis_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('jenis_biaya_persekolah_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});					
			  });	
			   ...
			   $('#btnExcel').live('click', function () {
				$.getJSON('../json-keuangansiuk/jenis_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('jenis_biaya_kompar_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});					
			  });	
	});
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Perhitungan Laba Rugi Komparatif Menurut Jenis Biaya</span>
            </div>            
            </td>
        </tr>
    </table>
