...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			var header=headerHalaman=headerDetil=isiValue="";
			...
			header+="                                                        HALAMAN       : ";
			//header+=nomor_halaman+"\n";
			headerHalaman+="                             BUKTI PENERIMAAN KAS-BANK\n";
			headerHalaman+="                            =============================\n";
			headerHalaman+="   NO BUKTI  : <?=$reqNoBukti?>                                         TANGGAL  : <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>\n";
			headerHalaman+=" |==========================================================================================   |\n";
			rowHeader=7;
			
			//header="   PT. PELINDO MARINE SERVICE                           REPORT ID.    : KBB_BKT_JKK_ENTRY.PR\n";rowHeader++;
//			header+="   ------------------------                             TGL.PROSES    : <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>\n";rowHeader++;
//			header+="                                                        HALAMAN       : "+nomor_halaman+"\n";rowHeader++;
//			header+="                             BUKTI PENERIMAAN KAS-BANK\n";rowHeader++;
//			header+="                            =============================\n";rowHeader++;
//			header+="   NO BUKTI  : <?=$reqNoBukti?>                                         TANGGAL  : <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>\n";rowHeader++;
//			header+=" |==========================================================================================   |\n";rowHeader++;
			
			var temp= " | 1. Pemegang Kas Harap membayarkan uang sebesar ";
			headerDetil=fillStringCompletor(temp,"37"," ",":");
			temp+= "Rp. <?=numberToIna($arrData[0]["JML_RP_TRANS"])?>";
			headerDetil=fillStringCompletor(temp,"95"," ","|")+"\n";rowHeaderDetil++;
			
			//headerDetil=fillStringCompletor(" | 1. Pemegang Kas Harap membayarkan uang sebesar        :Rp. <?=numberToIna($arrData[0]["JML_RP_TRANS"])?>","96"," ","|")+"\n";rowHeaderDetil++;
			//var result = splitIntoLines(' | 2. Terbilang        : <?=terbilang($arrData[0]["JML_RP_TRANS"])." Rupiah"?>  ', 48);
			
			// total lebar = 96
			temp= " | 2. Terbilang";
			temp=fillStringCompletor(temp,"21"," ",":");
			temp+= "<?=terbilang($arrData[0]["JML_RP_TRANS"])." Rupiah"?>";
			...
			for (var i = 0; i < result.length; i++)
			{
				if(i == 0)
				{
					//if(result.length > 1)
//					{
//						headerDetil+=" "+fillStringCompletor(result[i], "94"," ","|")+"\n";
//						//alert(" "+fillStringCompletor(result[i], "94"," ","|"));
//					}
//					else
//					{
//						headerDetil+=" "+fillStringCompletor(result[i], "95"," ","")+"\n";
//						//alert(" "+fillStringCompletor(result[i], "95"," ",""));
//					}
			...
			temp= " | 3. Kepada";
			temp=fillStringCompletor(temp,"21"," ",":");
			temp+= "<?=$arrData[0]["NM_AGEN_PERUSH"]?>";
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			headerDetil+=temp+"\n";rowHeaderDetil++;
			//headerDetil+=fillStringCompletor(" | 3. Kepada           : <?=$arrData[0]["NM_AGEN_PERUSH"]?>","96"," ","|")+"\n";rowHeaderDetil++;
			//alert(temp);
			
			temp= " | 4. Alamat";
			temp=fillStringCompletor(temp,"21"," ",":");
			temp+= "<?=$arrData[0]["ALMT_AGEN_PERUSH"]?>";
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			headerDetil+=temp+"\n";rowHeaderDetil++;
			//headerDetil+=fillStringCompletor(" | 4. Alamat           : <?=$arrData[0]["ALMT_AGEN_PERUSH"]?>","96"," ","|")+"\n";rowHeaderDetil++;
			
			temp= " | 5. Uraian";
			temp=fillStringCompletor(temp,"21"," ",":");
			temp+= "<?=$arrData[0]["KETERANGAN_UTAMA"]?>";
			temp=fillStringCompletor(temp,"95"," ","");
			var result = splitIntoLines(temp, 95);
...
//			}
			...
			temp=fillStringCompletor(temp,"21"," ",":");
			temp+= "<?=$arrData[0]["BUKTI_PENDUKUNG"]?>";
			temp=fillStringCompletor(temp,"95"," ","|")+"\n";rowHeaderDetil++;
			headerDetil+=temp;
			//headerDetil+=fillStringCompletor(" | 6. Bukti Pendukung  : <?=$arrData[0]["BUKTI_PENDUKUNG"]?>                        Tanggal, <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>","96"," ","|")+"\n";rowHeaderDetil++;
			alert(temp);*/
			...
			tempDetil= temp+"Tanggal, <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>";
			...
			temp= " |";
			temp=fillStringCompletor(temp,"93","-","");
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			headerDetil+=temp+"\n";rowHeaderDetil++;
...
//				alert(temp+'--'+panjangTemp);
				...
				temp= " |";
				temp=fillStringCompletor(temp,"9"," ","");
				//temp+= "<?=$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar.$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar." ".$tempNamaBukuBesar?>";
				temp+= "<?=$tempNamaBukuBesar?>";
				temp=fillStringCompletor(temp,"95"," ","");
...
//				}
			...
			temp+="RP";
			temp=fillStringCompletor(temp,"50"," ","");
			temp+="<?=numberToIna($arrData[0]["JML_RP_TRANS"])?>";
			temp=fillStringCompletor(temp,"65"," ","");
			temp=fillStringCompletor(temp,"80"," ","");
			temp+="<?=numberToIna($arrData[0]["JML_RP_TRANS"])?>";
			temp=fillStringCompletor(temp,"95"," ","|");
			...
			temp=fillStringCompletor(temp,"68"," ","");
			temp+="SURABAYA, <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>";
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			isiValue+=temp+"\n";
