...
<div id="wadah">
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
            ...
            <td>Tanggal Valuta</td>
			 <td>
             	<input id="reqTanggalValuta" name="reqTanggalValuta" style="width:109px" readonly value="<?=$tempTanggalValuta?>" />
                <input name="reqNoBukti" class="easyui-validatebox" readonly style="width:290px" type="text" value="<?=$tempNoBukti?>" />
			</td>
        </tr>
        <tr>           
             <td>No Ref</td>
			 <td>
                ...
                &nbsp;&nbsp;
            	No Ref 2
                <input name="reqNoRefLain" class="easyui-validatebox" style="width:111px" type="text" value="<?=$tempNoRefLain?>" />
			</td>
            <td>Nama Kapal</td>
			 <td>
             	<input id="reqKodeKapal" name="reqKodeKapal" class="easyui-validatebox" style="width:109px" value="<?=$tempKodeKapal?>" />
        ...
        <tr>           
			 ...
			 <td>
				...
				<input name="reqPelanggan" id="reqPelanggan" readonly class="easyui-validatebox" style="width:300px" type="text" value="<?=$tempPelanggan?>" />  
                <input name="reqBadanUsaha" id="reqBadanUsaha" type="hidden" value="<?=$tempBadanUsaha?>">      
			</td>
            <td>Kode Bank</td>
			 <td>
             	<input id="reqKodeBank" name="reqKodeBank" class="easyui-validatebox" style="width:109px" value="<?=$tempKodeBank?>" />
        ...
        <tr>
        	<td>Tanggal Transaksi</td>
			 <td>
                ...
                &nbsp;&nbsp;
                Tanggal Val Pajak
                <input id="reqTanggalValutaPajak" name="reqTanggalValutaPajak" style="width:110px;" readonly value="<?=$tempTanggalValutaPajak?>" />
			</td>
            <td>Jumlah Tagihan</td>
			 <td>
             	<input id="reqJumlahTagihan" name="reqJumlahTagihan" class="easyui-validatebox" style="width:145px" OnFocus="FormatAngka('reqJumlahTagihan')" OnKeyUp="FormatUang('reqJumlahTagihan')" OnBlur="FormatUang('reqJumlahTagihan')" value="<?=numberToIna($tempJumlahTagihan)?>" />
                &nbsp; &nbsp;
                Jumlah Upper
                <input id="reqJumlahUpper" name="reqJumlahUpper" class="easyui-validatebox" readonly style="width:145px" OnFocus="FormatAngka('reqJumlahUpper')" OnKeyUp="FormatUang('reqJumlahUpper')" OnBlur="FormatUang('reqJumlahUpper')" value="<?=numberToIna($tempJumlahUpper)?>" />
			</td>
        </tr>
        <tr>
            <td>Kurs&nbsp;Valuta</td>
			<td>
            	<input name="reqKursValuta" id="reqKursValuta" class="easyui-validatebox"  style="width:110px" type="text" value="<?=$tempKursValuta?>" readonly />
                &nbsp;&nbsp;
                Kurs Pajak&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="reqKursPajak" id="reqKursPajak" class="easyui-validatebox" maxlength="3" style="width:110px" type="text" value="<?=$tempKursPajak?>" readonly />
			</td>
            <td>Keterangan Tambahan</td>
            <td>
				<input name="reqKeterangan" class="easyui-validatebox" style="width:410px" type="text" value="<?=$tempKeterangan?>" />
            </td>
        </tr>
        <tr>
            <td>Kode Valuta</td>
			<td>
                ...
                &nbsp;&nbsp;
                Tahun
                <input id="reqTahun" name="reqTahun" class="easyui-validatebox" data-options="validType:'minLength[4]'" maxlength="4" style="width:40px" value="<?=$tempTahun?>" readonly />
                <input id="reqBulan" name="reqBulan" class="easyui-validatebox" data-options="validType:'minLength[2]'" maxlength="2" style="width:20px" value="<?=$tempBulan?>" readonly />
                &nbsp;&nbsp;
                Materai
	            <select name="reqMateraiPilih" id="reqMateraiPilih">
            ...
            <td>
            	<input name="reqTanggalPosting" readonly style="width:145px;" value="<?=$tempTanggalPosting?>" />
                &nbsp;&nbsp;
                No&nbsp;Posting
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              <td>
              	<select name="reqKlasTrans[]" id="reqKlasTrans<?=$checkbox_index?>" onChange="ambilReferensiKlasTrans('<?=$checkbox_index?>')">
                <?
              ...
              <td>
              	<input type="text" name="reqPajak[]" id="reqPajak<?=$checkbox_index?>" class="easyui-validatebox" value="<?=$kptt_nota_d->getField("STATUS_KENA_PAJAK")?>" />
              </td>
              <td>
              ...
              <td>
              	<input type="text" name="reqKeteranganTambah[]" style="width:98%;" class="easyui-validatebox" readonly value="<?=$kptt_nota_d->getField("KET_TAMBAHAN")?>" />
              </td>
              <td align="center">
              <label>
        ...
        <tfoot class="altrowstable">
        	<tr style="background:#f1f4fc">
            	<td colspan="3">&nbsp;</td>
            	<td><input type="text" id="reqJumlahTrans" name="reqJumlahTrans" style="text-align:right;" readonly value="<?=numberToIna($temp_jml_trans)?>" />
                	</td>
            	<td style="text-align:right">Jumlah Pajak <input type="text" id="reqJumlahPajak" name="reqJumlahPajak" style="text-align:right;" readonly value="<?=numberToIna($temp_jml_pajak)?>" />&nbsp;
                    </td>
            	<td>&nbsp;</td>
            </tr>
        </tfoot>
