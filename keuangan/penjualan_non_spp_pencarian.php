...
$reqJenisTransaksi = httpFilterGet("reqJenisTransaksi");
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/penjualan_non_spp_pencarian_json.php?reqJenis=<?=$reqJenisTransaksi?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedBB 	 = element[1];
					  anSelectedNama = element[2];
					  anSelectedKeterangan = element[3];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetSiswa('<?=$reqIndex?>', anSelectedId, anSelectedBB, anSelectedNama,anSelectedKeterangan);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <span><b>Apabila data tidak muncul, Silahkan entrikan data siswa terlebih dahulu!</b></span>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>	
            ...
            <th width="70px">NIS</th>  
            <th width="70px">NIS</th>  
            <th width="70px">Nama Siswa</th>   
            <th width="70px">Sekolah</th>           
			<th width="70px">Kelas</th>
            <th width="70px">Kode BB</th>
        </tr>
    </thead>
    </table> 
    </div> 
