...
<head>
	...
	<script type="text/javascript">
		...
		function OptionSetKelas(anSelectedDepId, anSelectedDepKelasId, anSelectedNama, anSelectedJumlah){
			...
			document.getElementById('reqNilaiJasa0').value = anSelectedJumlah;
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Transaksi Pembayaran Kesiswaan</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>  
			...
			<td>  
                ...
                <input name="reqDepartemenKelas" id="reqDepartemenKelas" class="easyui-validatebox" style="width:98%;" type="text" readonly value="<?=$reqDepartemenKelas?>" onKeyDown="openPopup('PELANGGAN');" />   
			</td>         
             <!-- <td>Pelanggan</td>
			 <td>
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              <td align="center">
              <label>
              <input type="text" name="reqJumlah[]" style="text-align:right;" id="reqJumlah<?=$checkbox_index?>" readonly  OnFocus="FormatAngka('reqJumlah<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqJumlah<?=$checkbox_index?>')" OnBlur="FormatUang('reqJumlah<?=$checkbox_index?>')" />
              <input type="text" name="reqNilaiPajak[]"  id="reqNilaiPajak<?=$checkbox_index?>" />
              <input type="text" name="reqKdBukuBesar[]" id="reqKdBukuBesar<?=$checkbox_index?>" />
              <input type="text" name="reqDK[]" id="reqDK<?=$checkbox_index?>" />
              <a style="cursor:pointer" onclick="deleteRowDrawTablePhp('dataTableRowDinamis', this)"><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a>
              </label>
              </td>
              </tr>
