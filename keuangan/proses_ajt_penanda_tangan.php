...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
				$('#btnCetakPdf').live('click', function () {
					newWindow = window.open('proses_ajt_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val(), 'Cetak');
					newWindow.focus();
					$('.closeImg', top.document).click();	
				});
			  
			    $('#btnCetakPreview').live('click', function () {
					OpenDHTMLPopup('proses_ajt_preview.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val(), 'Rincian Jurnal', 900, 600);	
			    });
