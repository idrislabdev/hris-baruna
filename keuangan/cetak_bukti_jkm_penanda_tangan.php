...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
				$('#btnCetak').live('click', function () {
					$.getJSON('cetak_bukti_jkm_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val(),
					function(data){
				  ...
				  //newWindow = window.open('cetak_bukti_jkm_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Cetak');
				  //newWindow.focus();				  
				 //	window.parent.divwin.close();	
				});
			  
			   $('#btnExcel').live('click', function () {
					newWindow = window.open('cetak_bukti_jkm_excel.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val(), 'Cetak');
					newWindow.focus();	
				 	window.parent.divwin.close();		
			  });
