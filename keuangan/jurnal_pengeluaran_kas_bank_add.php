        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
          ...
          ?>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <?
                    if($kbbt_jur_bb_d_tmp->getField('SALDO_VAL_KREDIT') > 0)
					{
						$kodeAwal = substr($kbbt_jur_bb_d_tmp->getField("KD_BUKU_BESAR"), 0, 3);	
						if($kodeAwal == "101")
						{}
						else
						{
						?>
                        <strong style="color:#FF0004">Posisi kredit harus rekening 1</strong>
                        <?
						}
					}
					?>
