...
$set->selectByParamsJPP(array(), -1, -1,$statement);
//echo $set->query;
while($set->nextRow())
{
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                ...
                <div id="laporan-header-tengah">
                    <div><br /><br /><br /><span class="dash-bawah" style="display:inline;">BUKTI PENGELUARAN PERSEDIAAN</span></div>
                </div>
