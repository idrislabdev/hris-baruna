	...
	<script type="text/javascript">
		...
		$(function(){
			  ...
			  $('#btnScreen').on('click', function () {
					newWindow = window.open('penjualan_tunai_screen_rpt.php?reqId=<?=$tempNoNota?>&reqKdValuta=<?=$tempValutaNama?>', 'Cetak');
					newWindow.focus();
			  });
			  
			  $('#btnPrint').on('click', function () {
				  
				  $.getJSON('../json-keuangansiuk/penjualan_tunai_cetak.php?reqId=<?=$reqId?>',
					function(data){
					  newWindow = window.open('penjualan_tunai_screen_rpt.php?reqId=<?=$tempNoNota?>&reqKdValuta=<?=$tempValutaNama?>', 'Cetak');
					  newWindow.focus();						  
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
            ...
            <td>B. Besar Kas</td>
			 <td>
				...
				<input name="reqBukuBesarKas" id="reqBukuBesarKas" class="easyui-combobox" style="width:295px" type="text" value="<?=$tempBukuBesarKas?>"  data-options="
        ...
        <tr>
            ...
            <td>
                ...
                Tgl. Faktur <input id="reqTanggalFakturPajak" name="reqTanggalFakturPajak" class="easyui-datebox" data-options="validType:'date'" required value="<?=$tempTanggalFakturPajak?>" tabindex="10" onMouseDown="tabindex=10"/>              
            </td>
        </tr>
        <tr>
            <td>Valuta</td>
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" name="reqLbr[]" class="easyui-validatebox" readonly value="" />
                  </td>
                  <td>
