          ...
          ?>
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    $kptt_nota_d_siswa->selectByParamsDaftarSiswa(array("A.NO_NOTA" => $kptt_nota_d->getField("REF_PEMBATALAN"), "A.KD_SUB_BANTU" => $kptt_nota_d->getField("NO_REF2")));
                    while($kptt_nota_d_siswa->nextRow())
                    {
                    ?>
                        <option value="<?=$kptt_nota_d_siswa->getField("KD_SUB_BANTU")."-".$kptt_nota_d_siswa->getField("NO_NOTA")?>" <? if($kptt_nota_d_siswa->getField("KD_SUB_BANTU")."-".$kptt_nota_d_siswa->getField("NO_NOTA") == $kptt_nota_d->getField("REF_PEMBATALAN")) { ?> selected <? } ?>><?=$kptt_nota_d_siswa->getField("NM_SUB_BANTU_JPJ")?></option>
                    <?
                    }
                    ?>
                    </select>
