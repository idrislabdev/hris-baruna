...
<head>
	...
	function addRowDrawTables(tableID) {
        ...
        element4.type = "text";
		element4.name = "reqDebet["+ id_row +"]";
		element4.id = "reqDebet"+id_row;
        ...
        var element4= document.createElement("input");
        element4.type = "text";
		element4.name = "reqKredit["+ id_row +"]";
		element4.id = "reqKredit"+id_row;
		element4.style.width = '100px';
		element4.className='easyui-validatebox';
		element4.onfocus = function() {  
        ...
        var element4= document.createElement("input");
        element4.type = "text";
		element4.name = "reqRupiahDebet["+ id_row +"]";
		element4.id = "reqRupiahDebet"+id_row;
		element4.style.width = '100px';
		element4.className='easyui-validatebox';
		element4.onfocus = function() {  
			FormatAngka("reqRupiahDebet"+id_row);
		};
		element4.onkeyup = function() {  
			FormatUang("reqRupiahDebet"+id_row);
		};
		element4.onblur = function() {  
			FormatUang("reqRupiahDebet"+id_row);
		};
        ...
        var element4= document.createElement("input");
        element4.type = "text";
		element4.name = "reqRupiahKredit["+ id_row +"]";
		element4.id = "reqRupiahKredit"+id_row;
		element4.style.width = '100px';
		element4.className='easyui-validatebox';
		element4.onfocus = function() {  
			FormatAngka("reqRupiahKredit"+id_row);
		};
		element4.onkeyup = function() {  
			FormatUang("reqRupiahKredit"+id_row);
		};
		element4.onblur = function() {  
			FormatUang("reqRupiahKredit"+id_row);
		};
    ...
    <tbody> 
      ...
      ?>
          <tr id="node-$kapal_sertifikat_kapal->getField('SERTIFIKAT_KAPAL_ID')">
              ...
              <td>
              	<input type="text" name="reqKeterangan[<?=$checkbox_index?>]" style="width:50px" class="easyui-validatebox" value="" />
              </td>
              <td>
              	<input type="text" style="width:100px;" name="reqDebet[]"  id="reqDebet<?=$checkbox_index?>"  OnFocus="FormatAngka('reqDebet<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqDebet<?=$checkbox_index?>')" OnBlur="FormatUang('reqDebet<?=$checkbox_index?>')" value="<?=numberToIna($tempNilaiTransaksi)?>">
              </td>
              <td>
              	<input type="text" style="width:100px;" name="reqKredit[]"  id="reqKredit<?=$checkbox_index?>"  OnFocus="FormatAngka('reqKredit<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqKredit<?=$checkbox_index?>')" OnBlur="FormatUang('reqKredit<?=$checkbox_index?>')" value="<?=numberToIna($tempNilaiTransaksi)?>">
              </td>
              <td>
              	<input type="text" style="width:100px;" name="reqRupiahDebet[]"  id="reqRupiahDebet<?=$checkbox_index?>"  OnFocus="FormatAngka('reqRupiahDebet<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqRupiahDebet<?=$checkbox_index?>')" OnBlur="FormatUang('reqRupiahDebet<?=$checkbox_index?>')" value="<?=numberToIna($tempNilaiTransaksi)?>">
              </td>
              <td>
              	<input type="text" style="width:100px;" name="reqRupiahKredit[]"  id="reqRupiahKredit<?=$checkbox_index?>"  OnFocus="FormatAngka('reqRupiahKredit<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqRupiahKredit<?=$checkbox_index?>')" OnBlur="FormatUang('reqRupiahKredit<?=$checkbox_index?>')" value="<?=numberToIna($tempNilaiTransaksi)?>">
              </td>
              <td align="center">
              <label>
