                  ...
                  <div id="metro-array" style="display: inline-block;">
                    ...
                    <div id="drillmenu1" class="drillmenu">
                      <ul>
                        ...
                        <li> <a href="#" class="metro-tile warna-menu"><img src="images/tileMenu/menu-aplikasi.png" class="menu-tile"/>Administrasi Aplikasi</a>
                          <ul>
                            ...
                            <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-pelaporan-bulanan-harian.png" class="menu-tile"/>Pelaporan Bulanan &amp; Harian</a>
                              <ul>
                                <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Lap. Bulanan (LB-Rupiah)</a>
                                  <ul>
                                  	<li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Daftar Isi</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Neraca Komparatif (LB1)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>L/R Jns Biaya Kompar (LB2)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>L/R Jns Biaya (LB2.1)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>L/R Pst Biaya Kompar (LB3)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>L/R Pst Biaya (LB3.1)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Rasio Keuangan (LB5)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Arus Kas (LB4)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-ikhtisar-jurnal.png" class="menu-tile"/>Ikhtisar Jurnal</a>
                                    	<ul>
                                    ...
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Neraca Saldo (LB6)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>BK. Besar Per Rek.(LB7)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Ikht. Buku&nbsp;Besar (LB8)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Ikht. Buku Bantu (LB9)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-ikhtisar-pendapatan-biaya.png" class="menu-tile"/>Ikhtisar Pendapatan &amp; Biaya</a>
                                    	<ul>
                                    ...
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Real. Biaya Jns / Pst (LB13)</a></li>
                                    <li> <a href="#" class="metro-tile warna-biru-toska"><img src="images/tileMenu/menu-LB-rupiah.png" class="menu-tile"/>Real. Biaya Pst / Jns (LB14)</a></li>
                                  </ul>
                                </li>
                        ...
                        <!-- PAJAK -->
                        <li> <a href="data_diri.php" target="mainFrame" class="metro-tile warna-ijo-3"><img src="images/tileMenu/menu-pajak.png" class="menu-tile"/>Pajak</a></li>
