...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
					...
					newWindow = window.open('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ $("#reqId").val()+'&reqKdValuta='+ $("#reqKdValuta").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'', 'Cetak');
			  		newWindow.focus();	
				 	window.parent.divwin.close();
			  });
