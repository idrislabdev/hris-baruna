...
$file_name	= "CETAK_NOTA_".$reqKdValuta . ($reqType == "" ? "" : "_EMAIL");
...
$zz = $creport->ParameterFields(1)->SetCurrentValue($reqPejabat);
$zz = $creport->ParameterFields(2)->SetCurrentValue($reqParam1);
$zz = $creport->ParameterFields(3)->SetCurrentValue($reqParam2);
