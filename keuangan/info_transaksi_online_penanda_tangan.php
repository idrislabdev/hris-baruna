...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
				$('#btnCetak').live('click', function () {
				  newWindow = window.open('info_transaksi_online_rpt.php?reqPeriode=<?=$reqPeriode?>&reqKode='+ $("#reqKode").val()+'&reqPelunasan='+ $("#reqPelunasan").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqTTD='+ $("#reqTTD").val(), 'Cetak');
				  newWindow.focus();				  
				 	window.parent.divwin.close();	
				});
			  
			   $('#btnExcel').live('click', function () {
					newWindow = window.open('info_transaksi_online_excel.php?reqPeriode=<?=$reqPeriode?>&reqKode='+ $("#reqKode").val()+'&reqPelunasan='+ $("#reqPelunasan").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqTTD='+ $("#reqTTD").val(), 'Cetak');
					newWindow.focus();	
				 	window.parent.divwin.close();		
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Cetak Saldo Piutang</span>
            </div>            
            </td>
        </tr>
    </table>
	...
	<table>
        ...
        <tr>
            ...
            <td>
                <input name="reqKode" id="reqKode" class="easyui-validatebox" style="width:170px" type="text" readonly value="<?=$reqKode?>" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
        	<td>Sertakan Tanda Tangan</td>
            <td>
                <select name="reqTTD" id="reqTTD">
