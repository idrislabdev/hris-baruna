...
<title>neraca saldo valas</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				...
				$.getJSON('../json-keuangansiuk/neraca_saldo_valas_proses_json.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('neraca_saldo_valas_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});	
			  ...
			  $('#btnExcel').live('click', function () {
				...
				$.getJSON('../json-keuangansiuk/neraca_saldo_valas_proses_json.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('neraca_saldo_valas_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Neraca Saldo Valas</span>
            </div>            
            </td>
        </tr>
    </table>
