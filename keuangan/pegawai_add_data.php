...
<div id="wadah">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                 <input id="dd" name="reqTanggalNpwp" class="easyui-datebox" data-options="validType:'date'" value="<?=$tempTanggalNpwp?>"></input>&nbsp;&nbsp;<a href="#" id="clueTipBox" class="clueTipBox" title="Panduan|Tanggal daftar NPWP yang dientri adalah tanggal NPWP yang didaftarkan pegawai ke Perusahaan."><img src="images/help.png"></a>
            </td>
