...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/bank_pencarian_json.php?reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetBank(anBb, anKode, anNama);	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Master Bank</span>
            </div>            
            </td>
        </tr>
    </table>
