...
<title>Penjualan Tunai (JKM)</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
				$('#btnCetak').live('click', function () {
					$.getJSON('penjualan_tunai_jurnal_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(),
					function(data){
				  ...
				  //newWindow = window.open('penjualan_tunai_jurnal_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val(), 'Cetak');
				  //newWindow.focus();				  
				 //	window.parent.divwin.close();	
				});
			  
			   $('#btnExcel').live('click', function () {
					newWindow = window.open('penjualan_tunai_jurnal_excel.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Cetak');
					newWindow.focus();	
				 	window.parent.divwin.close();		
			  });
			  
			  $('#btnCetakPreview').live('click', function () {
					OpenDHTMLPopup('penjualan_tunai_jurnal_preview.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Rincian Jurnal', 900, 600)	
			  });
...
<div id="wadah">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Cetak Bukti Penjualan Tunai (JKM)</span>
            </div>            
            </td>
        </tr>
    </table>
	...
	<table>
        ...
        <tr>
        	<td colspan="3"><input type="button" id="btnCetakPreview" value="Preview"> <?php /*?><input type="button" id="btnExcel" value="Excel"><?php */?></td>
        </tr>      
    </table>    	   
    </form>
</div>
