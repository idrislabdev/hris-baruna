...
<div id="wadah">
    ...
    <table>
        ...
        <tr>           
			 ...
			 <td>
                ...
                <input name="reqNoRef3" id="reqNoRef3" class="easyui-validatebox" style="width:98%;" type="text"  value="<?=$reqNoRef3?>" onKeyDown="openPopup();"  />   <!--onKeyDown="openPopup();"-->
    ...
    <table>
        <tr>
        	<td>Upload data pelunasan (<a href="uploads/template_pelunasan.xlsx">download template</a>)</td>
