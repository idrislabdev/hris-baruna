...
<title>proses cetak ulang nota penjualan</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_cetak_ulang_nota_penjualan_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('proses_cetak_ulang_nota_penjualan_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });

			  $('#btnPreviewRupiah').on('click', function () {
				  	var val = [];
			  ...
			  $('#btnPrintRupiah').on('click', function () {
			  ...
			  $('#reqTanggalAproval').datebox({
				onChange:function(newValue,oldValue){
					...
					if(newValue.length == 10)
					{
						...
						oTable.fnReloadAjax("../json-keuangansiuk/proses_cetak_ulang_nota_penjualan_json.php?reqTanggalAproval="+ val_tanggal_approval);
					}
					else
					{
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Proses Cetak Ulang Nota Penjualan</span>
            </div>            
            </td>
        </tr>
    </table>
