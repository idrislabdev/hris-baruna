...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-keuangansiuk/proses_pelunasan_transaksi_kas_bank_add.php',
				onSubmit:function(){
				...
				success:function(data){
					...
					document.location.href = 'proses_pelunasan_transaksi_kas_bank_add.php?reqId='+data[0];
		...
		function OptionSetPPKB(index, id){
			$.getJSON("../json-keuangansiuk/get_penjualan_transaksi_non_tunai_json_v2.php?reqNota="+id+"&reqId="+$("#reqNoPelanggan").val()+"&reqKdValuta="+$("#reqValutaNama").val(),
			function(data){				
