...
<script type="text/javascript">
	...
	***************************************************************************/ 
	...
	printWeb('http://192.168.88.98:8080/jasperserver/flow.html?_flowId=viewReportFlow&reportUnit=%2Freports%2FJURNAL_PENERIMAAN_KAS_BANK&standAlone=true&j_acegi_security_check&j_username=jasperadmin&j_password=jasperadmin&output=txt&NOTA_IN_PARAM=<?=$statement?>&PEJABAT=<?=$pejabat?>&JABATAN1=<?=$jabatan?>&PARAM1=<?=$reqParam1?>&PARAM2=<?=$reqParam2?>&PARAM3=<?=$reqParam3?>&PARAM4=<?=$reqParam4?>');
