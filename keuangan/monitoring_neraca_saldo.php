...
<title>monitoring neraca saldo</title>
...
function OpenDHTMLFullScreen(opAddress, opCaption, opWidth, opHeight)
{
	/*var left = (screen.width/2)-(opWidth/2);
    var top = (screen.height/2)-(opHeight/2) - 100;*/
	var left=450;
	
	window.parent.OpenDHTML(opAddress, opCaption, opWidth, opHeight);
   	...
   	<tr> 
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="100%">
                	<td width="65%"><iframe src="monitoring_neraca_saldo_monitoring.php" class="mainframe" id="idMainFrame" name="mainFramePop" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
                	<td width="35%"><iframe src="monitoring_neraca_saldo_detil.php" class="mainframe" id="idMainFrameDetil" name="mainFrameDetilPop" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
                </tr>
            </table>			
		</td>
	</tr>
