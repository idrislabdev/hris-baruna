		...
		$(function(){
			$('#ff').form({
				...
				onSubmit:function(){
					...
					// if($("#reqLokasi").is(':checked'))
					// {
					// 	$.messager.alert('Info',"Lokasi Aktiva Tidak Boleh Kosong.", 'info')
					// 	return false;
					// }
					else
				...
				success:function(data){
					...
					document.location.href = 'jurnal_jrr_asset_add.php?reqId='+data[0];
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Jurnal Rupa - Rupa (Asset)</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
            ...
            <td style="display:none">Bulan&nbsp;Buku</td>
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        <thead class="altrowstable">
          ...
          <tr>
              ...
              <th style="width:165px;">Lokasi&nbsp;Asset</th>
              <th>Aktiva</th>
              <th>Debet</th>
              <th>Kredit</th>
              <th>Aksi</th>
          ...
          ?>
			...
			$(function() {
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" id="reqLokasi<?=$checkbox_index?>" name="reqLokasi[]" value="<?=$kbbt_jur_bb_d_tmp->getField("LOKASI_AKTIVA")?>" style="width:165px;" <? if($kbbt_jur_bb_d_tmp->getField("DISABLE_BPUSAT") == "DISABLED") {} else { ?> tabindex="<? $last_tab++; echo $last_tab ?>" onMouseDown="tabindex=<?=$last_tab?>" <? } ?> <?=$kbbt_jur_bb_d_tmp->getField("DISABLE_BPUSAT")?>  />                   	
                  </td>
                  <td>
			  ...
			  <?
                ...
                $temp_lokasi += $kbbt_jur_bb_d_tmp->getField('LOKASI_AKTIVA');
              }
              ?>
              <?
			  if($checkbox_index == 0)
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" id="reqLokasi<?=$checkbox_index?>" name="reqLokasi[]"  style="width:165px;" tabindex="10" required class="easyui-validatebox" onMouseDown="tabindex=11" />                   	
                  </td>
                  <td>
                    <input type="text" id="reqKeterangan<?=$checkbox_index?>" name="reqKeterangan[]" class="easyui-validatebox" required style="width:95%;" tabindex="12" onMouseDown="tabindex=12"/>
                  </td>
                  <td>
