...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/buku_bantu_json.php?reqPeriode=<?=date("Ym")?>",			  
			  ...
			  $('#btnEdit').on('click', function () {
			   ...
			   $('#reqPeriode').combobox({
					onSelect: function(param){
						oTable.fnReloadAjax("../json-keuangansiuk/buku_bantu_json.php?reqPeriode="+param.id);
					}
			  });	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Buku Bantu</span>
            </div>            
            </td>
        </tr>
    </table>
