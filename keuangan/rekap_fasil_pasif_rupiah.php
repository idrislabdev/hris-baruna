...
<title>rekap fasil pasif rupiah</title>
    ...
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			   ...
			   $('#btnExcel').live('click', function () {
			  	newWindow = window.open('ikhtisar_jkm_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekapitulasi Piutang Pasif Per Segmen / Fasilitas (PUPN Rupiah)</span>
            </div>            
            </td>
        </tr>
    </table>
