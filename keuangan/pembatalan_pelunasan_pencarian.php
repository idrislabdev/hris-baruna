...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pembatalan_pelunasan_pencarian_json.php?reqId=<?=$reqId?>",
			...
			/* Click event handler */
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetNota(anSelectedId);	
...
<div id="wadah">
    ...
    <thead>
        <tr>
            ...
            <th width="70px">Badan&nbsp;Usaha</th>
            <th width="70px">Tgl&nbsp;Trans</th>
			<th width="70px">Bulan&nbsp;Buku</th>
            <th width="70px">Valuta</th>
            <th width="70px">Jml&nbsp;Transaksi</th>
        </tr>
    </thead>
    </table> 
    </div> 
