...
<title>Monitoring Jurnal Transaksi</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,	
			  "sAjaxSource": "../json-keuangansiuk/monitoring_jurnal_transaksi_json.php?reqJurnal=<?=$reqJurnal?>&reqPosting=0&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
		...
		$("#btnRincianJurnal").click();	
			  ...
			  $("#reqJurnal").change(function() { 
				 ...
				 val_posting= $("#reqPosting").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/monitoring_jurnal_transaksi_json.php?reqJurnal="+ val_jurnal + "&reqPosting=" + val_posting +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/monitoring_jurnal_transaksi_json.php?reqJurnal="+ $("#reqJurnal").val() + "&reqPosting=" + $("#reqPosting").val());
			  });
			  ...
			  return false;
			   ...
			   $('.vmenu .first_li').on('click',function() {
				  if( $(this).children().size() == 1 ) {
					  if($(this).children().text() == 'Rincian Jurnal')
					  {
						  $("#btnRincianJurnal").click();
					  }
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Monitoring Jurnal Transaksi</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="120px">No.&nbsp;Pendukung</th>
            <th width="250px">Nama&nbsp;Agen&nbsp;/&nbsp;Perusahaan</th>
            <th width="100px">Tgl&nbsp;Trans</th>
            <th width="50px">Valuta</th>
            <th width="100px">Jumlah&nbsp;Valas</th>
