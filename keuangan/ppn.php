...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/ppn_json.php?reqPeriode=<?=date("Ym")?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnExport').on('click', function () {
				  ...
				  var periode= $('#reqPeriode').combobox('getValue');
				  
				  //alert(periode);
				 newWindow = window.open('ppn_excel.php?reqPeriode='+periode, 'Cetak');
				 newWindow.focus();
			  });
			 ...
			 $('#reqPeriode').combobox({
					onSelect: function(param){
						oTable.fnReloadAjax("../json-keuangansiuk/ppn_json.php?reqPeriode="+param.id);
					}
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> PPN</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" title="Export" id="btnExport">&nbsp;Export Excel</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th style="text-align:center" width="80px">Kode Rek</th>
            <th style="text-align:center" width="200px">Nama Rekening</th>
            <th style="text-align:center" width="215px">Nama WP</th>
            <th style="text-align:center" width="105px">Nomor NPWP</th>
            <th style="text-align:center" width="105px">Faktur Pajak</th>
            <th style="text-align:center" width="85px">Tgl.&nbsp;Faktur</th>
            <th style="text-align:center" width="280px">Keterangan</th>
            <th style="text-align:center" width="85px">Jumlah DPP</th>
            <th style="text-align:center" width="85px">Jumlah PPN</th>
            <th style="text-align:center" width="120px">No&nbsp;Nota</th>
            <th style="text-align:center" width="85px">DPP Kode Rekening</th>
            <th style="text-align:center" width="85px">DPP Rekening</th>
            <th style="text-align:center" width="85px">No.&nbsp;Posting</th>
            <th style="text-align:center" width="85px">Tgl.&nbsp;Posting</th>
        </tr>
    </thead>
    </table> 
    </div> 
