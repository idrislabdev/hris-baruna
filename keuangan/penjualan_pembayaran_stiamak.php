...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/penjualan_pembayaran_stiamak_json.php?reqPeriode=<?=$reqPeriode?>",			  
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedPPKB = element[2];
					  anSelectedValuta = element[9];
			  ...
			  $('#btnView').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('penjualan_pembayaran_view.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('penjualan_pembayaran_stiamak_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  	  else
			  ...
			  $('#btnCetak').on('click', function () {
				   if(anSelectedData == "")
						return false;	
						  window.parent.OpenDHTML('penjualan_non_tunai_penanda_tangan.php?reqNoBukti='+ anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');				  
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KPTT_NOTA&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=PENJUALAN_NON_TUNAI&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  <?php /*?>$('#btnCetakNotaIND').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
						  window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+ '&reqKdValuta=IND', 'Cetak');
						  						  
						  oTable.fnReloadAjax("../json-keuangansiuk/penjualan_non_tunai_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
					  	  alert(data.STATUS);
			  ...
			  $('#btnCetakNotaENG').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
				  		...
				  		window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+ '&reqKdValuta=ENG', 'Cetak');	
					  	oTable.fnReloadAjax("../json-keuangansiuk/penjualan_non_tunai_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
					  	  alert(data.STATUS);						  						
			  ...
			  $('#btnCetakNotaIND').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
				 		  window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_penanda_tangan.php?reqId='+ anSelectedPPKB+'&reqKdValuta=IND', 'Cetak');	
						  //window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+ '&reqKdValuta=IND', 'Cetak');						  						  
						  oTable.fnReloadAjax("../json-keuangansiuk/penjualan_non_tunai_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
				  		...
				  		window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_penanda_tangan.php?reqId='+ anSelectedPPKB+'&reqKdValuta=ENG', 'Cetak');	
				  		//window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+ '&reqKdValuta=ENG', 'Cetak');	
					  	oTable.fnReloadAjax("../json-keuangansiuk/penjualan_non_tunai_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
			  ...
			  $('#btnCetakNotaCMX').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
				  		...
				  		window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_penanda_tangan.php?reqId='+ anSelectedPPKB+'&reqKdValuta=IND_MAX', 'Cetak');	
				  		//window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+ '&reqKdValuta=IND_MAX', 'Cetak');	
					  	oTable.fnReloadAjax("../json-keuangansiuk/penjualan_non_tunai_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
					  	  alert(data.STATUS);						  						
			  ...
			  $('#btnScreenCMX').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_penanda_tangan.php?reqId='+ anSelectedPPKB+'&reqKdValuta=IND_MAX', 'Cetak');	
				  //window.parent.OpenDHTML('penjualan_non_tunai_cetak_nota_rpt.php?reqId='+ anSelectedPPKB+'&reqKdValuta=IND_MAX', 'Cetak');
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-keuangansiuk/penjualan_pembayaran_stiamak_json.php?reqPeriode="+ $("#reqPeriode").val());
			  ...
			  return false;
			   ...
			   $('.first_li .inner_li span').on('click',function() {
					  ...
					  if($(this).attr("id") == 'clickScreenInd')
					  {
						  $("#btnScreenIND").click();
					  }
					  ...
					  {
						  $("#btnCetakNotaIND").click();
					  }
					  else if($(this).attr("id") == 'clickPrintEng')
					  {
						  $("#btnCetakNotaENG").click();
					  }
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi Penagihan SPP Mahasiswa STIAMAK</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('penjualan_pembayaran_stiamak_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnView" title="View">View</a>
            </li>
            <li>
            <a href="#" id="btnScreenIND" title="Screen">Screen</a>
            <a href="#" id="btnCetakNotaIND" title="Cetak Nota">Cetak Nota</a>
            </li>
            <li>
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
          ...
          <li><a href="#" id="btnScreenCMX">Complex Version</a></li>
        </ul>  
        <ul id="flexmenu2" class="flexdropdownmenu">
          <li><a href="#" id="btnCetakNotaIND">Indonesian Version</a></li>
          <li><a href="#" id="btnCetakNotaENG">English Version</a></li>
          <li><a href="#" id="btnCetakNotaCMX">Complex Version</a></li>
        </ul> 
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="90px">Tgl&nbsp;Posting</th>                                             
            <th width="90px">No&nbsp;Posting</th> 
        </tr>
    </thead>
    </table> 
    </div> 
    ...
    <div class="vmenu">
        ...
        <div class="first_li"><span>Screen</span>
            <div class="inner_li"> 
