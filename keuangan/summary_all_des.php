...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('summary_all_des_rpt.php?reqPeriode='+ $("#reqPeriode").val()+'&reqUmurPiutang='+ $("#reqUmurPiutang").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('summary_all_des_excel.php?reqPeriode='+ $("#reqPeriode").val()+'&reqUmurPiutang='+ $("#reqUmurPiutang").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
