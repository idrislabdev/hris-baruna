...
<title>inquiry jurnal kas keluar sudah posting</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/inquiry_jurnal_kas_keluar_sudah_posting_json.php?reqPeriode=<?=$reqPeriode?>&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			 ...
			 $('#btnDisplayJurnal').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
			  ...
			  $("#reqPeriode").change(function() { 
			  	 val_periode= $("#reqPeriode").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_keluar_sudah_posting_json.php?reqPeriode="+ val_periode +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_keluar_sudah_posting_json.php?reqPeriode="+ $("#reqPeriode").val());
			  ...
			  return false;
			   ...
			   $('.vmenu .first_li').on('click',function() {
				  if( $(this).children().size() == 1 ) {
					  if($(this).children().text() == 'Display Jurnal')
					  {
						  $("#btnDisplayJurnal").click();
					  } 
					  $('.vmenu').hide();
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Inquiry Jurnal Kas Keluar Sudah Posting</span>
            </div>            
            </td>
        </tr>
    </table>
    <div style="position: relative; z-index:10">
    <div style="position: absolute; margin-top:30px; margin-left:180px; z-index:9999; font-size:12px;">
        Dari Tanggal
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('inquiry_jurnal_kas_masuk_belum_posting_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnDeleteRow" title="Hapus">Hapus</a><?php */?>
            <a href="#" id="btnDisplayJurnal" title="Display Jurnal">Display Jurnal</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th>Keterangan</th>
            <th width="50px">Modul</th>
            <th width="50px">Jur</th>
            <th width="120px">No.&nbsp;Bukti</th>
            <th width="120px">Pendukung1</th>
            <th width="120px">Pendukung2</th>
    ...
    <!--RIGHT CLICK EVENT -->
    <div class="vmenu">
        <div class="first_li"><span>Display Jurnal</span></div>
    </div>
    <!--RIGHT CLICK EVENT -->     
</div>
</body>
