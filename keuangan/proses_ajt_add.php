...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-keuangansiuk/proses_ajt_add.php',
				onSubmit:function(){
				...
				success:function(data){
					...
					document.location.href = 'proses_ajt_add.php?reqId='+data[0];
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Ayat Jurnal Penutup (AJT)</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
             <td>Bulan di buku</td>
			 <td>
             	<input id="reqBulan" name="reqBulan" style="width:30px;" class="easyui-validatebox" data-options="validType:'minLength[2]'" maxlength="2" value="<?=$tempBulan?>" />
                <input id="reqTahun" name="reqTahun" style="width:60px;" class="easyui-validatebox" data-options="validType:'minLength[4]'" maxlength="4" value="<?=$tempTahun?>" />
			</td>
            <td>Kurs&nbsp;Valuta</td>
			 <td>
