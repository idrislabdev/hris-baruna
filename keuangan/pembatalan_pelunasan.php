...
<title>pembatalan pelunasan</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pembatalan_pelunasan_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnView').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pembatalan_pelunasan_view.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('pembatalan_pelunasan_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  	  else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KPTT_NOTA&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=PEMBATALAN_PELUNASAN&reqId='+anSelectedId+'&reqPrevNotaUpdate='+data.PREV_NOTA_UPDATE,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  $('#btnCetakPengeluaranKas').on('click', function () {
			  });
			  
			  $('#btnCetakJurnalBukti').on('click', function () {
			  });
			  
			  $('#btnCetakJurnalPosting').on('click', function () {
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi Pembatalan Pelunasan Nota Tagih</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pembatalan_pelunasan_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnView" title="View" style="display:none">View</a>
			<?php /*?><a href="#" id="btnCetakPengeluaranKas" title="Cetak Pengeluaran Kas">Cetak Pengeluaran Kas</a>
            <a href="#" id="btnCetakJurnalBukti" title="Cetak Jurnal Bukti">Cetak Jurnal Bukti</a>
            <a href="#" id="btnCetakJurnalPosting" title="Jurnal Posting">Jurnal Posting</a><?php */?>
    ...
    <thead>
        <tr>
            ...
            <th width="150px">Tipe&nbsp;Trans</th>
            <th width="200px">Pelanggan</th>
            <th width="100px">No.&nbsp;Ref</th>
            <th width="100px">Tgl&nbsp;Trans</th>
            <th width="120px">No.&nbsp;Bukti&nbsp;Dikoreksi</th>
            <th width="150px">BB&nbsp;Kas&nbsp;/&nbsp;Bank</th>
            <th width="50px">Valuta</th>   
            <th width="100px">Nilai&nbsp;Trans</th>
