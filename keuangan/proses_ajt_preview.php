...
$set->selectByParamsAJT(array(), -1, -1,$statement);
//echo $set->query;
while($set->nextRow())
{
	//KD_SUBSIS,NO_BUKTI, TGL_BUKTI, DARI, 
    //ALAMAT, URAIAN, BUKTI_PENDUKUNG, 
    //TANGGAL, NOMOR,
    //MUTASI_JURNAL, 
    //KETERANGAN,
    //DEBET, KREDIT,PREV_NO_NOTA,TIPE_TRANS, KD_BUKU_BESAR BB,
    //NO_POSTING, TGL_POSTING, KET_JUR
	
	$arrData[$index_set]["NO_BUKTI"]= $set->getField("NO_BUKTI");
	$arrData[$index_set]["TANGGAL"]= $set->getField("TANGGAL");
	$arrData[$index_set]["JML_VAL_TRANS"]= $set->getField("JML_VAL_TRANS");
	$arrData[$index_set]["JML_RP_TRANS"]= $set->getField("JML_RP_TRANS");
	$arrData[$index_set]["DARI"]= $set->getField("DARI");
	$arrData[$index_set]["ALMT_AGEN_PERUSH"]= $set->getField("ALMT_AGEN_PERUSH");
	$arrData[$index_set]["URAIAN"]= $set->getField("URAIAN");
	$arrData[$index_set]["BUKTI_PENDUKUNG"]= $set->getField("BUKTI_PENDUKUNG");
	$arrData[$index_set]["NOMOR"]= $set->getField("NOMOR");
	$arrData[$index_set]["MUTASI_JURNAL"]= $set->getField("MUTASI_JURNAL");
	$arrData[$index_set]["KD_SUB_BANTU"]= $set->getField("KD_SUB_BANTU");


	$arrData[$index_set]["KD_BUKU_PUSAT"]= $set->getField("KD_BUKU_PUSAT");
	$arrData[$index_set]["KETERANGAN"]= $set->getField("KETERANGAN");
	...
	$arrData[$index_set]["DEBET"]= $set->getField("DEBET");
	$arrData[$index_set]["KREDIT"]= $set->getField("KREDIT");
	...
	if($tempNoNotaKondisi == $arrData[$index_set]["NO_BUKTI"]){}
	else
	{
		$arrDataIndex[$index_set_detil]= $index_set;
		$index_set_detil++;
	}
	$tempNoNotaKondisi= $arrData[$index_set]["NO_BUKTI"];
...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			header+="   ------------------------                             TGL.PROSES    : <?=$arrData[$arrDataIndex[$param_index]]["TANGGAL"]?>\n";
			header+="                                                        HALAMAN       : ";
			headerHalaman+="\n                               BUKTI JURNAL RUPA-RUPA\n";
			headerHalaman+="                              ========================\n\n";
			headerHalaman+="   NO SIUK  : <?=$arrData[$arrDataIndex[$param_index]]["NO_BUKTI"]?>                                         TANGGAL  : <?=$arrData[$arrDataIndex[$param_index]]["TANGGAL"]?>\n";
			headerHalaman+=" |=============================================================================================|\n";
			rowHeader=9;
			...
			temp+= "<?=$arrData[$arrDataIndex[$param_index]]["DARI"]?>";
			...
			temp= " | 3. Uraian";
			temp=fillStringCompletor(temp,"24"," ",": ");
			temp+= "<?=$arrData[$arrDataIndex[$param_index]]["URAIAN"]?>";
			temp=fillStringCompletor(temp,"95"," ","");
			var result = splitIntoLines(temp, 90);
			...
			temp= " | 4. Bukti Pendukung";
			temp=fillStringCompletor(temp,"24"," ",": ");
			temp+= "<?=$arrData[$arrDataIndex[$param_index]]["BUKTI_PENDUKUNG"]?>";
			temp=fillStringCompletor(temp,"68"," ","");
			tempDetil= temp+"Tanggal, <?=$arrData[$arrDataIndex[$param_index]]["TANGGAL"]?>";
			...
			<?
				...
				$tempSaldoRpDebet= $arrData[$checkbox_index]["DEBET"];
				$tempSaldoRpKredit= $arrData[$checkbox_index]["KREDIT"];
			...
			?>
				...
				temp=fillStringCompletor(temp,"65"," ","");
				temp=fillStringCompletor(temp,"80"," ","");
				temp+="<?=numberToIna($arrData[$checkbox_index]["KREDIT"])?>";
				temp=fillStringCompletor(temp,"95"," ","|");
				var panjangTemp= panjangString(temp);
				//alert(temp+'--'+panjangTemp);
			<?
			...
			?>	
				...
				temp+="RP";
				temp=fillStringCompletor(temp,"58"," ","");
				temp+="<?=numberToIna($arrData[$checkbox_index]["DEBET"])?>";
				temp=fillStringCompletor(temp,"65"," ","");
				temp=fillStringCompletor(temp,"80"," ","");
				temp+="";
				temp=fillStringCompletor(temp,"95"," ","|");
			...
			temp=fillStringCompletor(temp,"68"," ","");
			temp+="SURABAYA, <?=$arrData[$data_awal]["TANGGAL"]?>";
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			isiValue+=temp+"\n";
...
<div id="laporan-wrapper" class="dash-bawah">
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                <div id="laporan-header-kiri">
                    ...
                    <div><br /><br /><br /><span>NO SIUK : <?=$arrData[$checkbox_index]["NO_BUKTI"]?></span></div>
                </div>
                <div id="laporan-header-tengah">
                    <div><br /><br /><br /><span class="dash-bawah" style="display:inline;">BUKTI JURNAL RUPA-RUPA</span></div>
                </div>
                <div id="laporan-header-kanan">
                    <div id="laporan-pojok" style="text-align:left;">
                        <div id="laporan-pojok-row">
                            <div>REPORT ID.</div>
                            <div>:</div>
                            <div>KBB_BKT_JRR_ENTRY</div>
                        </div>
                        <div id="laporan-pojok-row">
                            <div>TANGGAL PROSES</div>
                            <div>:</div>
                            <div><?=$arrData[$checkbox_index]["TANGGAL"]?></div>
                        </div>
                        <div id="laporan-pojok-row">
                            <div>HALAMAN</div>
                            <div>:</div>
                    ...
                    <div style="position:absolute; bottom:0; right:0;"><span>TANGGAL : <?=$arrData[$checkbox_index]["TANGGAL"]?></span></div>
                </div>
            </div>
    ...
    <div id="main" style="position:relative;">
        ...
        <div style="float:left; border:0px solid #C66;">
            ...
            <div id="laporan-uraian">
                <div id="laporan-uraian-row">
                    <div><span>1. Kepada</span></div>
                    <div><span>:</span></div>
                    <div><span><?=$arrData[$checkbox_index]["DARI"]?></span></div>
                </div>
                <div id="laporan-uraian-row">
                ...
                <div id="laporan-uraian-row">
                    <div><span>3. Uraian</span></div>
                    <div><span>:</span></div>
                    <div><span><?=$arrData[$checkbox_index]["URAIAN"]?></span></div>
                </div>
                <div id="laporan-uraian-row">
                    <div><span>4. Bukti Pendukung</span></div>
                    <div><span>:</span></div>
                    <div><span><?=$arrData[$checkbox_index]["BUKTI_PENDUKUNG"]?></span></div>
                    
                    <div style="float:right; margin-top:-14px; padding-bottom:10px;"><span>Tanggal, <?=$arrData[$checkbox_index]["TANGGAL"]?></span></div>
                </div>
            </div>
        </div>
        <!---->
        ...
        <div id="laporan-isi-area" class="dash-kiri dash-kanan">
            ...
            <div style="display: table;">
				...
				{
					if($tempKondisiNoBukti == $arrData[$checkbox_index]["NO_BUKTI"] || $tempKondisiNoBukti == "")
					{
					$tempNoNota= $arrData[$checkbox_index]["NO_BUKTI"];
					$tempTanggalTrans= $arrData[$checkbox_index]["TANGGAL"];
					$tempJumlahValTrans= $arrData[$checkbox_index]["JML_VAL_TRANS"];
                ...
                <div id="tabel" style="display: table-row;">            
                    ...
                    <div style="display: table-cell;"><span><?=$tempKdBukuBesar?>&nbsp;&nbsp;&nbsp;<?=$tempKdSubBantu?>&nbsp;&nbsp;&nbsp;<?=$tempKdBukuPusat?><br />
                    <?
					$tempKetTambahanUsd= $tempKetTambahanNilaiUsd="";
					if(strtoupper($tempKdValuta) == "IDR"){}
					else
                ...
                <?
					...
					$tempKondisiNoBukti= $arrData[$checkbox_index]["NO_BUKTI"];
                }
                ?>
            </div>
    ...
    <div id="footer">
        <div id="laporan-footer">
            <div id="laporan-periksa" class="dash-kanan dash-kiri dash-bawah">
                ...
                <div id="laporan-periksa-kanan">
                    <div id="laporan-periksa-manager" class="">
                        <span>
                        SURABAYA, <?=$arrData[$tempJumlahTransIndex]["TANGGAL"]?><br />
                        <?=$jabatan?><br /><br /><br /><br /><br /><br /></span>
           ...
           <?php /*?> <div id="laporan-periksa" class="dash-kanan dash-kiri">
            	<div id="laporan-periksa-kiri">
                    <div id="laporan-diperiksa-row" class="dash-kanan dash-bawah">
                        <div class="dash-kanan "><span><?=$reqParam2?></span></div>
                        <div class="dash-kanan ">&nbsp;</div>
