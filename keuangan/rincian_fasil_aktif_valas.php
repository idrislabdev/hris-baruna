...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rincian_fasil_aktif_valas_rpt.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+'&reqPeriode='+ $("#reqPeriode").val()+'&reqKdKartu='+ $("#reqKdKartu").val()+'&reqSdKdKartu='+ $("#reqSdKdKartu").val(), 'Cetak');
			  });
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rincian_fasil_aktif_valas_excel.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+'&reqPeriode='+ $("#reqPeriode").val()+'&reqKdKartu='+ $("#reqKdKartu").val()+'&reqSdKdKartu='+ $("#reqSdKdKartu").val(), 'Cetak');
			  });	
	});
</script>
</head>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Piutang Aktif Per Segmen / Fasilitas (Valas)</span>
            </div>            
            </td>
        </tr>
    </table>
	...
	<table>
        ...
        <tr>           
             <td>No Kartu</td>
			 <td>
             	<select id="reqKdKartu">
                	<option value="00008">00008</option>
                </select>
             </td>
             <td>S/d</td>
			 <td>
             	<select id="reqSdKdKartu">
