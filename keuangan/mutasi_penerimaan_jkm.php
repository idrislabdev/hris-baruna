...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  ...
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('mutasi_penerimaan_jkm_rpt.php?reqTanggal='+ $('#reqTanggal').datebox('getValue') +'&reqPeriode=' + periode + '&reqValuta=' + $("#reqValuta").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('mutasi_penerimaan_jkm_excel.php?reqTanggal='+ $('#reqTanggal').datebox('getValue') +'&reqPeriode=' + periode + '&reqValuta=' + $("#reqValuta").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Mutasi Penerimaan JKM</span>
            </div>            
            </td>
        </tr>
    </table>
