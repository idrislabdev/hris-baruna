...
<title>anggaran mutasi validasi</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-anggaran/anggaran_mutasi_validasi_json.php?reqPeriode=<?=$reqPeriode?>",
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedValidasi == 1)
				  	...
				  	window.parent.OpenDHTML('anggaran_mutasi_validasi_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
			  });
			  
			  $('#btnLihat').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  	window.parent.OpenDHTML('anggaran_mutasi_validasi_add.php?reqMode=lihat&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
			  });
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-anggaran/anggaran_mutasi_validasi_json.php?reqPeriode="+ $("#reqPeriode").val() + "&reqStatus=" + $("#reqStatus").val());
			  });
		...
		function setTambah()
		{
			window.parent.OpenDHTML('anggaran_mutasi_validasi_add.php?reqMode=insert&reqPeriode='+$("#reqPeriode").val(), 'Office Management - Administrasi Keuangan', '600', '300');
		}
</script>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Validasi Ppa</span>
            </div>
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" id="btnEdit" title="Edit">Validasi</a>
