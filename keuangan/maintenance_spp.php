...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/maintenance_spp_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(confirm("Set pelunasan " + anSelectedNota + " kartu " + anSelectedSubBantu + " telah dilakukan melalui GL?"))
				  {
						  $.get( "../json-keuangansiuk/maintenance_spp_pelunasan.php?reqId="+anSelectedNota+"&reqKartu="+anSelectedSubBantu, function( data ) {
							  $( ".result" ).html( data );
							  alert(data );
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Maintenance SPP</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnEdit" title="Edit">Set Lunas By GL</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Periode&nbsp;Buku</th>
