...
$kbbr_general_ref_d->selectByParamsRegisterJurnal();
...
<title>transaksi kasir register bukti jurnal</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/transaksi_kasir_register_bukti_jurnal_json.php?reqPeriode=<?=$reqPeriode?>&reqJurnal=<?=$reqJurnal?>",	  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('transaksi_kasir_register_bukti_jurnal_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			   ...
			   $('#btnHapus').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-keuangansiuk/delete.php?reqMode=transaksi_kasir_register_bukti_jurnal&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, function (data) 
					{
			  ...
			  oTable.fnReloadAjax("../json-keuangansiuk/transaksi_kasir_register_bukti_jurnal_json.php?reqPeriode="+ val_periode + "&reqJurnal=" + val_jurnal);
			  });
			  ...
			  return false;
			   ...
			   $('.vmenu .first_li').on('click',function() {
				  if( $(this).children().size() == 1 ) {
					  if($(this).children().text() == 'Register')
					  {
						  $("#btnAdd").click();
					  }
					  else if($(this).children().text() == 'Ubah')
					  {
						  $("#btnEdit").click();
					  }
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Register Bukti JKM/JKK </span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('transaksi_kasir_register_bukti_jurnal_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Register</a>            
            <a href="#" id="btnCetakUlang" title="Cetak Ulang">Cetak Ulang</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="120px">No Dokumen</th>
            <th width="70px">Jenis Jurnal</th>
            <th width="100px">Tanggal&nbsp;Trans</th>
            <th width="250px">Kepada</th>
            <th width="250px">Alamat Agen Perusahan</th>
            <th width="50px">Valuta</th>
            <th width="50px">Kurs</th>
            <th width="100px">Tanggal&nbsp;Posting</th>
    ...
    <!--RIGHT CLICK EVENT -->
    <div class="vmenu">
        <div class="first_li"><span>Register</span></div> 
        <div class="first_li"><span>Cetak Ulang</span></div>
    </div>
    <!--RIGHT CLICK EVENT -->     
</div>
</body>
