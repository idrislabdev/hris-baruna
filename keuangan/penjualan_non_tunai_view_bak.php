...
<div id="wadah">
    ...
    <table style="margin-left:17px;">
        ...
        <tr>
        	<td>NPWP</td>
            <td>
            <input id="reqNpwp" name="reqNpwp" <?=$disabled?> class="easyui-validatebox" style="width:295px" value="<?=$tempNpwp?>" />
        	</td>
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              <td>
              	<input type="text" name="reqPajak[]" id="reqPajak<?=$checkbox_index?>" class="easyui-validatebox" <?=$disabled?> value="<?=$kptt_nota_d->getField("STATUS_KENA_PAJAK_DESC")?>" />
              </td>
              <td>
