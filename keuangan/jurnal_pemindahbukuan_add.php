		...
		$(function(){
          ...
          if($("#reqUnbalance").is(':checked'))
				...
				success:function(data){
					...
					document.location.href = 'jurnal_pemindahbukuan_add.php?reqId='+data[0];
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Jurnal Pemindahbukuan (JKM)</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
			 ...
			 <td>
				...
				<input name="reqPerusahaan" id="reqPerusahaan" class="easyui-validatebox" style="width:295px" type="text" value="<?=$tempPerusahaan?>" onKeyDown="openPopup('PELANGGAN');" tabindex="3" onMouseDown="tabindex=3"/> [F9]
			</td>
             <td rowspan="2" valign="top">Keterangan</td>
			 <td rowspan="2" valign="top">
				<textarea name="reqKeteranganJurnal" style="width:400px; height:80px;" tabindex="5" onMouseDown="tabindex=5"><?=$tempKeteranganJurnal?></textarea>
			</td>
        </tr>
        <tr>           
             <td valign="top">Alamat</td>
			 <td>
  	  	        <textarea name="reqAlamat" id="reqAlamat" style="width:400px; height:80px; background-color:#f0f0f0" readonly><?=$tempAlamat?></textarea>
			</td>
        </tr>
        </thead>
    </table>
          ...
          ?>
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_BUKU_BESAR")?>" style="width:165px"  tabindex="<? $last_tab++; echo $last_tab ?>" />
                  </td>
                  <td>
                    ...
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_SUB_BANTU")?>" style="width:165px"  <? if($kbbt_jur_bb_d_tmp->getField("DISABLE_KARTU") == "DISABLED") {} else { ?> tabindex="<? $last_tab++; echo $last_tab ?>" <? } ?> <?=$kbbt_jur_bb_d_tmp->getField("DISABLE_KARTU")?> />
                  </td>
                  <td>
                    ...
                    value="<?=$kbbt_jur_bb_d_tmp->getField("KD_BUKU_PUSAT")?>" style="width:165px"  <? if($kbbt_jur_bb_d_tmp->getField("DISABLE_BPUSAT") == "DISABLED") {} else { ?> tabindex="<? $last_tab++; echo $last_tab ?>" <? } ?> <?=$kbbt_jur_bb_d_tmp->getField("DISABLE_BPUSAT")?> />
                  </td>
                  <td>
                    <input type="text" name="reqKeterangan[]" class="easyui-validatebox" value="<?=$kbbt_jur_bb_d_tmp->getField("KET_TAMBAH")?>" style="width:95%;"  tabindex="<? $last_tab++; echo $last_tab ?>" />
                  </td>
                  <td>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    "
                    value="" style="width:165px" tabindex="6" onMouseDown="tabindex=6"/>
                  </td>
                  <td>
                  	<input id="reqKartu<?=$checkbox_index?>" name="reqKartu[]" class="easyui-combobox" data-options="
                    filter: function(q, row) { return row['text'].toLowerCase().indexOf(q.toLowerCase()) != -1; },
                  ...
                  <td>
                    <input type="text" name="reqKeterangan[]" class="easyui-validatebox" style="width:95%;" tabindex="9" onMouseDown="tabindex=9" />
                  </td>
                  <td>
                    <input type="text" name="reqDebet[]" id="reqDebet<?=$checkbox_index?>" style="text-align:right; width:95%;" OnFocus="FormatAngka('reqDebet<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqDebet<?=$checkbox_index?>'); hitungDebetTotal('dataTableRowDinamis');setTimeout(setCheckBalance, 1000);" OnBlur="FormatUang('reqDebet<?=$checkbox_index?>')" tabindex="10" onMouseDown="tabindex=10"/>
                  </td>
                  <td>
                    <input type="text" name="reqKredit[]" id="reqKredit<?=$checkbox_index?>" style="text-align:right; width:95%;" OnFocus="FormatAngka('reqKredit<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqKredit<?=$checkbox_index?>'); hitungKreditTotal('dataTableRowDinamis');setTimeout(setCheckBalance, 1000);" OnBlur="FormatUang('reqKredit<?=$checkbox_index?>')" tabindex="11" onMouseDown="tabindex=11"/>
                  </td>
                  <td align="center">
                  <label>
                  <a style="cursor:pointer" onclick="deleteRowDrawTablePhp('dataTableRowDinamis', this)"><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a>
