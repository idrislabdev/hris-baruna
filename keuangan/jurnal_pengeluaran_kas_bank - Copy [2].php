...
$kbbt_jur_bb_tmp->selectByParamsPeriode(array("JEN_JURNAL" => "JKK"), -1, -1, " AND BLN_BUKU IS NOT NULL ");
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"aoColumns": [
			  ...
			  $('#btnCetak').on('click', function () {
			  	 if(anSelectedData == "")
					  return false;	
						newWindow = window.open('jurnal_pengeluaran_kas_bank_rpt.php?reqId='+ anSelectedId, 'Cetak');
						newWindow.focus();					  
