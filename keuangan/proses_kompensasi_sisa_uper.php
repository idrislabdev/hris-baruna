...
$kptt_nota->selectByParamsPeriode(array("TIPE_TRANS" => "JRR-KPT-03"), -1, -1, " AND BLN_BUKU IS NOT NULL ");
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_kompensasi_sisa_super_json.php?reqPeriode=<?=$reqPeriode?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnView').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('proses_kompensasi_sisa_super_view.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('proses_kompensasi_sisa_super_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  	  else
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-keuangansiuk/proses_kompensasi_sisa_super_json.php?reqPeriode="+ $("#reqPeriode").val());
			  ...
			  $('#btnCetak').on('click', function () {
				   if(anSelectedData == "")
						return false;	
						  window.parent.OpenDHTML('jurnal_rupa_rupa_penanda_tangan_jpj.php?reqNoBukti='+ anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');				  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi Pelunasan Uang Titipan (JRR)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('proses_kompensasi_sisa_super_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnCetak" title="Cetak">Cetak</a>
            <a href="#" id="btnView" title="View" <?php /*?>style="display:none"<?php */?>>View</a>
            <?php /*?><a href="#" id="btnCetakBukti" title="Cetak Bukti">Cetak Bukti</a><?php */?>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Tgl&nbsp;Valuta</th>
            <th width="120px">Thn&nbsp;/&nbsp;Bln&nbsp;Buku</th>
            <th width="300px">Rek.&nbsp;Titipan</th>
