...
<title>maintenance anggaran</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/maintenance_anggaran_json.php?reqTahunBuku=<?=$reqTahunBuku?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedBantu = element[1];
					  anSelectedPusat = element[2];
			  });
			  
			  $('#reqTahunBuku').combotree({
				  onSelect: function(param){
					  oTable.fnReloadAjax("../json-keuangansiuk/maintenance_anggaran_json.php?reqTahunBuku="+param.id);
				  }
				});
...
<div id="wadah">
    ...
    <div style="position: absolute; margin-top:5px; margin-left:180px; z-index:9999; font-size:12px;">
        Tahun : <input id="reqTahunBuku" class="easyui-combotree" name="reqTahunBuku" data-options="url:'../json-keuangansiuk/tahun_combo_json.php?reqMode=anggaran'" style="width:100px;" value="<?=$reqTahunBuku?>" />
    </div>
