...
<head>
	...
	<script type="text/javascript">
		...
		function OptionSetPembayaran(anSelectedId, anSelectedKode, anSelectedSiswa, anSelectedNilai, anSelectedCOA)
		{
			 
			document.getElementById('reqKodeKasBank').value = anSelectedCOA;
			document.getElementById('reqNoRef2').value = anSelectedKode;
			document.getElementById('reqNoRef3').value = anSelectedId;
			document.getElementById('reqKeterangan').value = "PELUNASAN UANG TITIPAN " + anSelectedSiswa;
			$("#alternatecolor").html("");
			$.get("proses_kompensasi_sisa_super_add_template.php?reqId="+anSelectedKode, function (data) {
		...
		function openPopup()
		{
			...
			$('#reqNoRef3').keyup(function (e) {
				if(e.which == 120)
				{
					OpenDHTMLPopup('proses_kompensasi_sisa_super_pencarian.php', 'Pencarian Data Siswa', 950, 600);
					return false;
				}
			});
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Pelunasan Uang Titipan (JRR)</span>
    </div>
    ...
    <table>
        ...
        <tr>           
             <td>Nomor Bukti Uang Titipan</td>
			 <td>
                <input name="reqNoRef3" readonly id="reqNoRef3" class="easyui-validatebox" style="width:60%;" type="text" onKeyDown="openPopup()"  value="<?=$reqNoRef3?>"  />   <!--onKeyDown="openPopup();"-->
                <input type="text" readonly name="reqNoRef2" id="reqNoRef2" class="easyui-validatebox" style="width:80px" type="text" value="<?=$reqNoRef2?>" tabindex="3"  />
                <input name="reqBadanUsaha" id="reqBadanUsaha" class="easyui-validatebox" style="width:295px" type="hidden" value="SISWA" readonly />
			</td>
            <td>BB Uang Titipan</td>
			 <td>
