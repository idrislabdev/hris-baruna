...
<title>rincian mutasi jurnal</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  ...
			  $('#btnExcel').live('click', function () {
				newWindow = window.open('rincian_mutasi_jurnal_excel.php?reqStatusPosting='+ $("#reqStatusPosting").val() + "&reqTanggalMulai="+ $('#reqTanggalMulai').datebox('getValue') +"&reqTanggalAkhir="+ $('#reqTanggalAkhir').datebox('getValue') +"&reqJenisJurnal="+$("#reqJenisJurnal").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
...
<div id="wadah">
	...
	<table>
		...
		<tr>
        	<td>Tanggal Mulai</td>
            <td><input id="reqTanggalMulai" name="" class="easyui-datebox" data-options="validType:'date', panelWidth:'230'" /></td>
        </tr>
		<tr>
        	<td>Tanggal Akhir</td>
            <td><input id="reqTanggalAkhir" name="" class="easyui-datebox" data-options="validType:'date', panelWidth:'230'" /></td>
        </tr>
        <tr>
        	<td>Jenis Jurnal</td>
            <td>
