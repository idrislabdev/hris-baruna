...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/pegawai_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedNissKadet= element[element.length-2];
...
</head><body style="overflow:hidden" onLoad="setValue();">
