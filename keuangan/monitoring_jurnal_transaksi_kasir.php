...
<title>monitoring jurnal transaksi kasir</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/monitoring_jurnal_transaksi_kasir_json.php?reqJurnal=<?=$reqJurnal?>&reqPosting=0&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			  ...
			  $("#reqJurnal").change(function() { 
				 ...
				 val_posting= $("#reqPosting").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/monitoring_jurnal_transaksi_kasir_json.php?reqJurnal="+ val_jurnal + "&reqPosting=" + val_posting +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/monitoring_jurnal_transaksi_kasir_json.php?reqJurnal="+ $("#reqJurnal").val() + "&reqPosting=" + $("#reqPosting").val());
			  });
