...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_kompensasi_sisa_super_pencarian_json.php?reqId=<?=$reqId?>&reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedCOA = element[2];
					  anSelectedKode = element[4];
					  anSelectedSiswa = element[5];
					  anSelectedNilai = element[6];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPembayaran(anSelectedId, anSelectedKode, anSelectedSiswa, anSelectedNilai, anSelectedCOA);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Uang Titipan Siswa</span>
            </div>            
            </td>
            <td style="text-align:right;">
            <span><b>Apabila data tidak muncul, Posting JKM terlebih dahulu!</b></span>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>	
            ...
            <th width="70px">No.&nbsp;Nota</th>          
			<th width="70px">COA</th>       
			<th width="70px">Tgl&nbsp;Posting</th>      
			<th width="70px">Sub&nbsp;Bantu</th> 
			<th width="70px">Siswa</th>
			<th width="70px">Titipan</th>
