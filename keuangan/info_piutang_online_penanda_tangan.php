...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
				$('#btnCetak').live('click', function () {
				  newWindow = window.open('info_piutang_online_rpt.php?reqKode='+ $("#reqKode").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val(), 'Cetak');
				  newWindow.focus();				  
				 	window.parent.divwin.close();	
				});
			  
			   $('#btnExcel').live('click', function () {
					newWindow = window.open('info_piutang_online_excel.php?reqKode='+ $("#reqKode").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val(), 'Cetak');
					newWindow.focus();	
				 	window.parent.divwin.close();		
			  });
