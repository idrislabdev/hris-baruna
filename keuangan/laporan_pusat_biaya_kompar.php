...
<title>pusat biaya kompar</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				$.getJSON('../json-keuangansiuk/pusat_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val()+'&reqCabang='+$("#reqCabang").val(),
				  function(data){
					newWindow = window.open('pusat_biaya_kompar_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val()+'&reqCabang='+$("#reqCabang").val(), 'Cetak');
					newWindow.focus();
				});
			  ...
			  $('#btnExcel').live('click', function () {
				$.getJSON('../json-keuangansiuk/pusat_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val()+'&reqCabang='+$("#reqCabang").val(),
				  function(data){
					newWindow = window.open('pusat_biaya_kompar_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val()+'&reqCabang='+$("#reqCabang").val(), 'Cetak');
					newWindow.focus();
				});
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Perhitungan Laba/Rugi Komparatif Menurut Pusat Biaya</span>
            </div>            
            </td>
        </tr>
    </table>
