...
<script type="text/javascript">
	...
	function setValue()
	{
		$('#reqTanggalAwalAproval').datebox('setValue', '<?=date("d-m-Y")?>');	
		$('#reqTanggalAkhirAproval').datebox('setValue', '<?=date("d-m-Y")?>');	
	}
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/cetak_bukti_jurnal_gl_json.php?reqPeriode=<?=$reqPeriode?>&reqJurnal=<?=$reqJurnal?>&reqPosting=0",
			...
			sDeleteURL: "../json-keuangansiuk/delete.php?reqMode=cetak_bukti_jurnal_gl",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" id="btnTertanda" title="Tertanda">Tertanda</a>
