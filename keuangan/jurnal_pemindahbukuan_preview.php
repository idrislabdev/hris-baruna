...
$an_jabatan= "A.N. PRESIDENT DIRECTOR";
...
$set->selectByParamsJKMPemindahbukuan(array(), -1, -1,$statement);
//echo $set->query;exit;
while($set->nextRow())
{
	...
	//$arrData[$index_set]["NM_BUKU_BESAR_WITH_PARENT"]= nl2br($set->getField("NM_BUKU_BESAR_WITH_PARENT"));
...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			?>
			// buat header
			header="   PT. PELINDO PROPERTI INDONESIA                         TANGGAL PROSES    : <?=dateToPageCheck($arrData[$arrDataIndex[$param_index]]["TGL_TRANS"])?>\n";
			header+="   ----------------------------                           HALAMAN           : ";
			headerHalaman+="\n                             BUKTI PENERIMAAN KAS-BANK\n";
			headerHalaman+="                            ===========================\n\n";
			headerHalaman+="   NO BUKTI  : <?=$arrData[$arrDataIndex[$param_index]]["NO_NOTA"]?>                                         TANGGAL  : <?=dateToPageCheck($arrData[$arrDataIndex[$param_index]]["TGL_TRANS"])?>\n";
			headerHalaman+=" |=============================================================================================|\n";
			rowHeader=9;
			...
			?>
				...
				//temp=fillStringCompletor(temp,"43"," ","");
			...
			temp= " |";
			temp=fillStringCompletor(temp,"47","-","|");
			temp=fillStringCompletor(temp,"66"," ","");
			temp+="<?=$an_jabatan?>";
			var panjangJabatan= panjangString("<?=$an_jabatan?>");
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			isiValue+=temp+"\n";
			...
			temp=fillStringCompletor(temp,"68"," ","");
			temp+="<?=$jabatan?>";
			var panjangJabatan= panjangString("<?=$jabatan?>");
			temp=fillStringCompletor(temp,"95"," ","|");
			var panjangTemp= panjangString(temp);
			//alert(temp+'--'+panjangTemp);
			isiValue+=temp+"\n";
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                <div id="laporan-header-kiri">
                    <div><span class="dash-bawah" style="display:inline; padding-bottom:20px;">PT. PELINDO PROPERTI INDONESIA</span></div>
            ...
            <div style="display: table;">
                ...
                <div id="tabel" style="display: table-row;">            
                    ...
                    <div style="display: table-cell;">
                    	<span>
							<?=$tempKdBukuBesar?>&nbsp;&nbsp;&nbsp;<?=$tempKdSubBantu?>&nbsp;&nbsp;&nbsp;<?=$tempKdBukuPusat?>
                            <br />
                            <?
							$tempKetTambahanUsd= $tempKetTambahanNilaiUsd="";
							if(strtoupper($tempKdValuta) == "IDR"){}
                            ...
                            ?>
							<?=$tempNamaBukuBesar.$tempKetTambahanNilaiUsd.$tempKetTambahanUsd?>
                            </span>
                    </div>
