...
$(document).ready(function() {
	...
	oTable = $("#example").dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			 ...
			 "aoColumns": [ 
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/jurnal_jkk_asset_json.php?reqPeriode=<?=$reqPeriode?>",
	...
	$('#btnEdit').on('click', function () {
		...
		if(anSelectedNoPosting == '' || anSelectedNoPosting.length != 6)
		  window.parent.OpenDHTML('jurnal_jkk_asset_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
		else
	...
	$('#reqPeriode').combobox({
	  onSelect: function(param){
		  if(param.text == 'Semua')
			  document.location.href = 'jurnal_jkk_asset.php?reqMode=all';
		  else		  
		  	  document.location.href = 'jurnal_jkk_asset.php?reqPeriode='+ param.id;
	  }
	});
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Pengeluaran Kas Bank (JKK) Asset </span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jurnal_jkk_asset_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
