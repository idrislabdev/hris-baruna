...
$reqFasilitas = httpFilterGet("reqFasilitas");
$reqKdKartu = httpFilterGet("reqKdKartu");
$reqSdKdKartu = httpFilterGet("reqSdKdKartu");
...
//------  Variables ------
$file_name	= "RINCIAN_FASIL_AKTIF_RUPIAH";
...
$zz = $creport->ParameterFields(1)->SetCurrentValue($reqKelompok);
$zz = $creport->ParameterFields(2)->SetCurrentValue($reqFasilitas);
$zz = $creport->ParameterFields(3)->SetCurrentValue($reqKdKartu);
$zz = $creport->ParameterFields(4)->SetCurrentValue($periode);
$zz = $creport->ParameterFields(5)->SetCurrentValue($reqSdKdKartu);
...
$name = $file_name."_".$reqKdKartu."_".$reqSdKdKartu."_".$reqPeriode.".xls";
