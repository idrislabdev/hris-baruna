...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  ...
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('laporan_harian_mutasi_kas_bank_rpt.php?reqTanggal='+ $('#reqTanggal').datebox('getValue') +'&reqPeriode=' + periode + '&reqMengetahui=' + $("#reqMengetahui").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('laporan_harian_mutasi_kas_bank_excel.php?reqTanggal='+ $('#reqTanggal').datebox('getValue') +'&reqPeriode=' + periode + '&reqMengetahui=' + $("#reqMengetahui").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Mutasi Harian Kas Bank</span>
            </div>            
            </td>
        </tr>
    </table>
