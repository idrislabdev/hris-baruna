...
<title>report penanda tangan</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-intranet/report_penanda_tangan_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('report_penanda_tangan_add.php?reqId='+anSelectedId, 'Office Management - Administrasi Intranet', '800', '580');	
			  });
			  
			  <?php /*?>$('#btnSetting').on('click', function () {
				  window.parent.OpenDHTML('report_penanda_tangan_setting.php?reqId='+anSelectedId, 'Office Management - Administrasi Intranet', '400', '280');
			  });<?php */?>
			  ...
			  return false;
			   ...
			   $('.vmenu .inner_li span').on('click',function() {												
					  if($(this).text() == 'xx')
					  {
						  $.getJSON('../json-intranet/report_penanda_tangan_set_status.php?reqId='+anSelectedId+'&reqNilai=1', function (data) 
						  {
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <?php /*?><a href="#" id="btnSetting" title="Edit">Setting</a><?php */?>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="150px">Jenis Report</th> 
            <th width="150px">Nama (Kiri)</th> 
            <th width="150px">Jabatan (Kiri)</th> 
            <th width="150px">Nama (Tengah)</th> 
            <th width="150px">Jabatan (Tengah)</th> 
            <th width="150px">Nama (Kanan)</th> 
            <th width="150px">Jabatan (Kanan)</th> 
        </tr>
    </thead>
    </table> 
    </div> 
