...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/cetak_bukti_jurnal_ar_json.php?reqJenisJurnal=<?=$tempJenisJurnal?>",
			...
			sDeleteURL: "../json-keuangan/delete.php?reqMode=cetak_bukti_jurnal_ar",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $("#reqJenisJurnal").change(function() { 
					...
					else
					{
				 	...
				 	oTable.fnReloadAjax("../json-keuangansiuk/cetak_bukti_jurnal_ar_json.php?reqJenisJurnal="+ val_jurnal +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval+"&reqTanggalAwalNotaCetak="+ val_tanggal_awal_nota+"&reqTanggalAkhirNotaCetak="+ val_tanggal_akhir_nota);
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnCari" title="Cari Nota">Cari Nota</a>
   ...
   <div style="position: absolute; margin-top:8px; margin-left:180px; z-index:9999; font-size:12px;">
        Transaksi Approval
        <input id="reqTanggalAwalAproval" name="reqTanggalAwalAproval" class="easyui-datebox" style="width:77px" />
        s/d
        <input id="reqTanggalAkhirAproval" name="reqTanggalAkhirAproval" class="easyui-datebox" style="width:77px" />
        &nbsp;&nbsp;
    	Jenis Jurnal : 
        <select name="reqJenisJurnal" id="reqJenisJurnal" style="width:200px">
		<?
