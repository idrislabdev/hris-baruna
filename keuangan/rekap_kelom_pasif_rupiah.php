...
<title>rekap kelom pasif rupiah</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rekap_kelom_pasif_rupiah_rpt.php?reqPeriode='+ $("#reqPeriode").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			    $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rekap_kelom_pasif_rupiah_excel.php?reqPeriode='+ $("#reqPeriode").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Daftar Mutasi Piutang Berdasarkan Kelompok (PUPN Rupiah)</span>
            </div>            
            </td>
        </tr>
    </table>
