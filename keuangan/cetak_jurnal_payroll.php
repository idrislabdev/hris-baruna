...
$kbbr_general_ref_d->selectByParamsJurnal(array(), -1, -1, " AND ID_REF_DATA IN ('JKK', 'JKM') ");
...
<title>cetak jurnal payroll</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/cetak_jurnal_payroll_json.php?reqPeriode=<?=$reqPeriode?>&reqJurnal=<?=$reqJurnal?>&reqPosting=0&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			  ...
			  $("#reqJurnal").change(function() { 
				  ...
				  val_posting= $("#reqPosting").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/cetak_jurnal_payroll_json.php?reqPeriode="+ val_periode + "&reqJurnal=" + val_jurnal + "&reqPosting=" + val_posting+"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/cetak_jurnal_payroll_json.php?reqPeriode="+ $("#reqPeriode").val() + "&reqJurnal=" + $("#reqJurnal").val() + "&reqPosting=" + $("#reqPosting").val());
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Cetak Jurnal Payroll</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div style="position: absolute; margin-top:30px; margin-left:176px; z-index:9999; font-size:12px;">
        <?php /*?>Periode : <select name="reqPeriode" id="reqPeriode">
				  ...
				  {
				  ?>
                  	<option value="<?=$arrPeriode[$i]?>"><?=getNamePeriode($arrPeriode[$i])?></option>
                  <?	  
				  }
				  ?>
        		  </select>&nbsp;&nbsp;<?php */?>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnLihat" title="Lihat">Lihat</a><?php */?>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">No&nbsp;Reg&nbsp;Kasir</th>
            <th width="120px">Pendukung&nbsp;3</th>
