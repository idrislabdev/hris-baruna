...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Pelunasan SPP Siswa</span>
    </div>
    ...
    <table>
        ...
        <tr>
        	<td colspan="4">
            <div>
                <input type="hidden" name="reqDepartemenId" value="99">
            ...
            for (var i = 0; i <= jsondata.length; i++) {
				...
				else
				{
					...
					else
					{
						arrNRP.push(nis);
						//alert(nis + ' ' + nilai);
						$.get("proses_pelunasan_pembayaran_add_template.php?reqId="+nis+"&reqNilai="+nilai, function (data) {
							$("#alternatecolor").append(data);
						});	
    ...
    <table>
        <tr>
        	<td>Upload data pelunasan SPP <strong>SISWA</strong> (<a href="uploads/template_pelunasan.xlsx">download template</a>)</td>
