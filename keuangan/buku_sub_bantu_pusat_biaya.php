...
$kbbr_buku_besar->selectByParams(array("A.KD_AKTIF"=>"A"), -1, -1, "AND A.KD_BUKU_BESAR BETWEEN NVL ('499.99.01', '801.01.00') AND NVL ('990.02.00', '888.88.88') ", " ORDER BY KD_BUKU_BESAR ASC ");
...
<title>buku sub bantu pusat biaya</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('buku_sub_bantu_pusat_biaya_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val() +"&reqA="+$("#reqA").val() +"&reqB="+$("#reqB").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			   $('#btnExcel').live('click', function () {
			  	newWindow = window.open('buku_sub_bantu_pusat_biaya_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val() +"&reqA="+$("#reqA").val() +"&reqB="+$("#reqB").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Buku Sub Bantu Biaya Pusat</span>
            </div>            
            </td>
        </tr>
    </table>
