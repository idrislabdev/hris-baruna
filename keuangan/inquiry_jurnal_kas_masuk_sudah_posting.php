...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/inquiry_jurnal_kas_masuk_sudah_posting_json.php?reqPeriode=<?=$reqPeriode?>&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
			  	 val_periode= $("#reqPeriode").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_masuk_sudah_posting_json.php?reqPeriode="+ val_periode +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 //oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_masuk_sudah_posting_json.php?reqPeriode="+ $("#reqPeriode").val());
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Inquiry Jurnal Kas Masuk Sudah Posting</span>
            </div>            
            </td>
        </tr>
    </table>
