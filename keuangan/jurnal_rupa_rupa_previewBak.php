...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			header+="                                                        HALAMAN       : ";
			headerHalaman+="                             BUKTI JURNAL RUPA-RUPA\n";
			headerHalaman+="                            =============================\n";
			headerHalaman+="   NO SIUK  : <?=$reqNoBukti?>                                         TANGGAL  : <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?>\n";
			headerHalaman+=" |==========================================================================================   |\n";
			rowHeader=7;
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                <div id="laporan-header-kiri">
                    ...
                    <div><br /><br /><br /><span>NO SIUK : <?=$reqNoBukti?></span></div>
                </div>
                <div id="laporan-header-tengah">
                    <div><br /><br /><span class="dash-bawah" style="display:inline;">BUKTI JURNAL RUPA-RUPA</span></div>
                </div>
                <div id="laporan-header-kanan">
                    ...
                    <div style="position:absolute; bottom:0; right:0;"><span>TANGGAL : <?=dateToPageCheck($arrData[0]["TGL_TRANS"])?></span></div>
                </div>
            </div>
        ...
        <div id="laporan-isi-area" class="dash-kiri dash-kanan">
            ...
            <div style="display: table;">
                ...
                <div id="tabel" style="display: table-row;">            
					...
					<?=$tempNamaBukuBesarParent?> <?=$tempNamaSubBantu?> <?=$tempNamaBukuPusat?></span>
                    </div>
