<?
include_once("file:///X|/WEB-INF/classes/utils/UserLogin.php");
include_once("file:///X|/WEB-INF/functions/string.func.php");
include_once("file:///X|/WEB-INF/functions/default.func.php");
include_once("file:///X|/WEB-INF/functions/date.func.php");
include_once("file:///X|/WEB-INF/classes/base-simpeg/PegawaiJabatan.php");
include_once("file:///X|/WEB-INF/classes/base/DeleteRowUser.php");
...
<head>
    ...
    <link href="file:///X|/simpeg/css/begron.css" rel="stylesheet" type="text/css">
    <link href="file:///X|/simpeg/css/admin.css" rel="stylesheet" type="text/css">
    <link href="file:///X|/WEB-INF/lib/media/themes/main_datatables.css" rel="stylesheet" type="text/css" /> 
</head>
<body>
<div id="begron"><img src="file:///X|/simpeg/images/bg-kanan-polos.jpg" width="100%" height="100%" alt="Smile"></div>
<div id="wadah">
	...
	?>
    	<tr onClick="parent.frames['mainFrameDetilPop'].location.href = 'pegawai_add_jabatan.php?reqId=<?=$reqId?>&reqRowId=<?=$pegawai_jabatan->getField("PEGAWAI_JABATAN_ID")?>'">
            ...
            <td><a href="#" onClick="if(confirm('Apakah anda yakin ingin menghapus data ini?')) { window.location.href = 'pegawai_add_jabatan_monitoring.php?reqMode=delete&reqId=<?=$pegawai_jabatan->getField("PEGAWAI_ID")?>&reqDeleteId=<?=$pegawai_jabatan->getField("PEGAWAI_JABATAN_ID")?>' }"><img src="file:///X|/WEB-INF/images/delete-icon.png"></a></td>
        </tr>    
    <?
	}
	?>    
