			  ...
			  $('#btnCetakNota').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId=<?=$reqId?>',
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
						  newWindow = window.open('penjualan_non_tunai_cetak_nota_rpt.php?reqId=<?=$reqId?>', 'Cetak');
						  newWindow.focus();					
					  }
					  else
					  	  alert(data.STATUS);

					  document.location.href = 'penjualan_non_tunai_add.php?reqId=<?=$reqId?>';		
...
<div id="wadah">
    ...
    <table style="margin-left:17px;">
        ...
        <tr>
            ...
            <td>
				<input name="reqKeterangan" class="easyui-validatebox" style="width:408px" type="text" value="<?=$tempKeterangan?>" tabindex="12" onMouseDown="tabindex=12"/>
            </td>
        </tr>
        <tr>
            <td>Kode Valuta</td>
			<td>
                ...
                &nbsp;&nbsp;
                Materai
	            <select name="reqMateraiPilih" id="reqMateraiPilih" tabindex="6" onFocus="tabindex=6">
        ...
        <tr>
        	<td>Faktur Pajak</td>
            <td colspan="3">
            <input id="reqFakturPajakPrefix" name="reqFakturPajakPrefix" class="easyui-validatebox" required data-options="validType:'minLength[3]'" maxlength="3" style="width:30px" value="<?=$tempFakturPajakPrefix?>" tabindex="7" onMouseDown="tabindex=7" />.
            <input id="reqFakturPajak" class="easyui-combobox" name="reqFakturPajak" data-options="valueField:'id',textField:'text', url:'../json-keuangansiuk/faktur_pajak_aktif_combo_json.php?reqTanggal=<?=$tempTanggalTransaksi?>'" style="width:139px;" value="<?=$tempFakturPajak?>" tabindex="8" onMouseDown="tabindex=8"/>&nbsp;
            ...
            Tgl. Faktur <input id="reqTanggalFakturPajak" name="reqTanggalFakturPajak" class="easyui-datebox" required data-options="validType:'date'" value="<?=$tempTanggalFakturPajak?>" tabindex="9" onMouseDown="tabindex=9"/></td>
        </tr>
        </thead>
    </table>
    ...
    <!--<table class="example altrowstable" id="alternatecolor" >-->
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              <td>
                ...
                "
                validType="exists['#reqKlasTrans<?=$checkbox_index?>']"
                value="" tabindex="13" onMouseDown="tabindex=13" />
              </td>
              <td>
              	<input type="text" name="reqPajak[]" id="reqPajak<?=$checkbox_index?>" class="easyui-combobox" data-options="
                required: true,
              ...
              <td>
              	<input type="text" name="reqNilaiJasa[]"  id="reqNilaiJasa<?=$checkbox_index?>" style="text-align:right" OnFocus="FormatAngka('reqNilaiJasa<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqNilaiJasa<?=$checkbox_index?>'); hitungSemua('<?=$checkbox_index?>');" OnBlur="FormatUang('reqNilaiJasa<?=$checkbox_index?>')" tabindex="15" onMouseDown="tabindex=15"/>
              </td>
              <td>
