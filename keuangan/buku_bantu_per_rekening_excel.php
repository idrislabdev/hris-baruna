...
//echo $reqDariRekening;


//------  Variables ------
$file_name	= "BUKU_BANTU_PER_REKENING";
...
{
	$statement = "{Command.KD_BUKU_BESAR} IN ('".$reqA."') TO ('".$reqB."') ";
}
...
//$akhirbulan = cal_days_in_month(CAL_GREGORIAN, $bulan, $tahun);
if ($bulan<=12)
$tanggal = strtoupper(getNamePeriode($reqPeriode));
else
$tanggal = "DESEMBER AUDIT ".$tahun;
