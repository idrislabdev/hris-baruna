...
<title>Buku&nbsp;Besar per rekening</title>
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('badan_usaha_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Buku&nbsp;Besar Per Rekening (LB7)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('badan_usaha_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            ...
            <th rowspan="2" class="th_like" width="100px">Nomor</th>
            <th rowspan="2" class="th_like" width="300px">Sumber Buku Jurnal</th>
            <th colspan="2" class="th_like" width="250px">Mutasi</th> 
            <th rowspan="2" class="th_like" width="50px">D/K</th>
            <th rowspan="2" class="th_like" width="150px">Saldo</th>   
        </tr>
        <tr>
