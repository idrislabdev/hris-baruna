    ...
    <tbody> 
      ...
      ?>
          <tr id="node-<?=$i?>">
              ...
              <td align="center">
              	<input type="checkbox" name="reqStatusVerifikasi[<?=$checkbox_index?>]" id="reqStatusVerifikasi<?=$checkbox_index?>" <? if($anggaran_mutasi_detil->getField("STATUS_VERIFIKASI") == 1) echo "checked";?> />
              </td>
          </tr>
      <?
	  	$i++;
