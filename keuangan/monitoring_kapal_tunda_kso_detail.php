...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/cetak_bukti_jurnal_ar_detail_json.php?reqId=<?=$reqId?>",						  
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pendataan_add_monitoring_add.php?reqMode=insert&reqId=<?=$reqId?>&reqInventarisId=<?=$reqInventarisId?>', 'Office Management - Aplikasi Keuangan', '800', '450');" title="Tambah">Tambah Item</a>
    ...
    <div id="rightclickarea"> <!--RIGHT CLICK EVENT -->
        ...
        <thead>
            <tr>
                ...
                <th width="70px">Buku&nbsp;Besar</th>                                            
                <th width="50px">Bantu</th>    
                <th width="50px">Kurs&nbsp;Valuta</th>    
                <th width="70px">Saldo&nbsp;Val&nbsp;Debet</th>    
                <th width="70px">Saldo&nbsp;Val&nbsp;Kredit</th>  
                <th width="70px">Saldo&nbsp;Rp&nbsp;Debet</th>    
                <th width="70px">Saldo&nbsp;Rp&nbsp;Kredit</th>     
