...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pph_4_ayat_2_json.php?reqPeriode=<?=date("Ym")?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnLihat').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('tahun_pembukuan_lihat.php?reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('tahun_pembukuan_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $('#btnHapus').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-keuangansiuk/delete.php?reqMode=tahun_pembukuan&id='+anSelectedId, function (data) 
					{
			 ...
			 $('#reqPeriode').combobox({
					onSelect: function(param){
						oTable.fnReloadAjax("../json-keuangansiuk/pph_4_ayat_2_json.php?reqPeriode="+param.id);
					}
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> PPh 4 Ayat 2</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnLihat" title="Lihat">Lihat</a>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('tahun_pembukuan_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            <th rowspan="2" style="text-align:center" width="50px">Kode Rek</th>
            <th rowspan="2" style="text-align:center" width="120px">Nama Rekening</th>
            <th colspan="2" style="text-align:center">Nomor&nbsp;Bukti</th>
            <th rowspan="2" style="text-align:center" width="350px">Keterangan</th>
            <th rowspan="2" style="text-align:center" width="85px">Jenis Jasa</th>
            <th rowspan="2" style="text-align:center" width="185px">Nama WP</th>
            <th rowspan="2" style="text-align:center" width="85px">Nomor NPWP</th>
            <th colspan="2" style="text-align:center" width="85px">Bukti Pemotongan</th>
            <th colspan="2" style="text-align:center" width="85px">Jumlah Biaya</th>
            <th rowspan="2" style="text-align:center" width="85px">Total Biaya</th>
            <th rowspan="2" style="text-align:center" width="85px">Jumlah Obyek<br> PPh</th>
            <th rowspan="2" style="text-align:center" width="55px">Tarif Efektif</th>
            <th rowspan="2" style="text-align:center" width="85px">Jumlah PPh<br> di potong</th>
            <th rowspan="2" style="text-align:center" width="15px">Post</th>
        </tr>
        <tr>
        	<th style="text-align:center" width="40px">JKM</th>
        	<th style="text-align:center" width="40px">JKK</th>
        	<th style="text-align:center" width="40px">Nomor</th>
        	<th style="text-align:center" width="40px">Tanggal</th>
        	<th style="text-align:center" width="40px">Bahan</th>
        	<th style="text-align:center" width="40px">Jasa</th>
        </tr>
    </thead>
    </table> 
    </div> 
