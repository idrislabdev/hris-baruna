...
<head>
	...
	function addRowDrawTables(tableID) {
        ...
        var element4= document.createElement("input");
        element4.type = "text";
		element4.name = "reqJumlahDikembalikan["+ id_row +"]";
		element4.id = "reqJumlahDikembalikan"+id_row;
		element4.style.width = '100px';
		element4.className='easyui-validatebox';
		element4.onfocus = function() {  
			FormatAngka("reqJumlahDikembalikan"+id_row);
		};
		element4.onkeyup = function() {  
			FormatUang("reqJumlahDikembalikan"+id_row);
		};
		element4.onblur = function() {  
			FormatUang("reqJumlahDikembalikan"+id_row);
		};
...
<div id="wadah">
    ...
    <ol id="toc" style="margin-bottom:-1px; margin-top:-3px;">
        ...
        <li><a href="pembatalan_kompensasi_add_data_detil_jurnal.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>"><span>Jurnal</span></a></li>
    </ol>
    ...
    <tbody> 
      ...
      ?>
          <tr id="node-$kapal_sertifikat_kapal->getField('SERTIFIKAT_KAPAL_ID')">
          	  <td><?=$i+1?></td>
              <td>
              <input type="text" name="reqNoNota[<?=$checkbox_index?>]" style="width:80px" class="easyui-validatebox" value="" />
              </td>
              <td>
              ...
              <td>
              	<input type="text" style="width:100px;" name="reqJumlahDikembalikan[<?=$checkbox_index?>]"  id="reqJumlahDikembalikan<?=$checkbox_index?>"  OnFocus="FormatAngka('reqJumlahDikembalikan<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqJumlahDikembalikan<?=$checkbox_index?>')" OnBlur="FormatUang('reqJumlahDikembalikan<?=$checkbox_index?>')" value="<?=numberToIna($tempNilaiTransaksi)?>">
              </td>
              <td>
