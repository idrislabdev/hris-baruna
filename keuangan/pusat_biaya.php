    ...
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				$.getJSON('../json-keuangansiuk/pusat_biaya_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('pusat_biaya_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});
			  ...
			  $('#btnExcel').live('click', function () {
				$.getJSON('../json-keuangansiuk/pusat_biaya_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('pusat_biaya_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});
