...
$set->selectByParamsJPJ(array(), -1, -1,$statement);
// echo $set->query;exit();
while($set->nextRow())
{
...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			// buat header Detil
			var temp= " | 1. Harap dibukukan Transaksi Penjualan Sebesar ";
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                ...
                <div id="laporan-header-tengah">
                    <div><br /><br /><span class="dash-bawah" style="display:inline;">BUKTI PENJUALAN JASA</span></div>
                </div>
    ...
    <div id="main" style="position:relative;">
        ...
        <div style="float:left; border:0px solid #C66;">
            ...
            <div id="laporan-uraian">
                <div style="float:left; width:100%;"><span>1. Harap dibukukan Transaksi Penjualan Sebesar : Rp. <?=numberToIna($arrData[$checkbox_index]["JML_RP_TRANS"])?></span></div>
