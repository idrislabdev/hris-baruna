...
<title>jurnal pemindahbukuan</title>
	...
	$('#example tbody').on( 'click', 'tr', function () {
	  ...
	  $('#btnEdit').on('click', function () {
		  ...
		  if(anSelectedNoPosting == '')
			  window.parent.OpenDHTML('jurnal_pemindahbukuan_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
		  else
	  ...
	  $('#btnCetak').on('click', function () {
		   if(anSelectedData == "")
			  return false;	
				window.parent.OpenDHTML('jurnal_pemindahbukuan_penanda_tangan.php?reqNoBukti='+ anSelectedId, 'Cetak');
	  });
	  
	$('#reqPeriode').combobox({
	  onSelect: function(param){
		  if(param.text == 'Semua')
			  document.location.href = 'jurnal_pemindahbukuan.php?reqMode=all';
		  else				  
		  	  document.location.href = 'jurnal_pemindahbukuan.php?reqPeriode='+ param.id;
	  }
	});
