...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			header+="                                                        HALAMAN       : ";
			headerHalaman+="                             BUKTI PENJUALAN JASA\n";
			headerHalaman+="                            =============================\n";
    ...
    <div id="main" style="position:relative;">
        ...
        <div style="float:left; border:0px solid #C66;">
            ...
            <div id="laporan-uraian">
                <div style="float:left; width:100%;"><span>1. Harap dibukukan Transaksi Penjualan Sebesar : Rp. <?=numberToIna($arrData[0]["JML_RP_TRANS"])?></span></div>
        ...
        <div id="laporan-isi-area" class="dash-kiri dash-kanan">
            ...
            <div style="display: table;">
                ...
                <div id="tabel" style="display: table-row;">            
                    ...
                    <div style="display: table-cell;"><span><?=$tempKdBukuBesar?> <?=$tempKdBukuPusat?><br /><?=$tempNamaBukuBesar?></span></div>
