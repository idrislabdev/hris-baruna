...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-keuangansiuk/jurnal_tutup_tahun_add.php',
				onSubmit:function(){
				...
				success:function(data){
					...
					document.location.href = 'jurnal_tutup_tahun_add.php?reqId='+data[0];
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
          ...
          ?>
              <tr id="node-<?=$i?>">
                  ...
                  <td align="center">
                  <label>
                  <a style="cursor:pointer" onclick="deleteRowDrawTablePhp('dataTableRowDinamis', this)"><!--<img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" />--><span class="merah">&otimes;</span></a>
                  </label>
                  </td>
              </tr>
			  <?
