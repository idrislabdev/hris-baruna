...
$total = $kbbt_neraca_saldo->getSumByParamsSaldoNeracaBantuRincian(array("BULTAH" => $reqPeriode, "KD_VALUTA" => $reqKodeValuta, "KD_KUSTO" => $reqId));
...
<title>saldo neraca vs bantu rincian</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/saldo_neraca_vs_bantu_rincian_json.php?reqId=<?=$reqId?>&reqPeriode=<?=$reqPeriode?>&reqKodeValuta=<?=$reqKodeValuta?>",			  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Nota</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
           <a href="#" id="btnTutup" title="Tutup">Tutup</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="150px">Tgl&nbsp;Trans</th>
            <th width="150px">Saldo</th>
         </tr>
    </thead>
    <tfoot>
    	<td colspan="2" style="text-align:right; font-weight:bold">Total</td>
        <td style="font-weight:bold"><?=numberToIna($total)?></td>
    </tfoot>
    </table> 
    </div> 
    <!--RIGHT CLICK EVENT -->
