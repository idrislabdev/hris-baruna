...
$reqSdKartu = httpFilterGet("reqSdKartu");
...
//------  Variables ------
$file_name	= "RINCIAN_KELOM_PASIF_RUPIAH";
...
$zz = $creport->ParameterFields(2)->SetCurrentValue($reqKartu);
$zz = $creport->ParameterFields(3)->SetCurrentValue($reqSdKartu);
$zz = $creport->ParameterFields(4)->SetCurrentValue($periode);
$zz = $creport->ParameterFields(5)->SetCurrentValue($bulan);
...
$name = $file_name."_".$reqKartu."_".$reqSdKartu."_".$reqPeriode.".pdf";
