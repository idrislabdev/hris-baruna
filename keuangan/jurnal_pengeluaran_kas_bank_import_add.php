...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Konfirmasi Import Data Jurnal Pengeluaran Kas Bank (JKK)</span>
    </div>
    ...
    <table style="margin-left:17px;">
        ...
        <tr>           
			 ...
			 <td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input  type="text" id="reqTahun" name="reqTahun" class="easyui-validatebox" data-options="validType:'minLength[4]'" maxlength="4" style="width:100px; background-color:#f0f0f0" value="<?=$tempTahun?>" />
                <input  type="text" id="reqBulan" name="reqBulan" class="easyui-validatebox" data-options="validType:'minLength[2]'" maxlength="2" style="width:50px; background-color:#f0f0f0" value="<?=$tempBulan?>" />
			</td>
          ...
          ?>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    ...
                    value="" style="width:165px" tabindex="10" onMouseDown="tabindex=10"/>
                  </td>
                  <td>
