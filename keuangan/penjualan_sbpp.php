...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/penjualan_sbpp_json.php?reqPeriode=<?=$reqPeriode?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('penjualan_sbpp_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  	  else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KPTT_NOTA&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=penjualan_sbpp&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  $('#btnCetakNotaInvoice').on('click', function () {
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
						  window.parent.OpenDHTML('penjualan_sbpp_cetak_nota_rpt.php?reqId='+ anSelectedId, 'Cetak');
						  						  
						  oTable.fnReloadAjax("../json-keuangansiuk/penjualan_sbpp_json.php?reqPeriode="+ $("#reqPeriode").val());
					  }
					  else
					  	  alert(data.STATUS);
				 ...
				 /* if(anSelectedData == "")
				  ...
				  $.getJSON('../json-keuangansiuk/proses_cetak_nota_penjualan_cetak.php?reqId='+anSelectedId,
					function(data){
					  ...
					  if(data.STATUS == "1")
					  {
						  window.parent.OpenDHTML('penjualan_sbpp_cetak_sbpp_rpt.php?reqId='+ anSelectedId, 'Cetak');
			  ...
			  $('#btnScreenInvoice').on('click', function () {
				  if(anSelectedData == "")
					  return false;			
				  window.parent.OpenDHTML('penjualan_sbpp_cetak_nota_rpt.php?reqId='+ anSelectedId, 'Cetak');
			  ...
			  $('#btnScreenSbpp').on('click', function () {
				  if(anSelectedData == "")
					  return false;			
				  window.parent.OpenDHTML('report_penanda_tangan_sbpp.php?reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
				  //window.parent.OpenDHTML('penjualan_sbpp_cetak_sbpp_rpt.php?reqId='+ anSelectedId, 'Cetak');
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi SBPP (JPJ)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('penjualan_sbpp_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
          <li><a href="#" id="btnScreenInvoice">Invoice</a></li>
          <li><a href="#" id="btnScreenSbpp">SBPP</a></li>
        </ul>  
        <ul id="flexmenu2" class="flexdropdownmenu">
          <li><a href="#" id="btnCetakNotaInvoice">Invoice</a></li>
          <li><a href="#" id="btnCetakNotaSbpp">SBPP</a></li>
        </ul>  
    </div>
    ...
    <div class="vmenu">
        ...
        <div class="first_li"><span>Screen</span>
            <div class="inner_li"> 
                ...
                <span id="clickScreenSBPP">SBPP</span> 
            </div>
        </div>
        <div class="first_li"><span>Print</span>
            <div class="inner_li"> 
                <span id="clickPrintInvoice">Invoice</span> 
                <span id="clickPrintSBPP">SBPP</span> 
            </div>
        </div>
