...
//------  Variables ------
$file_name	= "CETAK_BUKTI_JURNAL_AR_".$reqJenisJurnal;
...
$PejabatKiri = $arrPejabatKiri[0];
$JabatanKiri = $arrPejabatKiri[1];
...
//------ Read the records :-P -------
$zz = $creport->ParameterFields(1)->SetCurrentValue($PejabatKiri);
$zz = $creport->ParameterFields(2)->SetCurrentValue($JabatanKiri);
