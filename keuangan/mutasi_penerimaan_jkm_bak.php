...
<title>mutasi penerimaan jkm</title>
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			/* Click event handler */
			  ...
			  $('#btnCetak').on('click', function () {
			  	newWindow = window.open('mutasi_penerimaan_jkm_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Mutasi Penerimaan(JKM)</span>
            </div>            
            </td>
        </tr>
    </table>
