...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pelanggan_pencarian_json.php",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedBadanUsaha = element[1];
					  anSelectedNama = element[3];
					  anSelectedAlamat = element[4];
					  anSelectedNPWP = element[5];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSet(anSelectedId, anSelectedNama, anSelectedAlamat, anSelectedNPWP, anSelectedBadanUsaha);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Maintenance Master Pelanggan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="70px">NPWP</th>
            <th width="70px">Jenis Usaha</th>
        </tr>
    </thead>
    </table> 
    </div> 
