...
$reqC = httpFilterGet("reqC");
$reqD = httpFilterGet("reqD");
...
//------  Variables ------
$file_name	= "BUKU_SUB_BANTU_NERACA";
...
{
	$statementA = "{Command.KD_REKENING} IN ('".$reqA."') TO ('".$reqB."') ";
}
...
{
	$statementB .= " {Command.KD_KARTU} IN ('".$reqC."') TO ('".$reqD."') ";
}
...
elseif($statementB == "")
	...
	$statement = $statementA." AND ".$statementB;
...
$zz = $creport->ParameterFields(1)->SetCurrentValue((int)$reqHalaman);
