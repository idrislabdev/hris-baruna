...
$kbbt_jur_bb_tmp->selectByParamsPeriode(array("JEN_JURNAL" => "JRR"), -1, -1, " AND BLN_BUKU IS NOT NULL ");
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			sDeleteURL: "../json-keuangansiuk/delete.php?reqMode=jurnal_rupa_rupa",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			  ...
			  $('#btnCetak').on('click', function () {
			  	 if(anSelectedData == "")
					  return false;	
						newWindow = window.open('jurnal_rupa_rupa_rpt.php?reqId='+ anSelectedId, 'Cetak');
						newWindow.focus();					  
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-keuangansiuk/jurnal_rupa_rupa_json.php?reqPeriode="+ $("#reqPeriode").val());
