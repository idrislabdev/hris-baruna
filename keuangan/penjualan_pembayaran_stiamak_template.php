...
$statement = " AND NOT EXISTS(SELECT 1 FROM KPTT_NOTA_D X WHERE X.KD_SUB_BANTU = A.MPLG_KODE AND X.PERIODE_PEMBAYARAN = '".$reqPeriodeSPP."' ".$notStatement." ) ";
...
?>
    ...
    <a style="cursor:pointer" onclick="hapusRow('<?=$kbbt_jur_bb_d->getField("MPLG_KODE")?>'); $(this).parent().parent().parent().remove(); hitungUlang();"><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a>
    </label>
    </td>
    </tr>
  <?
