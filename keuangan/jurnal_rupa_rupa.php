...
$(document).ready(function() {
	...
	oTable = $("#example").dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			 ...
			 "aoColumns": [ 
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/jurnal_rupa_rupa_json.php?reqPeriode=<?=$reqPeriode?>",
		  ...
		  anSelectedNoPosting = element[1];	
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('jurnal_rupa_rupa_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
			  	  else
			...
			$('#btnCopy').on('click', function () {
				...
				$('#reqPeriode').combobox({
				  onSelect: function(param){
					  if(param.text == 'Semua')
						  document.location.href = 'jurnal_rupa_rupa.php?reqMode=all';
					  else						  
					      document.location.href = 'jurnal_rupa_rupa.php?reqPeriode='+ param.id;
				  }
				});
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Rupa-rupa</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jurnal_rupa_rupa_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jurnal_rupa_rupa_import.php', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Import">Import</a>
			</li>
        </ul>
    </div>
