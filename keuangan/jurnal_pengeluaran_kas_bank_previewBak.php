...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			header+="                                                        HALAMAN       : ";
			headerHalaman+="                             BUKTI PENGELUARAN KAS-BANK\n";
			headerHalaman+="                            =============================\n";
        ...
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                ...
                <div id="laporan-header-tengah">
                    <div><br /><br /><span class="dash-bawah" style="display:inline;">BUKTI PENGELUARAN KAS-BANK</span></div>
                </div>
    ...
    <div id="main" style="position:relative;">
        ...
        <div style="float:left; border:0px solid #C66;">
            ...
            <div id="laporan-uraian">
                <div style="float:left; width:100%;"><span>1. Pemegang Kas Harap membayarkan uang sebesar : Rp. <?=numberToIna($arrData[0]["JML_RP_TRANS"])?></span></div>
