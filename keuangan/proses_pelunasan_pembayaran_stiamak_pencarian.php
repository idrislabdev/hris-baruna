...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_pelunasan_pembayaran_stiamak_pencarian_json.php?reqId=<?=$reqId?>&reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPembayaran(anSelectedId, anSelectedKelasId, anSelectedNama);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Nota SPP Siswa</span>
            </div>            
            </td>
    ...
    <thead>
        <tr>	
            ...
            <th width="70px">No.&nbsp;PPKB</th>  
            <th width="170px">Keterangan</th>         
			<th width="70px">Total Tagihan</th>
            <th width="70px">Sudah Bayar</th>
