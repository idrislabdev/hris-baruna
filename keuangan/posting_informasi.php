...
$reqId = "'".str_replace(",","','",$reqId)."'";

$kbbt_jur_bb->selectByParams(array(), -1,-1, " AND NO_NOTA IN (".$reqId.") ");
?>
...
<div id="wadah">
    ...
    <tbody> 
      ...
      ?>
          <tr id="node-<?=$i?>">
              <td>
              	<?=$kbbt_jur_bb->getField("NO_NOTA")?>
              </td>
              <td>
              	<?=getFormattedDate($kbbt_jur_bb->getField("TGL_POSTING"))?>
              </td>
              <td>
              	<?=$kbbt_jur_bb->getField("NO_POSTING")?>
              </td>
           </tr>
      <?
	  	$i++;
