...
//------  Variables ------
$file_name	= "BUKTI_PENERIMAAN_KAS_BANK";
...
$zz = $creport->ParameterFields(7)->SetCurrentValue($reqParam4);
...
/*
$name = $file_name."_".$statement1.".rpt";

$len = filesize("$my_pdf");
header("Content-type: application/rpt");
