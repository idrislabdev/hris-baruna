...
<style type="text/css" media="screen">
	...
	$('#reqPeriode').combobox({
	  onSelect: function(param){
		  if(param.text == 'Semua')
			  document.location.href = 'jurnal_penerimaan_kas_bank.php?reqMode=all';
		  else
			  document.location.href = 'jurnal_penerimaan_kas_bank.php?reqPeriode='+ param.id;
	  }
	});
...
<div id="wadah">
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th>Id</th>
            <th width="100px">No&nbsp;Bukti&nbsp;(SIUK)</th>
            <th width="100px">Bukti&nbsp;Pendukung</th>
            <th width="90px">Tgl&nbsp;Trans</th>
            <th width="250px">Agen/Perusahaan</th>
            <th width="30px">Valuta</th>
            <th width="30px">Kurs</th>   
