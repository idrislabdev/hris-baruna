...
<head>
	...
	<script type="text/javascript">
		...
		function OptionSetKelas(anSelectedDepId, anSelectedDepKelasId, anSelectedNama, anSelectedJumlah,anSelectedJumlahSiswa){

			if(anSelectedJumlahSiswa == 0)
			{

				alert("Data " + anSelectedNama + " belum memiliki data siswa.");
				return;
			...
			$.get("penjualan_pembayaran_add_template.php?reqNota=<?=$reqId?>&reqId="+anSelectedDepKelasId+"&reqPeriodeSPP="+$("#reqPeriodeSPP").val(), function (data) {
				$("#alternatecolor").append(data);
				
				if (typeof data === "undefined" || data.trim() == "")
					alert("Semua siswa " + anSelectedNama + " telah dibuat JPJ pada periode " + $("#reqPeriodeSPP option:selected").text());
    ...
    <table style="margin-left:17px;">
        ...
        <tr>  
			...
			<td>  
                ...
                <input name="reqDepartemenKelas" id="reqDepartemenKelas" class="easyui-validatebox" style="width:70%;" type="text" readonly value="<?=$reqDepartemenKelas?>" onKeyDown="openPopup('PELANGGAN');" />&nbsp;<span style="color:#ff0000;" >(F9)</span>
			</td> 
        ...
        <tr>
        	<td>Tanggal Transaksi</td>
			 <td>
                ...
                &nbsp;&nbsp;
                <input id="reqTanggalValutaPajak" type="hidden" name="reqTanggalValutaPajak" style="width:114px; background-color:#f0f0f0" readonly value="<?=$tempTanggalValutaPajak?>" />
			</td>
            <td>Keterangan</td>
			<td>
