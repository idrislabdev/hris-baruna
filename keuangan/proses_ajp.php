...
$kbbt_jur_bb_tmp->selectByParamsPeriode(array("TIPE_TRANS" => "JRR-KBB-13"), -1, -1, " AND BLN_BUKU IS NOT NULL ");
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/proses_ajp_json.php?reqPeriode=<?=$reqPeriode?>",			  
		...
		$("#btnRincianJurnal").click();	
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
					  window.parent.OpenDHTML('proses_ajp_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
		  	      else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KBBT_JUR_BB&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=PROSES_AJP&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  $('#btnCetak').on('click', function () {
			  	  if(anSelectedData == "")
					  return false;		
					window.parent.OpenDHTML('proses_ajp_penanda_tangan.php?reqNoBukti='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-keuangansiuk/proses_ajp_json.php?reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Ayat Jurnal Penyesuaian (AJP)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('proses_ajp_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
