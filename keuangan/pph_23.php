...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pph_23_json.php?reqPeriode=<?=date("Ym")?>",			  
			...
			/* Click event handler */
			 ...
			 $('#reqPeriode').combobox({
					onSelect: function(param){
						oTable.fnReloadAjax("../json-keuangansiuk/pph_23_json.php?reqPeriode="+param.id);
					}
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> PPh 23</span>
            </div>            
            </td>
        </tr>
    </table>
