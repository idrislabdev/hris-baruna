...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/koreksi_tagihan_sudah_pencarian_json.php?reqId=<?=$reqId?>&reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  NO_NOTA = element[0];
					  KD_SUB_BANTU = element[1];
					  MPLG_NAMA = element[2];
					  JML_VAL_TRANS = element[3];
					  KD_BUKU_BESAR = element[4];
					  KLAS_TRANS = element[5];
					  
			  });
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPembayaran(NO_NOTA, KD_SUB_BANTU, MPLG_NAMA, JML_VAL_TRANS, KD_BUKU_BESAR, KLAS_TRANS);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data JPJ Tagihan</span>
            </div>            
            </td>
            <td style="text-align:right;">
            <span><b>Apabila data tidak muncul, artinya JPJ Pelunasan belum diposting</b></span>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>	
            ...
            <th width="170px">Tanggal Trans</th>
            <th width="70px">Total Transaksi</th>
        </tr>
    </thead>
    </table> 
    </div> 
