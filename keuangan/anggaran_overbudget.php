...
<title>anggaran overbudget</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-anggaran/anggaran_overbudget_json.php?reqPeriode=<?=$reqPeriode?>",
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  //window.parent.OpenDHTML('anggaran_overbudget_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Aplikasi Keuangan', '600', '300');	
				  window.parent.OpenDHTML('anggaran_overbudget_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');
			  });
			   ...
			   $('#btnHapus').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-anggaran/delete.php?reqMode=anggaran_overbudget&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, function (data) 
					{
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-anggaran/anggaran_overbudget_json.php?reqPeriode="+ $("#reqPeriode").val());
		...
		function setTambah()
		{
			window.parent.OpenDHTML('anggaran_overbudget_add.php?reqMode=insert&reqPeriode='+$("#reqPeriode").val(), 'Office Management - Administrasi Keuangan', '600', '300');
		}
</script>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Anggaran Overbudget</span>
            </div>
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnAdd" onClick="setTambah()" title="Tambah">Tambah</a><?php */?>
            <a href="#" id="btnEdit" title="Edit">Lihat</a>
            <?php /*?><a href="#" id="btnHapus" title="Hapus">Hapus</a><?php */?>
            </li>        
        </ul>
    </div>
