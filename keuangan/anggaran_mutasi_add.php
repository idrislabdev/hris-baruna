...
if($reqMode == "lihat")
{
	$link="anggaran_mutasi_validasi_add_data_lihat"; 
	$link_detil="anggaran_mutasi_validasi_add_data_lihat_detil";
}
else
{
	$link="anggaran_mutasi_add_data"; 
	$link_detil="anggaran_mutasi_add_data_detil";
}
?>
...
<script>
  function OpenDHTML(opAddress, opCaption, opWidth, opHeight)
  {
	...
	function OptionSet(id, bukupusat, bukubesar){
		window.frames["mainFramePop"].OptionSet(id, bukupusat, bukubesar);
	}	
   	...
   	<tr> 
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="50%">
                	<td><iframe src="<?=$link?>.php?reqId=<?=$reqId?>&reqPeriode=<?=$reqPeriode?>" class="mainframe" id="idMainFrame" name="mainFramePop" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
                </tr>
            	<tr height="50%" id="trdetil">
                	<td><iframe src="<?=$link_detil?>.php?reqId=<?=$reqId?>&reqPeriode=<?=$reqPeriode?>" class="mainframe" id="idMainFrameDetil" name="mainFrameDetilPop" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
                </tr>
            </table>			
		</td>
	</tr>
