...
$tahunlalu=$tahunint-1;

$reqPeriode2 = $bulan.$tahunlalu;

$periode_ti = strtoupper(getNamePeriodeKeu($reqPeriode));
$periode_tl = strtoupper(getNamePeriodeKeu($reqPeriode2));

$zz = $creport->ParameterFields(1)->SetCurrentValue($tanggal);
$zz = $creport->ParameterFields(2)->SetCurrentValue($periode_ti);
$zz = $creport->ParameterFields(3)->SetCurrentValue($periode_tl);
