	...
	***************************************************************************/ 
	function printWeb(file) {
		...
		window['qzDoneAppending'] = function() {
			qz.setPaperSize("11.0in", "11.0in");  // US Letter
            qz.setAutoSize(true);
			qz.print();
	...
	printWeb('http://192.168.88.98:8080/jasperserver/flow.html?_flowId=viewReportFlow&reportUnit=%2Freports%2FJURNAL_PENERIMAAN_KAS_BANK_COBA&standAlone=true&j_acegi_security_check&j_username=jasperadmin&j_password=jasperadmin&output=txt&NOTA_IN_PARAM=<?=$statement?>');
