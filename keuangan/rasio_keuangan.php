...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				//alert('exec PROCEDURE Summary_Neraca_Saldo');
				$.getJSON('../json-keuangansiuk/rasio_keuangan_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('rasio_keuangan_rpt.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});					
			  });	
			   ...
			   $('#btnExcel').live('click', function () {
				...
				$.getJSON('../json-keuangansiuk/rasio_keuangan_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('rasio_keuangan_excel.php?reqHalaman='+ $("#reqHalaman").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});					
			  });	
	});
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Laporan Rasio Keuangan</span>
            </div>            
            </td>
        </tr>
    </table>
