...
<title>ikhtisar per kelompok</title>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('ikhtisar_per_kelompok_rpt.php?reqPeriode='+ $("#reqPeriode").val()+'&reqValuta='+ $("#reqValuta").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('ikhtisar_per_kelompok_excel.php?reqPeriode='+ $("#reqPeriode").val()+'&reqValuta='+ $("#reqValuta").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
</script>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Ikhtisar Mutasi Piutang</span>
            </div>            
            </td>
        </tr>
    </table>
	...
	<table>
        ...
        <tr>
        	<td>Valuta</td>
            <td>
            	<select name="reqValuta" id="reqValuta">
