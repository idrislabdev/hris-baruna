...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> View Data Pelunasan Uang Titipan (JRR)</span>
    </div>
    ...
    <table>
        ...
        <tr>           
			 ...
			 <td>
                <input name="reqNoRef3" readonly id="reqNoRef3" class="easyui-validatebox" style="width:60%;" type="text" value="<?=$reqNoRef3?>"  />   <!--onKeyDown="openPopup();"-->
