...
<title>proses akhir tahun proses ajt</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangan/proses_akhir_tahun_proses_ajt_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('proses_akhir_tahun_proses_ajt_detil_monitoring.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Proses AJT (Login User AJT)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('proses_akhir_tahun_proses_ajt_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="200px">No / Tanggal Posting</th>
            <th width="200px">No&nbsp;Bukti</th>
            <th width="250px">Bukti&nbsp;Pendukung</th>
            <th width="250px">Bulan Di Buku</th>
            <th width="250px">Tanggal&nbsp;Transaksi</th>
            <th width="50px">Agen&nbsp;/&nbsp;Perusahaan</th>
            <th width="150px">Alamat</th>
            <th width="150px">Valuta</th>
            <th width="150px">Kurs&nbsp;Valuta</th>
