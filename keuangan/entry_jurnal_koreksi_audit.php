...
<title>entry jurnak koreksi audit</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/entry_jurnal_koreksi_audit_json.php",			  
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
			       ...
			       if(anSelectedNoPosting == '')
					  window.parent.OpenDHTML('entry_jurnal_koreksi_audit_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
		  	      else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KBBT_JUR_BB&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=JURNAL_JRR_AUDIT&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
			  ...
			  return false;
			   ...
			   $('.vmenu .first_li').on('click',function() {
				  if( $(this).children().size() == 1 ) {
					  ...
					  else if($(this).children().text() == 'Cetak Bukti Jurnal')
					  {
					  $("#btnCetakJurnal").click();
					  }
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Rupa-Rupa (JRR) Untuk Koreksi Audit</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('entry_jurnal_koreksi_audit_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnCetak" title="Cetak Bukti Jurnal">Cetak Bukti Jurnal</a>
    ...
    <div class="vmenu">
        ...
        <div class="first_li"><span>Cetak Bukti Jurnal</span></div> 
