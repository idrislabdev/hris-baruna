...
<?php /*?>	var jumlah_total=0;
	...
	{
		parent.frames["mainFramePop"].setJumlah();
		/*setChecked(false);
...
<div id="wadah">
    ...
    <thead>
      <tr>
          ...
          <?php /*?><th style="width:5%">Aksi</th><?php */?>
      </tr>
    </thead>
    <tbody> 
	  <?
      ...
      ?>
          <tr id="node-<?=$i?>">
              ...
              <td align="center">
              	<input type="text" style="width:100px;" name="reqHargaSatuan[]" id="reqHargaSatuan<?=$checkbox_index?>"  OnFocus="FormatAngka('reqHargaSatuan<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqHargaSatuan<?=$checkbox_index?>'); hitungJumlahHargaUnit('<?=$checkbox_index?>', 'dataTableRowDinamis');" OnBlur="FormatUang('reqHargaSatuan<?=$checkbox_index?>')" value="<?=numberToIna($anggaran_mutasi_detil->getField('HARGA_SATUAN'))?>" readonly>
              </td>
              <td align="center">
              ...
              <td align="center">
              	<input type="checkbox" name="reqStatusVerifikasi[]" id="reqStatusVerifikasi<?=$checkbox_index?>"  />
              </td>
             <?php /*?> <td align="center">
              <label>
      ...
      <?
	  	$i++;
		$checkbox_index++;
		$temp_jml_debet += $anggaran_mutasi_detil->getField('JUMLAH');
        //$temp_jml_kredit += $anggaran_mutasi_detil->getField('SALDO_VAL_KREDIT');
      }
      ?>
    </tbody>
    </table>
