	...
	<script type="text/javascript">
		...
		function OptionSetPPKB(index, id){
			...
			function(data){				
				...
				document.getElementById('reqJumlahBayar'+index).value = 0;
				document.getElementById('reqSisaBayar'+index).value = data.SISA_TAGIHAN;
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
          ...
          ?>
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                  <input type="text" name="reqNoPpkb[]" id="reqNoPpkb<?=$checkbox_index?>" class="easyui-validatebox" value="<?=$kptt_nota_d->getField("NO_REF3")?>" readonly />
                  </td>
                  <td>
