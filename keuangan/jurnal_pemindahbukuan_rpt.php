...
//------  Variables ------
$file_name	= "JURNAL_PEMINDAHBUKUAN";
...
$arrayPejabat=explode("-",$reqPejabat);
$pejabat=$arrayPejabat[0];
$jabatan=$arrayPejabat[1];
...
$zz = $creport->ParameterFields(5)->SetCurrentValue($statement);
