...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rekap_fasil_aktif_valas_rpt.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rekap_fasil_aktif_valas_excel.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
	});
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekapitulasi Piutang Aktif Per Segmen / Fasilitas (Valas)</span>
            </div>            
            </td>
        </tr>
    </table>
