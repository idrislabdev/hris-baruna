...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-keuangansiuk/jurnal_pengeluaran_kas_bank_add.php',
				onSubmit:function(){
				...
				success:function(data){
					...
					document.location.href = 'jurnal_pengeluaran_kas_bank_add.php?reqId='+data[0];
        ...
        <tbody class="example altrowstable" id="alternatecolor"> 
          ...
          ?>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" name="reqTanggalFakturPajak[]" id="reqTanggalFakturPajak<?=$checkbox_index?>" class="easyui-datebox" value="<?=dateToPageCheck($kbbt_jur_bb_d_tmp->getField("TGL_FAKTUR_PAJAK"))?>" style="width:95%;" tabindex="<? $last_tab++; echo $last_tab ?>" onMouseDown="tabindex=<?=$last_tab?>"/>
                  </td>
                  <td>
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" name="reqFakturPajak[]" class="easyui-validatebox" style="width:95%;" tabindex="11" onMouseDown="tabindex=11"/>
                  </td>
                  <td>
                    <input type="text" name="reqTanggalFakturPajak[]" class="easyui-datebox" style="width:95%;" tabindex="12" onMouseDown="tabindex=12"/>
                  </td>
                  <td>
                    <input type="text" name="reqKeterangan[]" class="easyui-validatebox" style="width:95%;" tabindex="13" onMouseDown="tabindex=13"/>
                  </td>
                  <td>
                    <input type="text" name="reqDebet[]" id="reqDebet<?=$checkbox_index?>" style="text-align:right; width:95%;" OnFocus="FormatAngka('reqDebet<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqDebet<?=$checkbox_index?>'); hitungDebetTotal('dataTableRowDinamis');setTimeout(setCheckBalance, 1000);" OnBlur="FormatUang('reqDebet<?=$checkbox_index?>')" tabindex="14" value="0" />
                  </td>
