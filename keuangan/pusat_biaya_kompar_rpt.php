...
//------  Variables ------
$file_name	= "PUSAT_BIAYA_KOMPAR_RUPIAH";
...
$tanggal_kini = strtoupper(getNamePeriodeKeu($reqPeriode));
$tanggal_lalu = strtoupper(getNamePeriodeKeu($bulan.$tahun_lalu));
//echo $tanggal_lalu;exit;
}
else
{
$tanggal = "31 JUNI AJP ".$tahun ;
$tanggal_kini = $tanggal; //strtoupper(getNamePeriodeKeu($reqPeriode));
$tanggal_lalu = $tanggal; // strtoupper(getNamePeriodeKeu($bulan.$tahun_lalu));
}
...
$zz = $creport->ParameterFields(5)->SetCurrentValue($tanggal_kini);
