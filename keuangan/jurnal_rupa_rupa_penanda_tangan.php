...
<script type="text/javascript" charset="utf-8">
    	...
    	$(document).ready( function () {
				$('#btnCetakPdf').live('click', function () {
				  	newWindow = window.open('jurnal_rupa_rupa_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Pdf');
				  	newWindow.focus();				  
				 	$('.closeImg', top.document).click();	
				});
			  
			    $('#btnCetakPreview').live('click', function () {
					OpenDHTMLPopup('jurnal_rupa_rupa_preview.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Rincian Jurnal', 900, 600)	
			    });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Bukti Jurnal Rupa - Rupa</span>
            </div>            
            </td>
        </tr>
    </table>
