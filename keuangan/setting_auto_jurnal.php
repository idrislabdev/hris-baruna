...
<title>setting auto jurnal</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/setting_auto_jurnal_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnSetting').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('setting_auto_jurnal_add.php?reqRowId='+anSelectedRowId+'&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '1000', '500');
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <?php /*?><a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('valuta_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a><?php */?>
            <a href="#" id="btnSetting" title="Setting">Ubah</a>
            </li>        
        </ul>
    </div>
