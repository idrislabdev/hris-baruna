...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/departemen_kelas_pencarian_json.php",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedDepId = element[0];
					  anSelectedDepKelasId = element[1];
					  anSelectedNama = element[2];
					  anSelectedJumlah= element[3];
					  anSelectedJumlahSiswa= element[4];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetKelas(anSelectedDepId, anSelectedDepKelasId, anSelectedNama, anSelectedJumlah,anSelectedJumlahSiswa);	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Master Kelas</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="70px">Total SPP</th>
            <th width="70px">Jumlah Siswa</th>
            <th width="70px">Jumlah Siswa (sudah entri SPP)</th>
        </tr>
    </thead>
    </table> 
    </div> 
