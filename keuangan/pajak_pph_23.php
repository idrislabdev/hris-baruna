...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/inquiry_jurnal_kas_keluar_belum_posting_json.php",			  
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('inquiry_jurnal_kas_keluar_belum_posting_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            <th rowspan="2">Id</th>
            <th rowspan="2" width="100px">Kode Rek.</th>
            <th rowspan="2" width="200px">Nama Rekening</th>
            <th colspan="2" style="text-align:center">Nomor&nbsp;Bukti</th>
            <th rowspan="2" width="300px">Keterangan</th>
            <th rowspan="2" width="100px">Jenis Jasa</th>
            <th rowspan="2" width="200px">Nama Wp</th>
            <th rowspan="2" width="100px">Nomor Npwp</th>
            <th colspan="2" style="text-align:center">Bukti Pemotongan</th>
            <th colspan="2" style="text-align:center">Jumlah Biaya</th>
            <th rowspan="2" width="150px">Total Biaya</th>
            <th rowspan="2" width="150px">Jumlah Obyek Pajak</th>
            <th rowspan="2" width="100px">Tarif Efektif</th>
            <th rowspan="2" width="150px">Jumlah Pph Dipotong</th>
            <th rowspan="2" width="100px">Posting</th>
        </tr>
        <tr>
			<th width="150px">Jkm</th>
            <th width="150px">Jkk</th>
			<th width="150px">Nomor</th>
            <th width="150px">Tanggal</th>
			<th width="150px">Bahan</th>
            <th width="150px">Jasa</th>
        </tr>
    </thead>
    </table> 
    </div> 
