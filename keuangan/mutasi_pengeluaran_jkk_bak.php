...
<title>mutasi pengeluaran jkk</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/badan_usaha_json.php",			  
			...
			sDeleteURL: "../json-keuangansiuk/delete.php?reqMode=badan_usaha",
			sAddHttpMethod: "GET",  
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('badan_usaha_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Administrasi Master Data', '600', '300');	
			  });
			  ...
			  $('#btnCetak').on('click', function () {
			  	newWindow = window.open('mutasi_pengeluaran_jkk_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Mutasi Pengeluaran(JKK)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('badan_usaha_add.php?reqMode=insert', 'Office Management - Administrasi Master Data', '600', '300');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnDeleteRow" title="Hapus">Hapus</a>
            </li>  
            <li><a href="#" title="Cetak" id="btnCetak"><img src="images/pegawai-open.png" />&nbsp;Cetak</a></li>       
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Nomor Bukti</th>
            <th width="100px">No. Posting</th>
            <th width="100px">Rekening Debet <br> Rekening Kredit</th>
            <!--<th width="100px">Rekening Kredit</th>-->
            <th width="100px">Jumlah Debet</th>
            <th width="100px">Jumlah Kredit</th>
        </tr>
    </thead>
    </table> 
    </div> 
