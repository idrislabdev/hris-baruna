...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
				$('#btnCetak').live('click', function () {
					/*$.getJSON('jurnal_pembelian_pemborongan_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(),
					function(data){
				  	...
				  	newWindow = window.open('jurnal_pembelian_pemborongan_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabatKiri='+ $("#reqPejabatKiri").val()+'&reqPejabatTengah='+ $("#reqPejabatTengah").val()+'&reqPejabatKanan='+ $("#reqPejabatKanan").val(), 'Cetak');
				  	newWindow.focus();				  
				 	window.parent.divwin.close();	
				});
			  
			   $('#btnExcel').live('click', function () {
					newWindow = window.open('jurnal_pembelian_pemborongan_excel.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Cetak');
					newWindow.focus();	
				 	window.parent.divwin.close();		
			  });
			  
			  $('#btnCetakPreview').live('click', function () {
					OpenDHTMLPopup('jurnal_pembelian_pemborongan_preview.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Rincian Jurnal', 900, 600)	
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Jurnal Pembelian Pemborongan (JPB)</span>
            </div>            
            </td>
        </tr>
    </table>
