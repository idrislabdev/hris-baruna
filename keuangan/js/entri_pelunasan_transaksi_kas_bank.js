function addRow()
{
	...
	button.innerHTML = '<center><input type="hidden" name="reqBukuBesar[]" id="reqBukuBesar'+rownum+'" value=""><input type="hidden" name="reqPrevNoNota[]" id="reqPrevNoNota'+rownum+'" value=""><a style="cursor:pointer;" onclick="deleteRowDrawTable(\'dataTableRowDinamis\', this)"><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a></center>';
	...
	$('#reqNoPpkb'+rowCount).keydown(function(e) {
		if(e.which==120)
		{
			OpenDHTMLPopup('proses_pelunasan_transaksi_kas_bank_pencarian.php?reqIndex='+rowCount+'&reqId='+$("#reqNoPelanggan").val()+'&reqKdValuta='+$("#reqValutaNama").val(), 'Pencarian Pelanggan', 950, 600);
		}
	});
