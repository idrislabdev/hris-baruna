function addRow()
{
	...
	$( "#reqBukuBesar"+rowCount).autocomplete({ source:'../json-keuangansiuk/buku_besar_combo_v2_json.php', 
	...
	$( "#reqLokasi"+rowCount).autocomplete({ source:'../json-keuangansiuk/lokasi_combo_json.php', 
											   autoFocus: true 
											}).autocomplete( "instance" )._renderItem = function( ul, item ) {
												return $( "<li>" )
											  .append( "<a>" + item.label + "<br>" + item.desc + "</a>" )
	...
	$( "#reqKeterangan"+rowCount).autocomplete({ source:'../json-keuangansiuk/asset_combo_json.php?reqJenis='+$("#reqBukuBesar"+rowCount).val(), 
											   autoFocus: true 
											}).autocomplete( "instance" )._renderItem = function( ul, item ) {
												return $( "<li>" )
											  .append( "<a>" + item.label + "<br>" + item.desc + "</a>" )
