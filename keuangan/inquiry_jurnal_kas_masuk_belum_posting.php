...
<title>inquiry jurnal kas masuk belum posting</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/inquiry_jurnal_kas_masuk_belum_posting_json.php?reqPeriode=<?=$reqPeriode?>&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			 $('#example tbody tr').on('dblclick', function () {
			  ...
			  var val_periode= val_tanggal_awal_approval=val_tanggal_akhir_approval="";
			  ...
			  $("#reqPeriode").change(function() { 
					...
					oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_masuk_belum_posting_json.php?reqPeriode="+ val_periode +"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
				 	//oTable.fnReloadAjax("../json-keuangansiuk/inquiry_jurnal_kas_masuk_belum_posting_json.php?reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Inquiry Jurnal Kas Masuk Belum Posting</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div style="position: absolute; margin-top:30px; margin-left:180px; z-index:9999; font-size:12px;">
        <?php /*?>Periode : <select name="reqPeriode" id="reqPeriode">
        		  <?
