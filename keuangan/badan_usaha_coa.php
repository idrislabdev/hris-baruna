...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/badan_usaha_coa_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('badan_usaha_coa_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekening Piutang Pelanggan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th colspan="2" style="text-align:center">Piutang Usaha</th>
            <th colspan="2" style="text-align:center">Penyisihan Piutang Usaha</th>
            <th colspan="2" style="text-align:center">Reduksi Pendapatan</th>
            <th colspan="2" style="text-align:center">Uper / Uang Panjar</th>
            <th colspan="2" style="text-align:center">Uang Titipan / Sisa Uper</th>
            <th rowspan="2" width="50px">Status</th> 
        </tr>
        <tr>
            <th width="150px">Rupiah</th>
            <th width="150px">Valas</th>
            <th width="150px">Rupiah</th>
            <th width="150px">Valas</th>
            <th width="150px">Rupiah</th>
            <th width="150px">Valas</th>
