...
$set->selectByParamsJRR(array(), -1, -1,$statement);
//echo $set->query;
while($set->nextRow())
{
	...
	//KETERANGAN_DETIL, SALDO_VAL_DEBET, SALDO_VAL_KREDIT, SALDO_RP_DEBET, SALDO_RP_KREDIT, KD_VALUTA, NO_POSTING, TGL_POSTING
...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			?>
			// buat header
			header="   PT. PELINDO PROPERTI INDONESIA                           REPORT ID.    : KBB_BKT_JRR_ENTRY\n";
