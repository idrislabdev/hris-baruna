...
//------  Variables ------
$file_name	= "RINCIAN_KELOM_AKTIF_RUPIAH";
...
$zz = $creport->ParameterFields(3)->SetCurrentValue($reqKelompok);
$zz = $creport->ParameterFields(4)->SetCurrentValue($reqKartu);
$zz = $creport->ParameterFields(5)->SetCurrentValue($reqSdKartu);
$zz = $creport->ParameterFields(6)->SetCurrentValue($periode);
