    ...
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
				...
				$.getJSON('../json-keuangansiuk/jenis_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('laba_rugi_sifat_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});	
			   ...
			   $('#btnExcel').live('click', function () {
				...
				$.getJSON('../json-keuangansiuk/jenis_biaya_kompar_proses_json.php?reqPeriode='+ $("#reqPeriode").val(),
				  function(data){
					newWindow = window.open('laba_rugi_sifat_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				});	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Laba Rugi Sifat</span>
            </div>            
            </td>
        </tr>
    </table>
