...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				...
				success:function(data){
					...
					document.location.href = 'proses_pelunasan_nonspp_add.php?reqId='+data[0];
		...
		function OptionSetPembayaran(anSelectedId, anSelectedInv, anSelectedNama)
		{
			...
			$("#alternatecolor").html("");
			$.get("proses_pelunasan_nonspp_add_template.php?reqId="+anSelectedId, function (data) {
		...
		function openPopup()
		{
			...
			$('#reqNoRef3').keyup(function (e) {
				if(e.which == 120)
				{
					OpenDHTMLPopup('proses_pelunasan_nonspp_pencarian.php', 'Pencarian Kelas', 950, 600);
					return false;
				}
			});
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Pelunasan NON SPP</span>
    </div>
    ...
    <table>
        ...
        <tr>
        	<td colspan="4">
            <div>
                <input type="hidden" name="reqDepartemenId" value="98">
            ...
            for (var i = 0; i <= jsondata.length; i++) {
				...
				else
				{
					...
					else
					{
						arrNRP.push(nis);
						//alert(nis + ' ' + nilai);
						$.get("proses_pelunasan_nonspp_add_template.php?reqId="+nis+"&reqNilai="+nilai, function (data) {
							$("#alternatecolor").append(data);
						});	
    ...
    <table>
        <tr>
        	<td>Upload data pelunasan NON-SPP (<a href="uploads/template_pelunasan.xlsx">download template</a>)</td>
