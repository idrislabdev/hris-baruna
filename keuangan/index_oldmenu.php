      ...
      <table width="230" border="0" cellpadding="0" cellspacing="0" height="100%" id="menuFrame">
        <tr> 
          ...
          <td valign="top">
            ...
            <div id="ddsidemenubar" class="markermenu" style="height:1px; margin-top:96px;">
            	<ul>
                <li><a href="#" rel="administrasi_aplikasi">Administrasi Aplikasi</a></li>
                <li><a href="#" rel="penjualan_piutang">Penjualan/Piutang (A/R)</a></li>
                <li><a href="#" rel="kasir">Kasir</a></li>
                <li><a href="#" rel="buku_besar">Buku&nbsp;Besar (G-L)</a></li>
                <li><a href="#" rel="anggaran">Anggaran</a></li>
                <li><a href="#" rel="pajak" style="border-bottom-width: 0">Pajak</a></li>		
                </ul>
            </div>
            <script type="text/javascript">
            ...
            <!-- SUB MENU -->
            <ul id="administrasi_aplikasi" class="ddsubmenustyle blackwhite">
            <li><a href="#">Admin 1</a>
                <ul>
            ...
            <ul id="penjualan_piutang" class="ddsubmenustyle blackwhite">
            ...
            <ul id="kasir" class="ddsubmenustyle blackwhite">
            <li> <a href="#">Kasir</a>
              <ul>
            ...
            <ul id="buku_besar" class="ddsubmenustyle blackwhite">
            ...
            <ul id="anggaran" class="ddsubmenustyle blackwhite">
            ...
            <ul id="pajak" class="ddsubmenustyle blackwhite">
