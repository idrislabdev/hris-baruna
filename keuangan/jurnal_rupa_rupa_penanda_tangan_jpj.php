...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
				$('#btnCetakPdf').live('click', function () {				  	
				  	newWindow = window.open('jurnal_rupa_rupa_jpj_rpt.php?reqNoBukti='+ $("#reqNoBukti").val()+'&reqPejabat='+ $("#reqPejabat").val()+'&reqParam1='+ $("#reqParam1").val()+'&reqParam2='+ $("#reqParam2").val()+'&reqParam3='+ $("#reqParam3").val()+'&reqParam4='+ $("#reqParam4").val(), 'Cetak');
				  	newWindow.focus();				  
