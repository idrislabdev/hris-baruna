...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
			  $('#btnCetak').live('click', function () {
			  	newWindow = window.open('rincian_fasil_aktif_rupiah_rpt.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+
				'&reqPeriode='+ $("#reqPeriode").val()+'&reqKdKartu='+ $("#reqKdKartu").val()+'&reqSdKdKartu='+ $("#reqSdKdKartu").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnExcel').live('click', function () {
			  	newWindow = window.open('rincian_fasil_aktif_rupiah_excel.php?reqKelompok='+ $("#reqKelompok").val()+'&reqFasilitas='+ $("#reqFasilitas").val()+
				'&reqPeriode='+ $("#reqPeriode").val()+'&reqKdKartu='+ $("#reqKdKartu").val()+'&reqSdKdKartu='+ $("#reqSdKdKartu").val(), 'Cetak');
				newWindow.focus();
			  });	
	});
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rincian Piutang Aktif Per Segmen / Fasilitas (Rupiah)</span>
            </div>            
            </td>
        </tr>
    </table>
