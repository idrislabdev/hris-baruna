...
<script type="text/javascript" charset="utf-8">
   ...
   function print() {
         ...
         if (qz != null) {
			...
			tempIsiValue="";
			// buat header
			header="   PT. PELINDO PROPERTI INDONESIA                        REPORT ID.    : KBB_BKT_JKK_ENTRY.PR\n";
    ...
    <div id="header">
        <div id="laporan-header">
            <div id="laporan-header-atas" class="dash-bawah">
                ...
                <div><span class="dash-bawah" style="display:inline;padding:0 0 10px 0;">PT. PELINDO PROPERTI INDONESIA</span><?php if($arrData[$checkbox_index]["NO_REF2"] != '1') {echo '<span style="margin:10px 0 0; padding:0">Auto</span>';} ?></div>
