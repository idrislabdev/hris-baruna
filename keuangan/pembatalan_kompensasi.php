...
<title>pembatalan kompensasi</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/pembatalan_kompensasi_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnView').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pembatalan_kompensasi_view.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  });
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('pembatalan_kompensasi_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Aplikasi Keuangan', '600', '300');	
			  	  else
				  ...
				  $.getJSON('../json-keuangansiuk/get_posting_json.php?reqTabel=KPTT_NOTA&reqId='+anSelectedId,
					function(data){
						if(data.NO_POSTING == "")
						{
							...
							{
								$.getJSON('../json-keuangansiuk/hapus_data_json.php?reqSource=PEMBATALAN_KOMPENSASI&reqId='+anSelectedId,
								function(data){
									if(data.HASIL == 1)
									{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi Pembatalan Pelunasan Per Nota (JRR)</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pembatalan_kompensasi_add.php?reqMode=insert', 'Office Management - Aplikasi Keuangan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            ...
            <th width="120px">Rek.&nbsp;Kas&nbsp;/&nbsp;Bank</th>   
            <th width="200px">Ket Tambahan</th>
            <th width="100px">No&nbsp;Posting</th>  
            <th width="100px">Tgl&nbsp;Posting</th>  
            <th width="100px">Jml Trans</th>
