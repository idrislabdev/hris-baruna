...
<title>posting koreksi audit monitoring</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/posting_koreksi_audit_json.php?reqPeriode=<?=$reqPeriode?>&reqJurnal=<?=$reqJurnal?>&reqPosting=0&reqTanggalAwalAproval=<?=date("d-m-Y")?>&reqTanggalAkhirAproval=<?=date("d-m-Y")?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  window.parent.frames['mainFrameDetilPop'].location.href = 'posting_koreksi_audit_detil.php?reqId='+anSelectedId;
			  });
			  ...
			  $('#btnPosting').on('click', function () {
					...
					else
					{
						if(confirm('Posting data terpilih ?'))
						{
							...
							$.getJSON('../json-keuangansiuk/posting_koreksi_audit_proses_json.php?reqId='+id+'&reqTglPosting='+$("#reqTanggalPosting").datebox("getValue"),
							  function(data){
			  ...
			  $("#reqJurnal").change(function() { 
				  ...
				  val_posting= $("#reqPosting").val();
					...
					oTable.fnReloadAjax("../json-keuangansiuk/posting_koreksi_audit_json.php?reqPeriode="+ val_periode + "&reqJurnal=" + val_jurnal + "&reqPosting=" + val_posting+"&reqTanggalAwalAproval="+ val_tanggal_awal_approval+"&reqTanggalAkhirAproval="+ val_tanggal_akhir_approval);
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Posting Jurnal Transaksi Audit</span>
            </div>            
