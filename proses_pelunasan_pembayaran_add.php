...
<head>
	...
	<script type="text/javascript">
		...
		function OptionSetPembayaran(anSelectedId, anSelectedKelasId, anSelectedNama)
		{
			 
			document.getElementById('reqNoRef2').value = anSelectedId;
			document.getElementById('reqNoRef3').value = anSelectedKelasId;
			document.getElementById('reqKeterangan').value = "PELUNASAN " + anSelectedNama;

			$("#alternatecolor").html("");
			$.get("proses_pelunasan_pembayaran_add_template.php?reqJKM=<?=$reqId?>&reqId="+anSelectedId+"&reqKelasId="+anSelectedKelasId, function (data) {
...
<div id="wadah">
    ...
    <div>
    	<p style="text-align: right; padding-right: 15px; color:red;" ><img src="../WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /> untuk menghapus data siswa yang tidak membayar SPP</p>
    </div>  
    </form>
</div>
</body>
