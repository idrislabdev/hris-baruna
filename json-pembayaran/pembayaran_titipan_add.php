...
$reqVerified = httpFilterPost("reqVerified");
...
$kptt_nota_spp->setField('TIPE_TRANS', "JKM-KPT-98");
$kptt_nota_spp->setField('NO_NOTA', $reqNoBukti);
...
$kptt_nota_spp->setField('JML_VAL_TRANS', dotToNo($reqJumlahTransaksi));
$kptt_nota_spp->setField('JML_RP_TRANS', floor(dotToNo($reqJumlahTransaksi)));
...
$kptt_nota_spp->setField('JML_VAL_BAYAR', dotToNo($reqJumlahTransaksi));	
$kptt_nota_spp->setField('SISA_VAL_BAYAR', "");
$kptt_nota_spp->setField('KD_BANK', $reqNoBukuBesarKas);


$reqBukuBesar = str_replace("207", "101", substr($reqNoRef3, 0,6)).substr($reqVerified, 6,6);

$kptt_nota_spp->setField('REK_BANK', $reqBank);
$kptt_nota_spp->setField('KD_BB_BANK', $reqBukuBesar);	
...
$kptt_nota_spp->setField('VERIFIED', $reqVerified);	
$kptt_nota_spp->setField('DEPARTEMEN_KELAS', $reqDepartemenKelas);	
...
if($kptt_nota_spp->insert())
{
		...
		$kptt_nota_spp_d->setField('HARGA_SATUAN', dotToNo($reqJumlahTransaksi));
		$kptt_nota_spp_d->setField('TGL_VALUTA', dateToDBCheck($reqTanggalTransaksi));	
		$kptt_nota_spp_d->setField('KD_VALUTA', $reqValutaNama);
		$kptt_nota_spp_d->setField('KURS_VALUTA', "1");
		$kptt_nota_spp_d->setField('JML_VAL_TRANS', dotToNo($reqJumlahTransaksi));
		$kptt_nota_spp_d->setField('STATUS_KENA_PAJAK', "");
		$kptt_nota_spp_d->setField('JML_VAL_PAJAK', "");
		$kptt_nota_spp_d->setField('JML_RP_TRANS', dotToNo($reqJumlahTransaksi));
		$kptt_nota_spp_d->setField('JML_RP_PAJAK', "");
		$kptt_nota_spp_d->setField('JML_RP_SLSH_KURS', "");
		$kptt_nota_spp_d->setField('TANDA_TRANS', "+");
		$kptt_nota_spp_d->setField('KD_BUKU_BESAR', $reqBukuBesar);
		...
		$kptt_nota_spp_d->setField('PREV_NO_NOTA', "");
		$kptt_nota_spp_d->setField('KET_TAMBAHAN', "PELUNASAN NOTA NO : ");
		$kptt_nota_spp_d->setField('STATUS_PROSES', "1");	
		$kptt_nota_spp_d->setField('FLAG_JURNAL', "");
		$kptt_nota_spp_d->setField('NO_REF1', "");
		$kptt_nota_spp_d->setField('NO_REF2', "");
		$kptt_nota_spp_d->setField('NO_REF3', "");
