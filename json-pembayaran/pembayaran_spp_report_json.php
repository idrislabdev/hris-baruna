...
$aColumns = array("NO_NOTA","NO_NOTA", "TGL_TRANS", "KD_KUSTO", "MPLG_NAMA", "DEPARTEMEN_KELAS", "JML_VAL_TRANS", "TANGGAL_TAGIHAN");
$aColumnsAlias = array("A.NO_NOTA", "A.NO_NOTA", "A.TGL_TRANS", "A.KD_KUSTO", "B.MPLG_NAMA", "AA.DEPARTEMEN_KELAS", "A.JML_VAL_TRANS", "AA.TGL_TRANS", "TANGGAL_TAGIHAN");
...
$allRecord = $kptt_nota_spp->getCountByParamsReport(array(), $statement);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else	
	$allRecordFilter = $kptt_nota_spp->getCountByParamsReport(array(), $statement." AND (UPPER(A.NO_NOTA) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.KD_KUSTO) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(B.MPLG_NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%')");

$kptt_nota_spp->selectByParamsReport(array(), $dsplyRange, $dsplyStart, $statement." AND (UPPER(A.NO_NOTA) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.KD_KUSTO) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(B.MPLG_NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%')", $sOrder);     		
