...
$absensi_rekap->selectByParamsRekapDetailKehadiranKoreksi($periode, array(), -1, -1, $statement, " ORDER BY NAMA ASC");
...
$worksheet->write_blank	(4, 11, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 12, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 13, $text_format_merge_line_bold);
$worksheet->write		(4, 14, "SAKIT", $text_format_merge_line_bold);
...
$worksheet->write		(4, 19, "IJIN", $text_format_merge_line_bold);
$worksheet->write_blank	(4, 20, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 21, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 22, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 23, $text_format_merge_line_bold);
$worksheet->write		(4, 24, "CUTI", $text_format_merge_line_bold);
$worksheet->write_blank	(4, 25, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 26, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 27, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 28, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 29, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 30, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 31, $text_format_merge_line_bold);
$worksheet->write_blank	(4, 32, $text_format_merge_line_bold);
$worksheet->write		(4, 33, "DINAS", $text_format_merge_line_bold);
$worksheet->write_blank	(4, 34, $text_format_merge_line_bold);
$worksheet->write 		(4, 35, "ALPHA", $text_format_line_bold);
$worksheet->write_blank	(4, 36, $text_format_merge_line_bold);
...
$worksheet->write(5, 9, "TGL", $text_format_line);
$worksheet->write(5, 10, "HPC", $text_format_line);
$worksheet->write(5, 11, "TGL", $text_format_line);
$worksheet->write(5, 12, "HTPC", $text_format_line);
$worksheet->write(5, 13, "TGL", $text_format_line);
$worksheet->write(5, 14, "JML", $text_format_line);
$worksheet->write(5, 15, "STK", $text_format_line);
$worksheet->write(5, 16, "TGL", $text_format_line);
$worksheet->write(5, 17, "SDK", $text_format_line);
$worksheet->write(5, 18, "TGL", $text_format_line);
$worksheet->write(5, 19, "JML", $text_format_line);
$worksheet->write(5, 20, "ITK", $text_format_line);
$worksheet->write(5, 21, "TGL", $text_format_line);
$worksheet->write(5, 22, "IDK", $text_format_line);
$worksheet->write(5, 23, "TGL", $text_format_line);
$worksheet->write(5, 24, "JML", $text_format_line);
$worksheet->write(5, 25, "CT", $text_format_line);
$worksheet->write(5, 26, "TGL", $text_format_line);
$worksheet->write(5, 27, "CAP", $text_format_line);
$worksheet->write(5, 28, "TGL", $text_format_line);
$worksheet->write(5, 29, "CS", $text_format_line);
$worksheet->write(5, 30, "TGL", $text_format_line);
$worksheet->write(5, 31, "CB", $text_format_line);
$worksheet->write(5, 32, "TGL", $text_format_line);
$worksheet->write(5, 33, "JML", $text_format_line);
$worksheet->write(5, 34, "TGL", $text_format_line);
$worksheet->write(5, 35, "JML", $text_format_line);
$worksheet->write(5, 36, "TGL", $text_format_line);
...
while($absensi_rekap->nextRow())
{
	...
	$worksheet->write($row, 9, $absensi_rekap->getField('TGL_HT'), $text_format_line);
	$worksheet->write($row, 10, $absensi_rekap->getField('HPC'), $text_format_line);
	$worksheet->write($row, 11, $absensi_rekap->getField('TGL_HPC'), $text_format_line);
	$worksheet->write($row, 12, $absensi_rekap->getField('HTPC'), $text_format_line);
	$worksheet->write($row, 13, $absensi_rekap->getField('TGL_HTPC'), $text_format_line);
	$worksheet->write($row, 14, $absensi_rekap->getField('JUMLAH_S'), $text_format_line);
	$worksheet->write($row, 15, $absensi_rekap->getField('STK'), $text_format_line);
	$worksheet->write($row, 16, $absensi_rekap->getField('TGL_STK'), $text_format_line);
	$worksheet->write($row, 17, $absensi_rekap->getField('SDK'), $text_format_line);
	$worksheet->write($row, 18, $absensi_rekap->getField('TGL_SDK'), $text_format_line);
	$worksheet->write($row, 19, $absensi_rekap->getField('JUMLAH_I'), $text_format_line);
	$worksheet->write($row, 20, $absensi_rekap->getField('ITK'), $text_format_line);
	$worksheet->write($row, 21, $absensi_rekap->getField('TGL_ITK'), $text_format_line);
	$worksheet->write($row, 22, $absensi_rekap->getField('IDK'), $text_format_line);
	$worksheet->write($row, 23, $absensi_rekap->getField('TGL_IDK'), $text_format_line);
	$worksheet->write($row, 24, $absensi_rekap->getField('JUMLAH_C'), $text_format_line);
	$worksheet->write($row, 25, $absensi_rekap->getField('CT'), $text_format_line);
	$worksheet->write($row, 26, $absensi_rekap->getField('TGL_CT'), $text_format_line);
	$worksheet->write($row, 27, $absensi_rekap->getField('CAP'), $text_format_line);
	$worksheet->write($row, 28, $absensi_rekap->getField('TGL_CAP'), $text_format_line);
	$worksheet->write($row, 29, $absensi_rekap->getField('CS'), $text_format_line);
	$worksheet->write($row, 30, $absensi_rekap->getField('TGL_CS'), $text_format_line);
	$worksheet->write($row, 31, $absensi_rekap->getField('CB'), $text_format_line);
	$worksheet->write($row, 32, $absensi_rekap->getField('TGL_CB'), $text_format_line);
	$worksheet->write($row, 33, $absensi_rekap->getField('DL'), $text_format_line);
	$worksheet->write($row, 34, $absensi_rekap->getField('TGL_DL'), $text_format_line);
	$worksheet->write($row, 35, $absensi_rekap->getField('JUMLAH_A'), $text_format_line);
	$worksheet->write($row, 36, $absensi_rekap->getField('TGL_A'), $text_format_line);
	$row++;
}
$row++;
