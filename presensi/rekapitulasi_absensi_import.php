...
$finger_scan_lokasi->selectByParams(array(), -1, -1, " AND IP_ADDRESS IS NULL ");
?>
...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		$('#ff').form({
			url:'../json-absensi/rekapitulasi_absensi_import_proses.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				alert(data);
				document.location.href = 'rekapitulasi_absensi_import.php';
			}				
		});
	});
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-absensi/rekapitulasi_absensi_import_json.php",	  
			...
			sDeleteURL: "../json-absensi/delete.php?reqMode=rekapitulasi_absensi_import",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnImport').on('click', function () {
					if(confirm("Import data absensi ?"))
					{
						var win = $.messager.progress({
							title:'Please waiting',
							msg:'Loading data...'
						...
						$.getJSON('../json-absensi/proses_absensi_import_json.php',
						  function(data){
							$.messager.progress('close');
			  ...
			  return false;
			   ...
			   $('.vmenu .inner_li span').on('click',function() {												
					  if($(this).text() == 'Aktif')
					  {
						  $.getJSON('../json-intranet/kalender_kerja_set_status.php?reqId='+anSelectedId+'&reqNilai=1', function (data) 
						  {
					  ...
					  {
						  $.getJSON('../json-intranet/kalender_kerja_set_status.php?reqId='+anSelectedId+'&reqNilai=0', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Import Absensi</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div style="position: absolute; margin-top:4px; margin-left:180px; z-index:9999; font-size:12px;">
    	File
        &nbsp;&nbsp;:&nbsp;&nbsp;
		...
		{
		?>
    	<option value="<?=$finger_scan_lokasi->getField("MESIN_ID")?>"><?=$finger_scan_lokasi->getField("NAMA_LOKASI")?></option>
		<?
		}
		?>
        </select>
