...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "sAjaxSource": "../json-absensi/absensi_manual_json.php?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>",
			  "sScrollX": "100%",								  
			  "sScrollXInner": "100%",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedRefId = element[8];
			  });
			  
			  $("#reqBulan").change(function() {
				 oTable.fnReloadAjax("../json-absensi/absensi_manual_json.php?reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val());				 	 
			  });
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('absensi_manual_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Presensi', '600', '350');	
			  });
			  
			  $('#btnApprove').on('click', function () {
				//alert(anSelectedValidasi);			  
				  if(anSelectedData == "" || anSelectedValidasi == "Approve" )
					  return false;
					  
			  oTable.fnReloadAjax("../json-absensi/absensi_manual_json.php?reqMode=Approve&reqId=" + anSelectedId + "&reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val());			
			  alert("selesai!");
			  });
			  ...
			  oTable.fnReloadAjax("../json-absensi/absensi_manual_json.php?reqMode=Hapus&reqId=" + anSelectedId + "&reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val());			
			  alert("selesai!");
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Absensi Manual</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('absensi_manual_add.php?reqMode=insert', 'Office Management - Aplikasi Presensi', '600', '350');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnDeleteRow" title="Hapus">Hapus</a>
            <a href="#" id="btnApprove" title="Approve">Approve</a>
            </li>        
        </ul>
    </div>
