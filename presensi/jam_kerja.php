...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-absensi/master_jam_kerja_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('jam_kerja_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Presensi', '600', '500');	
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-absensi/delete.php?reqMode=master_jam_kerja&id='+anSelectedId, function (data) 
					{
			  ...
			  return false;
			   ...
			   $('.vmenu .inner_li span').on('click',function() {												
					  if($(this).text() == 'Aktif')
					  {
						  $.getJSON('../json-absensi/master_jam_kerja_json_set.php?reqJenisId='+anSelectedJenisId+'&reqId='+anSelectedId+'&reqNilai=1', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
							  });
						  });					
						  oTable.fnUpdate('Aktif', anSelectedPosition, 6, true);
					  }
					  /*else if($(this).text() == 'Tidak Aktif')
					  {
						  $.getJSON('../json/master_jam_kerja_json_set.php?reqId='+anSelectedId+'&reqNilai=0', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
								  
							  });
						  });									
						  oTable.fnUpdate('Tidak Aktif', anSelectedPosition, 6, false);
					  }*/
					  $('.vmenu').hide();
					  $('.overlay').hide();
			  });	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Master Jam Kerja</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jam_kerja_add.php?reqMode=insert', 'Office Management - Aplikasi Presensi', '600', '500');" title="Tambah">Tambah</a>
