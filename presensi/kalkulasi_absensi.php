...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-absensi/kalkulasi_absensi_json.php?reqPeriode=" + $("#reqBulan").val()+$("#reqTahun").val(),	  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('kalkulasi_absensi_add.php?reqMode=update&reqId='+anSelectedId + "&reqBulan=" + $("#reqBulan").val() + "&reqTahun=" + $("#reqTahun").val(), 'Office Management - Aplikasi Presensi', '600', '450');	
			  });
			  
			  $('#btnProses').on('click', function () {
				  oTable.fnReloadAjax("../json-absensi/kalkulasi_absensi_json.php?reqJenis=Proses&reqPeriode=" + $("#reqBulan").val()+$("#reqTahun").val());
			  });
			  ...
			  $("#reqBulan").change(function() { 
				 oTable.fnReloadAjax("../json-absensi/kalkulasi_absensi_json.php?reqPeriode=" + $("#reqBulan").val()+$("#reqTahun").val());				 	 
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Kalkulasi Absensi</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" id="btnEdit" title="Edit">View</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="10px">Kelompok</th>
            <th width="50px">Unit Kerja</th>
            <th width="50px">Jabatan</th>
            <th width="20px">Total Perak</th>
            <th width="20px">Total Daerah</th>
        </tr>
    </thead>
    </table> 
    </div> 
