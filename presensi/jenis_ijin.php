...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-absensi/master_ijin_json.php",	  
			...
			sDeleteURL: "../json-absensi/delete.php?reqMode=kalender_kerja",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('kalender_kerja_add.php?reqId='+anSelectedId, 'Office Management - Aplikasi Presensi', '900', '580');	
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('jenis_ijin_add.php?reqMode=insert', 'Office Management - Aplikasi Presensi', '600', '300');" title="Tambah">Tambah</a>
