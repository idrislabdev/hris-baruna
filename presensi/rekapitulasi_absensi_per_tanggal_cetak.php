...
$reqHari = httpFilterGet("reqHari");
if($reqHari == "")
	$reqHari = date('d');

$absensi_rekap->selectByParamsRekapDatangCepat(array(), -1, -1, $reqBulan.$reqTahun, (int)$reqHari, generateZero($reqHari, 2));
...
$worksheet->write(2, 1, "PT PELINDO MARINE SERVICE", $text_format_merge);
...
$worksheet->write(4, 4, "DEPARTEMEN", $text_format_line_bold);
...
while($absensi_rekap->nextRow())
{
	...
	$worksheet->write($row, 4, $absensi_rekap->getField("DEPARTEMEN"), $text_format_line_left);
