		...
		$(function(){
			$('#ff').form({
				...
				success:function(data){
					...
					top.frames['mainFrame'].location = 'absensi_koreksi.php?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>';
    ...
    <div class="data-foto-table">
        <div class="data-foto">
            ...
            <div class="data-foto-ket">
                ...
                <div style="color:#000; font-size:16px; line-height:20px;">Periode : <?=$monthName. "&nbsp;" . $currYear?></div>
            </div>
        	...
        	<div>
                <form id="ff" method="post" novalidate>
                    ...
                    <div class="container_calendar">
                        ...
                        <input type="hidden" name="reqKategori" value="DARAT">
