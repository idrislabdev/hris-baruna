...
$aColumns = array("ANGGARAN_ID","TAHUN_BUKU","KD_BUKU_PUSAT","KD_SUB_BANTU","KD_BUKU_BESAR","KD_VALUTA","JUMLAH","JUMLAH_MUTASI","D_K","REALISASI");
$aColumnsAlias = array("A.ANGGARAN_ID","A.TAHUN_BUKU","A.KD_BUKU_PUSAT","A.KD_SUB_BANTU","A.KD_BUKU_BESAR","A.KD_VALUTA","A.JUMLAH","B.JUMLAH_MUTASI","B.D_K","B.REALISASI");
...
$statement= " AND A.TAHUN_BUKU = '".$reqTahunBuku."'";
...
while($anggaran->nextRow())
{
	...
	for ( $i=0 ; $i<count($aColumns) ; $i++ )
	{
		...
		else if($aColumns[$i] == "JUMLAH" || $aColumns[$i] == "JUMLAH_MUTASI" || $aColumns[$i] == "JUMLAH_TRIWULAN2" || $aColumns[$i] == "JUMLAH_TRIWULAN3" || $aColumns[$i] == "JUMLAH_TRIWULAN4")
