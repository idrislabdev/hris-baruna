...
$aColumns = array("ANGGARAN_MUTASI_ID", "NO_NOTA", "NO_REF2", "JENIS_ANGGARAN", "PUSPEL_NAMA", "LAST_UPDATED_BY", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "NO_NOTA", "NO_REF2", "JENIS_ANGGARAN", "PUSPEL_NAMA", "A.LAST_UPDATED_BY", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
...
$statement .= " AND APPROVED_TGJAWAB_DATE IS NULL AND APPROVED_TGJAWAB_KADIV_DATE IS NOT NULL AND NVL(JML_VAL_REALISASI, 0) > 0 ";
