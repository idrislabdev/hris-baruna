...
$aColumns = array("ANGGARAN_MUTASI_ID", "NO_NOTA", "NO_REF3", "JENIS_ANGGARAN", "PUSPEL_NAMA", "LAST_UPDATED_BY", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "NO_NOTA", "NO_REF3", "JENIS_ANGGARAN", "PUSPEL_NAMA", "A.LAST_UPDATED_BY", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
...
$statement .= " AND NVL(STATUS_PERMOHONAN, 0) = 1 AND APPROVED_DATE IS NULL AND APPROVED_KADIV_DATE IS NOT NULL ";
