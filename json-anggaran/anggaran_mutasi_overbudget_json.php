...
$statement .= " AND NVL(STATUS_PERMOHONAN, 0) = 0 AND A.JENIS_ANGGARAN_ID = '".$reqJenis."' AND EXISTS(SELECT 1 FROM PEL_ANGGARAN.ANGGARAN_OVERBUDGET X WHERE X.ANGGARAN_MUTASI_ID = A.ANGGARAN_MUTASI_ID) ";
