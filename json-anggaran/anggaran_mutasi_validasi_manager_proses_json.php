...
for($i=0;$i<count($arrId);$i++)
{
	if($error == 0)
	{
			...
			$anggaran_mutasi->selectByParams(array("A.ANGGARAN_MUTASI_ID" => $arrId[$i]));
			...
			if($reqJenisAnggaranId == 3 || $reqJenisAnggaranId == 6)
			{
				...
				$anggaran_mutasi_d->selectByParamsJurnalUangMuka(array("A.ANGGARAN_MUTASI_ID" => $arrId[$i]));
