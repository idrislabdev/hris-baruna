...
$aColumns = array("ANGGARAN_MUTASI_ID", "STATUS_KIRIM_LEBIH_KURANG", "NO_NOTA", "NO_REF3", "NO_REF2", "JENIS_ANGGARAN", "NM_BUKU_BESAR", "PEGAWAI", "TGL_TRANS", "JML_VAL_TRANS", "REALISASI", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "STATUS_KIRIM_LEBIH_KURANG", "NO_NOTA", "NO_REF3", "NO_REF2", "A.JENIS_ANGGARAN_ID", "PUSPEL_NAMA", "B.NAMA", "TGL_TRANS", "JML_VAL_TRANS", "REALISASI", "KET_TAMBAH");
...
if($reqStatus == "0")
	$statement .= " AND VERIFIKASI_TGJAWAB_DATE IS NULL AND VERIFIKASI_TGJAWAB_STAFF_DATE IS NOT NULL ";
elseif($reqStatus == "1")
	$statement .= " AND VERIFIKASI_TGJAWAB_DATE IS NOT NULL AND VERIFIKASI_TGJAWAB_STAFF_DATE IS NOT NULL ";
else
	$statement .= "";
...
$statement .= " AND A.JENIS_ANGGARAN_ID IN (1, 2, 3, 5, 6) AND APPROVED_TGJAWAB_DATE IS NOT NULL AND NVL(JML_VAL_REALISASI, 0) > 0 ";
