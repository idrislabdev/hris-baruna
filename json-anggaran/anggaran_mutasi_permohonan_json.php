...
$aColumns = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "NO_NOTA", "NO_REF1", "PUSPEL", "PUSPEL_NAMA","TGL_TRANS", "NO_REF3", "JML_VAL_TRANS", "PERIODE", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "NO_NOTA", "NO_REF1", "PUSPEL", "PUSPEL_NAMA", "TGL_TRANS", "NO_REF3", "JML_VAL_TRANS", "A.BLN_BUKU", "KET_TAMBAH");
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY ANGGARAN_MUTASI_ID asc" )
	{
		...
		*/
		$sOrder = " ORDER BY A.TGL_TRANS DESC";
...
$statement .= " AND A.JENIS_ANGGARAN_ID = '".$reqJenis."' AND STATUS_PERMOHONAN = 1 ";

$statement_json= " AND (UPPER(B.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.NO_REF1) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.KET_TAMBAH) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.NO_NOTA) LIKE '%".strtoupper($_GET['sSearch'])."%')";
