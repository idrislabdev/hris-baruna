...
$aColumns = array("ANGGARAN_MUTASI_ID", "STATUS_KIRIM_LEBIH_KURANG", "NO_NOTA", "JENIS_ANGGARAN", "PUSPEL", "PUSPEL_NAMA", "PEGAWAI", "TGL_TRANS", "NO_REF2", "JML_VAL_TRANS", "JML_VAL_REALISASI", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "STATUS_KIRIM_LEBIH_KURANG", "NO_NOTA", "JENIS_ANGGARAN", "PUSPEL", "PUSPEL_NAMA", "B.NAMA", "TGL_TRANS", "NO_REF2", "JML_VAL_TRANS", "JML_VAL_REALISASI", "KET_TAMBAH");
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY ANGGARAN_MUTASI_ID asc" )
	{
		...
		*/
		$sOrder = " ORDER BY NVL(TGL_PERTANGGUNGJAWABAN, TGL_ENTRY) DESC";
...
$statement .= " AND NVL(STATUS_PERMOHONAN, 0) = 0 AND A.JENIS_ANGGARAN_ID IN (1) ";
