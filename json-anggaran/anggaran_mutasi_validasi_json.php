...
$aColumns = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "JENIS_ANGGARAN", "PUSPEL", "PUSPEL_NAMA", "PEGAWAI", "TGL_TRANS", "NO_REF1", "NO_REF2", "NO_REF3", "JML_VAL_TRANS", "PERIODE", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "JENIS_ANGGARAN", "PUSPEL", "PUSPEL_NAMA", "B.NAMA", "TGL_TRANS", "NO_REF1", "NO_REF2", "NO_REF3", "JML_VAL_TRANS", "A.BLN_BUKU", "KET_TAMBAH");
...
$statement .= " AND NVL(STATUS_PERMOHONAN, 0) = 0 AND NOT EXISTS(SELECT 1 FROM PEL_ANGGARAN.ANGGARAN_OVERBUDGET X WHERE X.ANGGARAN_MUTASI_ID = A.ANGGARAN_MUTASI_ID) ";
