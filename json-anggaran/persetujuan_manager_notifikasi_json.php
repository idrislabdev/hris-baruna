...
$aColumns = array("ANGGARAN_MUTASI_ID", "NO_NOTA", "NO_REF3", "STATUS", "JENIS_ANGGARAN", "PUSPEL_NAMA", "TGL_TRANS", "LAST_UPDATED_BY", "JML_VAL_TRANS", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "JENIS_ANGGARAN", "APPROVED_DATE", "PUSPEL", "PUSPEL_NAMA", "A.LAST_UPDATED_BY", "TGL_TRANS", "NO_REF3", "JML_VAL_TRANS", "KET_TAMBAH");
...
if($reqStatus == "PERMOHONAN")
	$statement .= " AND NVL(STATUS_PERMOHONAN, 0) = 1 AND APPROVED_DATE IS NULL ";
elseif($reqStatus == "PERTANGGUNGJAWAB")
	$statement .= " AND APPROVED_TGJAWAB_DATE IS NULL AND APPROVED_TGJAWAB_DATE IS NULL AND NVL(JML_VAL_REALISASI, 0) > 0 ";
else
	$statement .= " AND ((NVL(STATUS_PERMOHONAN, 0) = 1 AND APPROVED_DATE IS NULL) OR (APPROVED_TGJAWAB_DATE IS NULL AND APPROVED_TGJAWAB_DATE IS NULL AND NVL(JML_VAL_REALISASI, 0) > 0)) ";
