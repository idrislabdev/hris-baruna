...
$aColumns = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "NO_NOTA", "NO_REF3", "JENIS_ANGGARAN", "PUSPEL_NAMA", "PEGAWAI", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
$aColumnsAlias = array("ANGGARAN_MUTASI_ID", "VERIFIKASI", "NO_NOTA", "NO_REF3", "JENIS_ANGGARAN", "PUSPEL_NAMA", "B.NAMA", "TGL_TRANS", "JML_VAL_TRANS", "KET_TAMBAH");
...
if($reqStatus == "")
	$statement .= " AND (VERIFIKASI IS NULL AND VERIFIKASI_BY IS NULL ) AND VERIFIKASI_STAFF_DATE IS NOT NULL ";
else
	$statement .= " AND VERIFIKASI_BY IS NOT NULL AND VERIFIKASI_STAFF_DATE IS NOT NULL ";
