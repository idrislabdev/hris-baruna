...
$anggaran_overbudget_total = $anggaran_overbudget->getSumByParams(array("KD_BUKU_BESAR" => $reqKdBukuBesar, "KD_BUKU_PUSAT" => $reqKdBukuPusat), " AND NVL(VERIFIKASI, 'S') = 'S' AND NOT A.ANGGARAN_MUTASI_ID = NVL('".$reqId."', 0) ");
...
{   
	...
	{
		$overbudget = 0 - $posisi_sekarang - $anggaran_overbudget_total;
		$nilai = "1";
	}
}
