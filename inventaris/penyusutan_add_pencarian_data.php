...
<div id="wadah">
    ...
    <div style="position: absolute; margin-top:5px; margin-left:175px; z-index:9999; font-size:14px;">
        Lokasi : <input id="cc" class="easyui-combotree" name="reqLokasi" data-options="url:'../json-masterdata/lokasi_combo_json.php'" style="width:400px;">&nbsp;&nbsp;
    </div>
    </div>
