...
<body rightmargin="0" bottommargin="0" topmargin="0" style="overflow-x:hidden;" >
<div id="page_effect" style="display:none;">
<div id="bg"><img src="../WEB-INF/images/bg-kiri-popup.jpg" width="100%" height="100%" alt=""></div>
<div id="content">

            	<div id="menu-kiri-title"></div>
                <a href="#" id="penyusutan_add_data_add" class="menu-bg" onclick="executeOnClick('penyusutan_add_data_add');" style="background-position:0 -27px">
