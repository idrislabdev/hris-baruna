...
<head>
    ...
    $(document).ready(function() {
	  ...
	  $('#btnBuatJurnal').on('click', function () {
		...
		if(confirm('Buat jurnal penyusutan periode <?=getNamePeriode($reqPeriode)?> ?'))
		{  
			var jqxhr = $.get( "../json-inventaris/kalkulasi_penyusutan_jurnal.php?reqPeriode=<?=$reqPeriode?>&reqTanggalTransaksi="+$("#reqTanggalTransaksi").datebox("getValue"), function(data) {
			  alert(data);
			  $("#btnBuatJurnal").hide();
			});	
		}		
