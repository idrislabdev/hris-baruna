        ...
        <!--<table class="example altrowstable" id="alternatecolor" >-->
            <thead class="altrowstable">
              <tr>
                  ...
                  <th style="width:10%">Umur Ekonomis</th>
            ...
            <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              ?>
                  <tr id="node-<?=$i?>">
                      ...
                      <td>
                        <input type="text" name="reqUmurEkonomis[]" <? if($inventaris_ruangan->getField("UMUR_EKONOMIS") == 0) {} else { ?> readonly <? } ?> id="reqUmurEkonomis<?=$i?>" style="text-align:right; width:100px" OnKeyUp="" value="<?=$inventaris_ruangan->getField("UMUR_EKONOMIS")?>" />
                      </td>
                      <td>
