...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/rekap_inventaris_ruangan_json.php",
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
			   ...
			   $('#btnEksporXls').on('click', function () {
				  newWindow = window.open('rekap_inventaris_ruangan_excel.php?reqLokasi='+ $('#reqLokasi').combotree('getValue'), 'Cetak');
				  newWindow.focus();
			  });	
			  
			  
			   $('#btnEksporPdf').on('click', function () {
				  newWindow = window.open('rekap_inventaris_ruangan_pdf.php?reqLokasi='+ $('#reqLokasi').combotree('getValue'), 'Cetak');
				  newWindow.focus();
			  });			  
			  
			  $('#btnCetakRuangan').on('click', function () {
					window.parent.OpenDHTML('report_penanda_tangan.php?reqJenis=RUANGAN', 'Sistem Informasi Inventaris');	
			  });
			  
			  $('#btnCetakPerlengkapan').on('click', function () {
					window.parent.OpenDHTML('report_penanda_tangan.php?reqJenis=PERLENGAKAPAN', 'Sistem Informasi Inventaris');	
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Rekapitulasi Asset Ruangan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
            	...
            	<a href="#" id="btnEksporPdf" title="Ekspor"> Cetak</a>
            	<!-- <a href="#" title="Cetak" id="btnCetakRuangan">Cetak Ruang</a> -->
            </li> 
            <?php /*?><li>
            	<a href="#" title="Cetak" id="btnCetakRuangan">Cetak Ruang</a>
            </li>  
            <li>
            	<a href="#" title="Cetak" id="btnCetakPerlengkapan">Cetak Perlengkapan</a>
            </li><?php */?>          
        </ul>
    </div>
    <div style="position: relative; z-index:10">
    <div style="position: absolute; margin-top:6px; margin-left:175px; z-index:9999; font-size:14px;">
    	Lokasi : <input id="reqLokasi" name="reqLokasi" class="easyui-combotree" data-options="url:'../json-inventaris/lokasi_combo_json.php'" style="width:300px" />
    </div>
    </div>
