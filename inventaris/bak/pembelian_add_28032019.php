...
<div id="kontainer" style="height:100%; min-height:100%;">
    ...
    <div id="popup-kanan">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%; height:100%;">
            <tr height="50%">
                <td><iframe src="pembelian_add_data.php?reqId=<?=$reqId?>" class="mainframe" id="idMainFrame" name="mainFramePop" width="100%" height="100%" scrolling="auto" frameborder="0" style="display:block;"></iframe></td>
            </tr>
