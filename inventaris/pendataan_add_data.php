...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/pendataan_add_data_json.php?reqId=<?=$reqId?>&reqInventarisId=<?=$reqInventarisId?>",		
			  ...
			  $('#btnDownload').on('click', function () {
			  	...
			  	if(anSelectedFormat == "-" || anSelectedFormat == "")
					alert("Dokumen file tidak ada");
			  	else
			  	{
						  newWindow = window.open('../json-inventaris/download.php?reqTipe=inventaris&reqId=' + anSelectedId, 'Cetak');
						  newWindow.focus();
			  	}
			  	 ...
			  	 $('#btnHapus').on('click', function () {
					...
					if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
						...
						var jqxhr = $.get('../json-inventaris/delete.php?reqMode=inventaris_ruangan_detil&reqAlasan=DIHAPUS&id='+anSelectedId, function() {
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Daftar item inventaris : <?=$reqInventarisNama?> </span>
            </div>            
            </td>
        </tr>
    </table>
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pendataan_add_monitoring_add.php?reqMode=insert&reqId=<?=$reqId?>&reqInventarisId=<?=$reqInventarisId?>', 'Sistem Informasi Inventaris', '800', '450');" title="Tambah">Tambah Item</a>
            <a href="#" id="btnEdit" title="Edit">Ubah Item</a>
            <a href="#" id="btnHapus" title="Hapus">Hapus Item</a>
            <?php /*?><a href="#" id="btnPindah" title="Pindah">Pindah Item</a>
            <a href="#" id="btnHistori" title="Histori Penanggung Jawab">Histori Penanggung Jawab</a>
            <a href="#" id="btnCetakBarcode" title="Cetak Barcode" data-flexmenu="flexmenu1">Cetak Barcode</a><?php */?>
            </li>        
        </ul>
