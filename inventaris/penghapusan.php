...
<style type="text/css" media="screen">
	...
	<script type="text/javascript" language="javascript" class="init">
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/penyusutan_json.php",			  
			...
			sDeleteURL: "../json-inventaris/delete.php?reqMode=penyusutan",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').live('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('penyusutan_add.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
			  
			  $('#btnEkspor').live('click', function () {
				  newWindow = window.open('penyusutan_excel.php', 'Cetak');
				  newWindow.focus();
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Penghapusan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('penyusutan_add.php?reqMode=insert', 'Sistem Informasi Inventaris');" title="Tambah">Tambah</a>
    ...
    <thead>
         <tr>
            <th>Id</th>
            <th width="50px">Jenis Susut</th>  
            <th width="80px">Nama</th>  
            <th width="50px">Tanggal</th>
            <th width="200px">Inventaris</th>                                
