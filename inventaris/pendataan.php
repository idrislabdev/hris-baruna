...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/pendataan_json.php",	
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pendataan_add.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
			  
			  $('#btnEkspor').on('click', function () {
				  newWindow = window.open('rekap_inventaris_ruangan_excel.php', 'Cetak');
				  newWindow.focus();
			  });
			  
			  $('#btnCetak').on('click', function () {
				  window.parent.OpenDHTML('pendataan_cetak_add.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
			  
			  $('#btnCetakLabel').on('click', function () {				  
				  newWindow = window.open('label_inventaris.php?reqId='+ anSelectedId, 'Cetak');
				  newWindow.focus();
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Pendataan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            ...
            <?php /*?><a href="#" id="btnDeleteRow" title="Hapus"><img src="../WEB-INF/images/icn_delete.png" width="15" height="15"/> Hapus</a><?php */?>
            </li>
            <li><a href="#" title="Ekspor" id="btnEkspor"> Export Excel</a></li>
            <?php /*?><li>
            	<a href="#" title="Cetak Daftar" id="btnCetak"> Cetak Daftar Asset</a>
            </li> <?php */?>    
        </ul>
    </div>
