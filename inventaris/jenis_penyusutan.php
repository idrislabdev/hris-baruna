...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/jenis_penyusutan_json.php",			  
			...
			sDeleteURL: "../json-inventaris/delete.php?reqMode=jenis_penyusutan",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.createWindow('jenis_penyusutan_add.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
			  ...
			  $('#btnDownload').on('click', function () {
			  	...
			  	{
				  newWindow = window.open('../json-inventaris/download.php?reqTipe=jenis_penyusutan&reqId=' + anSelectedId, 'Cetak');
				  newWindow.focus();
			  	}
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Jenis Penghapusan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
                <a href="#" id="btnAdd" onClick="window.parent.createWindow('jenis_penyusutan_add.php?reqMode=insert', 'Sistem Informasi Inventaris')" title="Tambah"><img src="../WEB-INF/images/icon-tambah.png" /> Tambah</a>
                <a href="#" id="btnEdit" title="Edit"><img src="../WEB-INF/images/icon-edit.png" /> Ubah</a>
                <a href="#" id="btnDeleteRow" title="Hapus"><img src="../WEB-INF/images/icon-hapus.png" /> Hapus</a>
            </li>        
        </ul>
    </div>
