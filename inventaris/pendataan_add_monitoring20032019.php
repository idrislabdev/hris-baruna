...
<script src="../WEB-INF/lib/media/js/complete.js" type="text/javascript" ></script>
...
<script src="../WEB-INF/lib/media/js/jquery.dataTables.editable.js" type="text/javascript" ></script>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			sDeleteURL: "../json-operasional/delete.php?reqMode=pendataan_add_monitoring",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnHapus').on('click', function () {
					...
					if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
						$.getJSON('../json-inventaris/delete.php?reqMode=inventaris_ruangan&id='+anSelectedId+'&reqRowId=<?=$reqId?>', function (data) 
						{
...
<div id="begron"><img src="../WEB-INF/images/bg-kanan-atas.png" width="100%" height="100%" alt="Smile"></div>
<div id="wadah">
    
    <div class="judul-halaman">Pendataan</div>
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
                <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pendataan_add_monitoring_add.php?reqMode=insert&reqId=<?=$reqId?>', 'Sistem Informasi Inventaris', '900', '500');" title="Tambah"><img src="../WEB-INF/images/icon-tambah.png" /> Tambah Inventaris</a>
                <a href="#" id="btnHapus" title="Hapus"><img src="../WEB-INF/images/icon-hapus.png" /> Hapus Inventaris</a>            
            </li>        
	        <li>
            	<a href="#" id="btnCetakBarcodeSemua"><img src="../WEB-INF/images/icon-print.png" /> Cetak Barcode Semua</a>
            </li>   
        </ul>
    </div>
