...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-pelaporan/rekap_inventaris_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEksporXls').on('click', function () {				   
				  newWindow = window.open('rekap_inventaris_excel.php?reqInventaris='+ $("#reqInventaris").val(), 'Cetak');
				  newWindow.focus();				  
			  });
			  
			  $('#btnEksporPdf').on('click', function () {				   
				  newWindow = window.open('rekap_inventaris_pdf.php?reqInventaris='+ $("#reqInventaris").val(), 'Cetak');
				  newWindow.focus();				  
			  });
			  
			  $("#reqInventaris").change(function() { 
				 fnReloadAjax("../json-pelaporan/rekap_inventaris_json.php?reqInventaris="+ $("#reqInventaris").val());
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Rekapitulasi Inventaris</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
            	<a href="#" id="btnEksporXls" title="Ekspor"><img src="../WEB-INF/images/icon-excel.png" /> Export Excel</a>
            	<a href="#" id="btnEksporPdf" title="Ekspor"><img src="../WEB-INF/images/icon-print.png" /> Cetak</a>
            </li>        
        </ul>
    </div>
    <div style="position: relative; z-index:10">
    <div style="position: absolute; margin-top:6px; margin-left:175px; z-index:9999; font-size:14px;">
    	Inventaris : <select name="reqInventaris" id="reqInventaris">
        				<option value="">Semua</option>
                      <?
                      while($inventaris->nextRow())
					  {
					  ?>
                      	<option value="<?=$inventaris->getField("INVENTARIS_ID")?>"><?=$inventaris->getField("NAMA")?></option>
                      <?
					  }
					  ?>
                      </select>
