...
$html = file_get_contents("http://".$_SERVER['SERVER_NAME'] . dirname($_SERVER['REQUEST_URI'])."/rincian_rekap_aktiva_tetap_excel?reqPeriode=".$reqPeriode."&reqPeriodeLalu=".$reqPeriodeLalu."");


$mpdf->WriteHTML($html,2);

$mpdf->Output("rincian_aktiva_tetap_".$reqPeriodeLalu."_".$reqPeriode.".pdf",'I');
exit;
//==============================================================
//==============================================================
//==============================================================
