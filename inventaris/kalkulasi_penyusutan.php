...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/kalkulasi_penyusutan_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEksporXls').on('click', function () {
				  document.location.href = "rekap_kalkulasi_penyusutan_excel.php?reqMode=update&reqPeriode="+$("#reqPeriode").val();	
			  });
			  ...
			  $('#btnKalkulasi').on('click', function () {
				...
				{  
					var jqxhr = $.get( "../json-inventaris/kalkulasi_penyusutan.php?reqPeriode="+$("#reqPeriode").val(), function(data) {
					  alert(data);
			  		  oTable.fnReloadAjax("../json-inventaris/kalkulasi_penyusutan_json.php?reqPeriode="+ $("#reqPeriode").val());
					});	
				}				 
			  });
			  ...
			  $('#btnLihatSd').on('click', function () {
					 window.parent.OpenDHTML('jurnal_lihat_sd.php?reqPeriodeLalu=<?=$reqPeriodeLalu?>&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Fixed Asset', '900', '600');	
			  ...
			  $("#reqPeriode").change(function() { 
			  		document.location.href ="kalkulasi_penyusutan.php?reqPeriode="+ $("#reqPeriode").val()+"&reqPeriodeLalu="+ $("#reqPeriodeLalu").val();
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Kalkulasi Penyusutan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            ...
            <a href="#" id="btnLihatSd" title="Lihat"> Lihat Jurnal s.d</a>
