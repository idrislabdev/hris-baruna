        ...
        <!--<table class="example altrowstable" id="alternatecolor" >-->
            ...
            <tbody class="example altrowstable" id="alternatecolor"> 
              ...
              ?>
                  <tr id="node-<?=$i?>">
                      <td>
                        <input type="hidden" name="reqInventarisRuanganId[]" readonly  value="<?=$inventaris_ruangan->getField("INVENTARIS_RUANGAN_ID")?>" />
                        ...
                        <input type="text" name="reqKode[]" readonly style="width:350px" value="<?=$inventaris_ruangan->getField("NOMOR")?>" />
                      </td>
                      <td>
                        <input type="text" name="reqInventaris[]" readonly style="width:480px" value="<?=$inventaris_ruangan->getField("INVENTARIS")?>" />
                      </td>
                      <td>
                        <input id="cc" class="easyui-combotree" name="reqLokasi[]"  data-options="url:'../json-inventaris/lokasi_combo_json.php'" style="width:450px;" value="<?=$inventaris_ruangan->getField("LOKASI_ID")?>">
                      </td>
                  </tr>
                  <? 
                    $i++;
