...
if(varItem == 'pembelian_add_data'){
	...
	parent.mainFramePop.location.href='pembelian_add_data.php?reqId=<?=$reqId?>';
...
<div id="kontainer" style="height:100%; min-height:100%;">
    ...
    <div id="sisi-kiri" style="overflow-y:auto;">
    	<input type="hidden" id="setHideMenu">
            ...
            <div><a href="#" id="pembelian_add_data" onclick="executeOnClick('pembelian_add_data');">Data Pembelian</a></div>
        	<div><a href="#" id="pembelian_add_data_pemetaan" onclick="executeOnClick('pembelian_add_data_pemetaan');">Pemetaan Inventaris</a></div>
            </div>
	</div>
    <div id="sisi-kanan">
