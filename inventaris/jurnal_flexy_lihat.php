...
<head>
    ...
    $(document).ready(function() {
	  ...
	  $('#btnBuatJurnal').on('click', function () {
		...
		{  
			var jqxhr = $.get( "../json-inventaris/kalkulasi_penyusutan_jurnal.php?reqPeriodeLalu=<?=$reqPeriodeLalu?>&reqPeriode=<?=$reqPeriode?>&reqTanggalTransaksi="+$("#reqTanggalTransaksi").datebox("getValue"), function(data) {
			  alert(data);
			  $("#btnBuatJurnal").hide();
			});	
		}		
