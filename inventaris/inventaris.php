...
<style type="text/css" media="screen">    
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/inventaris_json.php",	
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('inventaris_add_data.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Asset</span>
            </div>            
            </td>
        </tr>
    </table>
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif)">    
        <ul>
            <li>
                <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('inventaris_add_data.php?reqMode=insert', 'Sistem Informasi Inventaris')" title="Tambah"> Tambah</a>
