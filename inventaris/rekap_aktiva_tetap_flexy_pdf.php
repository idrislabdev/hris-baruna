...
$html = file_get_contents("http://".$_SERVER['SERVER_NAME'] . dirname($_SERVER['REQUEST_URI'])."/rekap_aktiva_tetap_flexy_excel.php?reqPeriode=".$reqPeriode."&reqPeriodeLalu=".$reqPeriodeLalu."");


$mpdf->WriteHTML($html,2);

$mpdf->Output("rekap_aktiva_tetap_".$reqPeriodeLalu."_".$reqPeriode.".pdf",'I');
exit;
//==============================================================
//==============================================================
//==============================================================
