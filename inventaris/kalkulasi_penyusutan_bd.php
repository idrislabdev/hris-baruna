...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/kalkulasi_penyusutan_bd_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEksporXls').on('click', function () {
				  document.location.href = "rekap_kalkulasi_penyusutan_bd_excel.php?reqMode=update&reqPeriode="+$("#reqPeriode").val();	
			  });

			  $('#btnKalkulasi').on('click', function () {
				if(confirm('Kalkulasi periode terpilih?'))
				{  
					var jqxhr = $.get( "../json-inventaris/kalkulasi_penyusutan_bd.php?reqPeriode="+$("#reqPeriode").val(), function(data) {
					  alert(data);
			  		  oTable.fnReloadAjax("../json-inventaris/kalkulasi_penyusutan_bd_json.php?reqPeriode="+ $("#reqPeriode").val());
					});	
				}				 
			  });
			  ...
			  $('#btnLihat').on('click', function () {
					 window.parent.OpenDHTML('jurnal_lihat_bd.php?reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Fixed Asset', '900', '600');	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Kalkulasi Penyusutan - Backdate</span>
            </div>            
            </td>
        </tr>
    </table>
