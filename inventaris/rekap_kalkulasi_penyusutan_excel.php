...
$fname = tempnam("/tmp", "rekap_kalkulasi_penyusutan_".$reqPeriode.".xls");
...
$worksheet->write(1, 1, "KALKULASI PENYUSUTAN PERIODE ".strtoupper(getNamePeriode($reqPeriode)), $text_format);
...
header("Content-Type: application/x-msexcel; name=\"rekap_kalkulasi_penyusutan_".$reqPeriode.".xls\"");
header("Content-Disposition: inline; filename=\"rekap_kalkulasi_penyusutan_".$reqPeriode.".xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>