...
$kalkulasi_penyusutan->selectByParamsPeriodeTahunan();
...
$reqPeriodeLalu = (substr($reqPeriode, 0, 2))."".(substr($reqPeriode, 2, 4)-1);
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-inventaris/aktiva_tetap_tahunan_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEksporXls').on('click', function () {
				  document.location.href = "rekap_aktiva_tetap_tahunan_excel.php?reqMode=update&reqPeriode="+$("#reqPeriode").val();	
			  });
			  $('#btnEksporPdf').on('click', function () {
				  window.parent.OpenDHTML("rekap_aktiva_tetap_tahunan_pdf.php?reqMode=update&reqPeriode="+$("#reqPeriode").val(), 'Sistem Informasi Inventaris');	
			  });
			  ...
			  $("#reqPeriode").change(function() { 
			  		document.location.href ="aktiva_tetap_tahunan.php?reqPeriode="+ $("#reqPeriode").val();
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekapitulasi Aktiva Tetap</span>
            </div>            
            </td>
        </tr>
    </table>
