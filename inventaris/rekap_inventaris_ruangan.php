			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 // else
			  		...
			  		oTable.fnReloadAjax("../json-gaji/integrasi_potongan_json.php?reqPeriode="+ $("#reqPeriode").val());
			  ...
			  $('#btnEksporXls').on('click', function () {
				  document.location.href = 'rekap_inventaris_ruangan_excel.php?reqMode=update&reqId='+anSelectedId;	
			  });
			  $('#btnEksporPdf').on('click', function () {
				  window.parent.OpenDHTML('rekap_inventaris_ruangan_pdf.php?reqMode=update&reqId='+anSelectedId, 'Sistem Informasi Inventaris');	
			  });
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Rekap Asset</span>
            </div>            
            </td>
        </tr>
    </table>
