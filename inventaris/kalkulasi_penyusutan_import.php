...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-inventaris/kalkulasi_penyusutan_import.php',
				onSubmit:function(){
        ...
        {
            window.open("rekap_kalkulasi_penyusutan_excel.php", '_blank');
        }
	</script>
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Import Data Kalkulasi Penyusutan</span>
    </div>
    ...
    <table>
        ...
        <div>
            ...
            <input type="hidden" id="reqPeriode" name="reqPeriode" value="<?=$arrPeriode[0]?>">
