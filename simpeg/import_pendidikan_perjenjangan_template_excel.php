...
$fname = tempnam("/tmp", "import_pendidikan_perjenjangan_template.xls");
...
header("Content-Type: application/x-msexcel; name=\"import_pendidikan_perjenjangan_template.xls\"");
header("Content-Disposition: inline; filename=\"import_pendidikan_perjenjangan_template.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>