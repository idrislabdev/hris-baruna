...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/pegawai_pencarian_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			 ...
			 // $('#example tbody tr').on('dblclick', function () {
			  ...
			  $("#reqJenisPegawai").change(function() { 
				 oTable.fnReloadAjax("../json-simpeg/pegawai_cuti_tahunan_pencarian_json.php?reqDepartemen=<?=$reqDepartemen?>&reqJenisPegawai="+ $("#reqJenisPegawai").val());				 	 
			  });
...
<div id="wadah">
    ...
    <div style="position: absolute; margin-top:6px; margin-left:188px; z-index:9999; font-size:12px;">
