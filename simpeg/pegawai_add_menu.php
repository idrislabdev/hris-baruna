...
else if(varItem == 'pegawai_add_status_cuti_tahunan'){
	$('#pegawai_add_status_cuti_tahunan').css({'background-position': '0 -27px'});
	parent.mainFramePop.location.href='pegawai_add_status_cuti_tahunan_monitoring.php?reqId=<?=$reqId?>';
	parent.mainFrameDetilPop.location.href='pegawai_add_status_cuti_tahunan.php?reqId=<?=$reqId?>';
	parent.document.getElementById('trdetil').style.display = '';		
}
...
else if(varItem == 'pegawai_add_cv'){
	$('#pegawai_add_cv').css({'background-position': '0 -27px'});
	parent.mainFramePop.location.href='pegawai_add_cv_monitoring.php?reqId=<?=$reqId?>';
	parent.mainFrameDetilPop.location.href='pegawai_add_cv.php?reqId=<?=$reqId?>';
	parent.document.getElementById('trdetil').style.display = '';	
}
...
<body onload="hide_perubahan_pangkat('<?=$reqId?>')" style="overflow-x:hidden;">
	...
	<tr>
		<td>
        	...
        	<div style="background-image:url(../WEB-INF/images/bg-identitas.png); ">
                ...
                <div id="menu-kiri-title">IDENTITAS</div>
                ...
                <div class="identitas-area">
                    ...
                    <div class="identitas-data"> 
                        <div><?=$tempNama?></div>     
                        <div>NRP : <?=$tempNRP?></div>
                        <div>Zodiac : <?=$tempZodiac?></div>
                        
                    </div>
                    <div class="identitas-jabatan"><?=$tempJabatanNama?> / <?=$tempKelas?></div>
                </div>
            ...
            <div id="menu-kiri">
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapeg.png" height="24" class="top" />Data Pegawai
                </div>
                </a>

                <a href="#" id="pegawai_add_sk_calon_pegawai" class="menu-bg" onclick="executeOnClick('pegawai_add_sk_calon_pegawai');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-sk-capeg.png" height="24" class="top" />SK Calon Pegawai
                </div>
                </a>

                <a href="#" id="pegawai_add_sk_pegawai" class="menu-bg" onclick="executeOnClick('pegawai_add_sk_pegawai');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-sk-peg.png" height="24" class="top" />SK Pegawai
                </div>
                </a>
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-jenis-peg.png" height="24" class="top" />Jenis Pegawai
                </div>
                </a>
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datajab.png" height="24" class="top" />Data Jabatan
                </div>
                </a>
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datajab-perbantuan.png" height="24" class="top" />Data Jabatan Perbantuan
                </div>
                </a>
                
                <a href="#" id="pegawai_add_pangkat" class="menu-bg" onclick="executeOnClick('pegawai_add_pangkat');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapangkat.png" height="24" class="top" />Data Pangkat
                </div>
                </a>
                <?php /*?></div><?php */?>
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapenghasilan.png" height="24" class="top" />Data Penghasilan
                </div>
                </a>
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapend-jenjang.png" height="24" class="top" />Data Pendidikan Perjenjangan
                </div>
                </a>
                
                <a href="#" id="pegawai_add_pendidikan_substansial" class="menu-bg" onclick="executeOnClick('pegawai_add_pendidikan_substansial');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapend-subs.png" height="24" class="top" />Data Pendidikan Substansial
                </div>
                </a>
				
                <a href="#" id="pegawai_add_pendidikan" class="menu-bg" onclick="executeOnClick('pegawai_add_pendidikan');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-datapend.png" height="24" class="top" />Data Pendidikan
                </div>
                </a>
                
                <a href="#" id="pegawai_add_status_nikah" class="menu-bg" onclick="executeOnClick('pegawai_add_status_nikah');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-nikah.png" height="24" class="top" />Status Nikah
                </div>
                </a>
                
                <a href="#" id="pegawai_add_keluarga" class="menu-bg" onclick="executeOnClick('pegawai_add_keluarga');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-keluarga.png" height="24" class="top" />Data Keluarga
                </div>
                </a>

                <a href="#" id="pegawai_add_perubahan_alamat" class="menu-bg" onclick="executeOnClick('pegawai_add_perubahan_alamat');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-alamat.png" height="24" class="top" />Perubahan Alamat
                </div>
                </a>

                <a href="#" id="pegawai_add_hukuman" class="menu-bg" onclick="executeOnClick('pegawai_add_hukuman');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-hukum.png" height="24" class="top" />Hukuman
                </div>
                </a>
                
                <a href="#" id="pegawai_add_sertifikat" class="menu-bg" onclick="executeOnClick('pegawai_add_sertifikat');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-sert.png" height="24" class="top" />Sertifikat
                </div>
                </a>
                <a href="#" id="pegawai_add_cv" class="menu-bg" onclick="executeOnClick('pegawai_add_cv');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-pengalaman.png" height="24" class="top" />Curiculum Vitae
                </div>
                </a>

                <!--<div id="menu-kiri-title">FIP 04</div>                
                <a href="#" id="pegawai_add_status_cuti_tahunan" class="menu-bg" onclick="executeOnClick('pegawai_add_status_cuti_tahunan');">
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-cuti.png" height="24" class="top" />Status Cuti Tahunan
                </div>
                </a>-->
