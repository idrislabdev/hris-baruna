...
<script type="text/javascript">
   ...
   $.fn.combotree.defaults = {
			...
			if(newValue == '<?=$reqDepartemen?>')
			{
				...
				document.location.href = "histori_mutasi.php?reqDepartemen=" + newValue + "&reqKelompok="+ $("#reqKelompok").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val() + "&reqStatusPegawai=" +$("#reqStatusPegawai").val(); 
			}
	};
</script>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/histori_mutasi_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			pLocation: "../json-simpeg/histori_mutasi_json.php",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedStatusPegawai= element[element.length-1];
			  });
			  
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pegawai_add.php?reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '980', '535');	
			  });
			  
			  $('#btnHistoriMutasi').on('click', function () {
				  if(anSelectedData == "")
					  return false;
				  /*if(anSelectedStatusPegawai == '5')
				  {
					  alert('Data status Pegawai sudah MPP');
				  }
				  else
				  {
				  	window.parent.OpenDHTML('pegawai_add_mutasi.php?reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '680', '255');	
				  }*/
				  window.parent.OpenDHTML('histori_mutasi_add.php?reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '680', '255');	
			  });
			  
			  $('#btnMpp').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pegawai_add_mpp.php?reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '980', '535');	
			  });
			  ...
			  $("#reqJenisPegawai").change(function() { 
				 oTable.fnReloadAjax("../json-simpeg/histori_mutasi_json.php?reqDepartemen=<?=$reqDepartemen?>&reqKelompok="+ $("#reqKelompok").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val() + "&reqStatusPegawai=" +$("#reqStatusPegawai").val());				 	 
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Histori Mutasi</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <!--<a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pegawai_add.php', 'Office Management - Aplikasi Kepegawaian', '980', '535');" title="Tambah">Tambah</a>-->
            ...
            <a href="#" id="btnHistoriMutasi" title="Mutasi">Histori</a>
            <!--<a href="#" id="btnMpp" title="MPP">MPP</a>-->
            </li>        
        </ul>
    </div>
    <?
    ...
    <div style="position: absolute; margin-top:6px; margin-left:148px; z-index:9999; font-size:12px;">
