...
$akses_app_penghasilan->selectByParamsAksesMenu(array("LINK_FILE" => "cuti_tunda.php", "AKSES_APP_PENGHASILAN_ID" => $userLogin->userAksesPenghasilan));
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/cuti_tunda_json.php?reqPeriode=<?=$reqPeriode?>",
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 oTable.fnReloadAjax("../json-simpeg/cuti_tunda_json.php?reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
				 	 
			  });

			  $('#btnProses').on('click', function () {
				 oTable.fnReloadAjax("../json-simpeg/cuti_tunda_json.php?reqMode=proses&reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
			  });
			  ...
			  /* RIGHT CLICK EVENT */
			  	...
			  	$('#example tbody tr').on('click', function () {
				  	...
				  	parent.frames['mainFrameDetilPop'].location.href = 'cuti_tunda_detail.php?reqCutiId=' + anSelectedData;
			  	});	
			$('#btnCetak').on('click', function () {
				//if(anSelectedData == '') return false;		
			  	newWindow = window.open('cuti_tunda_monitoring_cetak.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
		  	});		
		} );
</script>
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Cuti Tunda</span>
            </div>            
            </td>
        </tr>
    </table>
    <form id="formAddNewRow" action="#" title="Add a new browser" style="width:600px;min-width:600px">
     ...
     <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li><a href="#" id="btnCetak" title="Cetak">Cetak</a> </li>
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="85px">Tunda</th>
            <th width="85px">Dilaksanakan</th>
        </tr>
    </thead>
    </table>
    </div>    
