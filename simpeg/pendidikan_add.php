...
{
	$reqMode = "update";	
	$pendidikan->selectByParams(array('PENDIDIKAN_ID'=>$reqId), -1, -1);
	$pendidikan->firstRow();
	
	$tempNama= $pendidikan->getField('NAMA');
	$tempKeterangan= $pendidikan->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pendidikan_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Pendidikan</span>
    </div>
