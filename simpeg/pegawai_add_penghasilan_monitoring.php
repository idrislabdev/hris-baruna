...
if($reqMode == "delete")
{
	...
	$delete_row_user->setField("TABEL_NAMA", "PEGAWAI_PENGHASILAN");
	...
	echo '<script language="javascript">';
	echo 'window.parent.frames["mainFrameDetilPop"].location.href = "pegawai_add_penghasilan.php?reqId='.$reqId.'";';
	echo '</script>';
		
}

$pegawai_penghasilan->selectByParams(array("A.PEGAWAI_ID" => $reqId));
...
<div id="wadah">
	...
	?>
        <tr onClick="parent.frames['mainFrameDetilPop'].location.href = 'pegawai_add_penghasilan.php?reqId=<?=$reqId?>&reqRowId=<?=$pegawai_penghasilan->getField("PEGAWAI_PENGHASILAN_ID")?>'">
            ...
            <td><?=$pegawai_penghasilan->getField("KETERANGAN_PERUBAHAN")?></td>
