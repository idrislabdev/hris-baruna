...
{
	$reqMode = "update";	
	$pejabat_penetap->selectByParams(array('PEJABAT_PENETAP_ID'=>$reqId), -1, -1);
	$pejabat_penetap->firstRow();
	
	$tempNama= $pejabat_penetap->getField('NAMA');
	$tempKeterangan= $pejabat_penetap->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pejabat_penetap_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Pejabat Penetap</span>
    </div>
