...
<script src="media/js/FixedColumns.js" type="text/javascript"></script>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-intranet/hasil_rapat_json.php",						  
			...
			sDeleteURL: "../json-intranet/delete.php?reqMode=hasil_rapat",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pegawai_add.php?reqId='+anSelectedId, 'Office Management - Administrasi Intranet', '900', '480');	
			  });
			  ...
			  return false;
			   ...
			   $('.vmenu .inner_li span').on('click',function() {												
					  if($(this).text() == 'Aktif')
					  {
						  $.getJSON('../json-intranet/hasil_rapat_set_status.php?reqId='+anSelectedId+'&reqNilai=1', function (data) 
						  {
					  ...
					  {
						  $.getJSON('../json-intranet/hasil_rapat_set_status.php?reqId='+anSelectedId+'&reqNilai=0', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Hasil Rapat</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <?
    if($userLogin->arrGroupIntranet[0]["HASIL_RAPAT"] == "A")
	{
	?>    
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pegawai_add.php', 'Office Management - Administrasi Intranet', '900', '480');" title="Tambah">Tambah</a>
