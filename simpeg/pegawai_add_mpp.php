...
$pegawai_jabatan->selectByParamsJabatanTerakhirMPP(array('A.PEGAWAI_ID'=>$reqId));
...
function getEnableDisableInput($json_item_gaji, $variable)
{
	...
	{
		echo $json_item_gaji->{'VAR_JUMLAH'}{$i} . " - " . $variable;
...
<head>
    ...
    <script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pegawai_add_mpp.php',
				onSubmit:function(){
			...
			$("#reqPeriode").keyup(function(e) {
				if( $("#reqPeriode").val() != ''){
					$.getJSON('../json-simpeg/get_periodik_penghasilan_gaji_mpp.php?reqPegawaiId=<?=$reqId?>&reqPeriode='+$("#reqPeriode").val(),
					function(data){
			...
			function hitungTunsel(e) {
				var strKelas;
					...
					function(data){
						var persenMPP = 0.075;
						$("#reqJumlahP3").val(FormatCurrency(Number(data.JUMLAH)+(Number(data.JUMLAH)*persenMPP)));
						...
						var tx = Number(bc) + (Number(bc) * persenMPP) + Number(bd) + (Number(bd) * persenMPP);
						var tt = tx - tz;
...
<div id="wadah" class="CodeMirror-scroll">
    ...
    <div id="judul-halaman">
		<span><img src="../WEB-INF/images/panah-judul.png">Informasi Perubahan Status MPP</span>
	</div>
        ...
        <div class="data-table">
    		<form id="ff" method="post" novalidate style="margin-top:20px;">
                <table border="0" width="100%">
                    <tr>
                        ...
                        <td>
                            <input id="reqTMTMPP" name="reqTMTMPP" class="easyui-datebox" data-options="validType:'date'" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="reqNoSKMPP" id="reqNoSKMPP" class="easyui-validatebox" size="40" type="text" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td>TMT</td>
            ...
            <?php /*?>        <tr>
                ...
                <div>
                    ...
                    <input type="button" name="reqCetakSK" id="reqCetakSK" value="Cetak SK">
