...
{
	$reqMode = "update";	
	$agama->selectByParams(array('AGAMA_ID'=>$reqId), -1, -1);
	$agama->firstRow();
	
	$tempNama= $agama->getField('NAMA');
	$tempKeterangan= $agama->getField('KETERANGAN');
}
?>
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Agama</span>
    </div>
