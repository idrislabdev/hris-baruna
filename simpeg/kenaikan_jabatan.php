...
$jenis_kenaikan_jabatan = new JenisPegawai();
$status_kenaikan_jabatan = new StatusPegawai();
...
$jenis_kenaikan_jabatan->selectByParams();
$status_kenaikan_jabatan->selectByParams();
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/kenaikan_jabatan_json.php?reqStatus=0",
			...
			/* Click event handler */
			  ...
			  $('#btnCetakExportExcel').on('click', function () {
			  	newWindow = window.open('kenaikan_jabatan_excel.php?reqStatus=0', 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $('#btnTolak').on('click', function () {
				  ...
				  if ( confirm( "Usulan tidak disetujui ?" ) ) 
				  {
					$.getJSON('../json-simpeg/pegawai_kenaikan_jabatan_set_tolak.php?reqId='+anSelectedId, function (data) 
					{
						$.each(data, function (i, SingleElement) {
							oTable.fnReloadAjax("../json-simpeg/kenaikan_jabatan_json.php?reqStatus="+ $("#reqStatus").val());
						});
					});
			  ...
			  $('#btnKenaikanJabatan').on('click', function () {
				  if(anSelectedData == "")
					  return false;
				  window.parent.OpenDHTML('pegawai_add_usulan_kenaikan_jabatan_realisasi.php?reqId='+anSelectedPegawaiId+'&reqKenaikanJabatanId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '980', '400');
			  });

			  $('#btnCetakSK').on('click', function () {
				  if(anSelectedData == "")
					  return false;
				  alert('Cetak SK');
			  });
			  ...
			  return false;
			   ...
			   $('.vmenu .inner_li span').on('click',function() {												
					  if($(this).text() == 'Aktif')
					  {
						  $.getJSON('../json-intranet/kenaikan_jabatan_set_status.php?reqId='+anSelectedId+'&reqNilai=1', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
							  });
						  });									
					  ...
					  {
						  $.getJSON('../json-intranet/kenaikan_jabatan_set_status.php?reqId='+anSelectedId+'&reqNilai=0', function (data) 
						  {
							  $.each(data, function (i, SingleElement) {
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Kenaikan Jabatan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnKenaikanJabatan" title="Realisasi">Realisasi</a> 
            <a href="#" id="btnTolak" title="Tolak">Tolak</a> 
            </li>
             <li>
            <a href="#" id="btnCetakSK" title="Cetak SK">Cetak SK</a>
            </li>
            <li>
            <a href="#" id="btnCetakExportExcel" title="Export Excel">Export Excel</a>
            </li>
        </ul>
    </div>
    <?
    ...
    <thead>
        <tr>
        	...
        	<th rowspan="2" class="th_like" width="250px">PEGAWAI ID</th>
            <th rowspan="2" class="th_like" width="85px">NRP</th> 
            <th rowspan="2" class="th_like" width="85px">NIPP</th>
            <th rowspan="2" class="th_like" width="180px">Nama</th>
            <th colspan="2" style="text-align:center">Sebelum</th>
            <th colspan="2" style="text-align:center">Sesudah</th>
        </tr>
        <tr>
        	<th class="th_like" width="170px">Departemen</th>
            <th class="th_like" width="170px">Jabatan</th>
            <th class="th_like" width="170px">Departemen</th>
            <th class="th_like" width="170px">Jabatan</th>
        </tr>
    </thead>
        ...
        <!--RIGHT CLICK EVENT -->
        <div class="vmenu">
            <?php /*?><div class="first_li"><span>Ubah</span></div>
            <div class="first_li"><span>Mutasi</span></div>
            <div class="first_li"><span>MPP</span></div>
            <div class="first_li"><span>Hapus</span></div><?php */?>
        </div>
        <!--RIGHT CLICK EVENT -->
