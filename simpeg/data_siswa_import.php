...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/import_data_siswa_import.php',
				onSubmit:function(){
        ...
        {
            window.open("import_data_siswa_template_excel.php", '_blank');
        }
	</script>
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Siswa </span>
    </div>
...
<!--         <tr>
        ...
        <tr>
            ...
            <td> : </td>
            <td>
                <a onClick="downloadForm()" style="cursor: pointer; color:blue">Download Template Siswa</a>
            </td>
        </tr>  
        <tr>
            <td>Upload</td>
