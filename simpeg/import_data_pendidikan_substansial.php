...
//$tempLokasi= $pegawai_pendidikan_substansial->getField("LOKASI_TERAKHIR");
//$tempNama= $pegawai_pendidikan_substansial->getField("KAPAL");
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/import_data_pendidikan_substansial.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Import Data Pendidikan Substansial</span>
    </div>
