...
{
	$reqMode = "update";	
	$status_pegawai->selectByParams(array('STATUS_PEGAWAI_ID'=>$reqId), -1, -1);
	$status_pegawai->firstRow();
	
	$tempNama= $status_pegawai->getField('NAMA');
	$tempKeterangan= $status_pegawai->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/status_pegawai_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data StatusPegawai</span>
    </div>
