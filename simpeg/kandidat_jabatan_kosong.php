...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/kandidat_jabatan_kosong_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  {
					  window.parent.OpenDHTML('kandidat_jabatan_kosong_pilih.php?reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '600', '300');	
				  }
				  else
				  	alert("Jabatan sudah terisi.");
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnEdit" title="Edit">Pilih Kandidat</a>
            </li>        
        </ul>
    </div>
