...
<style type="text/css" media="screen">
	...
	.coloringRowBlue { background-color:#A8AEFD; }
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/work_order_kontrak_pkwt_json.php",
			...
			/* Click event handler */
			  ...
			  $('#btnCetakExportExcel').on('click', function () {
			  	newWindow = window.open('work_order_kontrak_pkwt_excel.php', 'Cetak');
				newWindow.focus();
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Kontrak PKWT</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="60px">Kontrak Awal</th>
            <th width="70px">Kontrak Akhir</th> 
        </tr>
    </thead>
    </table>
    </div>
