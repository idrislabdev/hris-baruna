...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/integrasi_kenaikan_import.php',
				onSubmit:function(){
        ...
        {
            window.open("import_integrasi_kenaikan_excel.php", '_blank');
        }
	</script>
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Data Kenaikan Kelas Siswa</span>
    </div>
