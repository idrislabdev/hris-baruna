    	...
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="50%">
                	<?
                    if($reqId == "")
						$link = "cuti_tahunan_add_data.php?reqId=".$reqId."&reqPeriode=".$reqPeriode;
					else 
						$link = "cuti_tahunan_add_monitoring.php?reqId=".$reqId;
					?>
                	<td><iframe src="<?=$link?>" class="mainframe" id="idMainFrame" name="mainFramePop" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
                </tr>
            	<tr height="50%" id="trdetil" <? if($reqId == "") { ?> style="display:none" <? } ?>>
                	<td><iframe <? if($reqId == "") {} else { ?> src="cuti_tahunan_add_detil.php?reqId=<?=$reqId?>" <? } ?> class="mainframe" id="idMainFrameDetil" name="mainFrameDetilPop" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
                </tr>
            </table>			
		</td>
	</tr>
