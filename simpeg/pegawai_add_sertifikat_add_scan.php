...
<ol id="toc" style="margin-bottom:-1px; margin-top:-3px;">
    <li><a href="pegawai_add_sertifikat_add_upload.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>"><span>Upload</span></a></li>
    <li class="current"><a href="#"><span>Scan</span></a></li>
</ol>
    	...
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="50%" id="trdetil">
                	<td><iframe src="pegawai_add_sertifikat_add_data_scan.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>" class="mainframe" id="idMainFrameDetil" name="mainFrameDetilPop" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
                </tr>
            </table>			
		</td>
	</tr>
