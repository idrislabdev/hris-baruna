...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-simpeg/pengawakan_json.php?reqStatus=0",
			...
			/* Click event handler */
			  ...
			  $('#btnValidasi').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pengawakan_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Kepegawaian', '890', '550');	
			  });

			  $("#reqStatus").change(function() {
				 oTable.fnReloadAjax("../json-simpeg/pengawakan_json.php?reqStatus=" + $("#reqStatus").val());
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Validasi Pengawakan</span>
            </div>            
            </td>
        </tr>
    </table>
    <div style="position: relative; z-index:10">
    <div style="position: absolute; margin-top:31px; margin-left:180px; z-index:9999; font-size:12px;">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnValidasi" title="Validasi">Validasi</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th rowspan="2">Id</th>
            <th width="100px" rowspan="2">NRP</th>
            <th width="200px" rowspan="2">Nama</th>
            <th width="200px" rowspan="2">Kelas</th>
            <th width="200px" colspan="2" style="text-align:center">Sebelum</th>
            <th width="200px" colspan="2" style="text-align:center">Sesudah</th>                                      
        </tr>
        <tr>
            <th width="200px">Jabatan</th>
            <th width="200px">Kapal</th>
            <th width="200px">Jabatan</th>
            <th width="200px">Kapal</th>      
        </tr>
    </thead>
