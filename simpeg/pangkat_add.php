...
{
	$reqMode = "update";	
	$pangkat->selectByParams(array('PANGKAT_ID'=>$reqId), -1, -1);
	$pangkat->firstRow();
	
	$tempNama= $pangkat->getField('NAMA');
	$tempKeterangan= $pangkat->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pangkat_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Pangkat</span>
    </div>
