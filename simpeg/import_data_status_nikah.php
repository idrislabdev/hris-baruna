...
//$tempLokasi= $pegawai_status_nikah->getField("LOKASI_TERAKHIR");
//$tempNama= $pegawai_status_nikah->getField("KAPAL");
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/import_data_status_nikah.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Import Data Status Nikah</span>
    </div>
