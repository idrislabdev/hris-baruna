...
$tempDepartemenNamaPegawai = $pegawai->getField('DEPARTEMEN');
...
<head>
    ...
    <script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pegawai_add_mutasi.php',
				onSubmit:function(){
...
<div id="wadah" class="CodeMirror-scroll">
    ...
    <div id="judul-halaman">
		<span><img src="../WEB-INF/images/panah-judul.png">Mutasi Departemen</span>
	</div>
    		...
    		<form id="ff" method="post" novalidate style="margin-top:20px;">
                <table>
                    <tr>
                        ...
                        <td>
                            <label><?=$tempDepartemenNamaPegawai?></label>
                            <input type="hidden" name="reqDepartemenLama" value="<?=$tempDepartemenPegawai?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Unit Kerja Baru</td>
                        <td>
                            <input id="ccDepartemen" class="easyui-combotree" required name="reqDepartemen" data-options="panelHeight:'88',url:'../json-simpeg/departemen_combo_json.php'" style="width:300px;">
                        </td>
                    </tr>
                    <tr>
                        <td>Jabatan Lama</td>
                        <td>
                            <label><?=$pegawai_info->getField("JABATAN_NAMA")?></label>
                            <input type="hidden" name="reqJabatanLama" value="<?=$tempDepartemenPegawai?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Jabatan Baru</td>
                        <td>
                            <input id="ccJabatan" class="easyui-combotree"  required="true" name="reqJabatan" data-options="panelHeight:'120',url:'../json-simpeg/jabatan_combo_json.php'" style="width:300px;">
                        </td>
                    </tr>
                    <tr>
                        <td>Nomor SK</td>
                    ...
                    <tr>
                        <td>Keterangan</td>
                        <td>
                            <textarea name="reqKeterangan" style="width:400px; height:100px;"></textarea>
                        </td>
                    </tr>
                </table>
                <div>
