...
if(varItem == 'pegawai_add_data'){
	...
	parent.mainFramePop.location.href='pegawai_add_mpp_data.php?reqId=<?=$reqId?>';
	...
	parent.mainFramePop.location.href='pegawai_add_mpp_add_penghasilan_monitoring.php?reqId=<?=$reqId?>';
	parent.mainFrameDetilPop.location.href='pegawai_add_mpp_add_penghasilan.php?reqId=<?=$reqId?>';
		...
		<td>
            ...
            <div id="menu-kiri">
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/administrator.png" height="24" class="top" />Data MPP
                </div>
                </a>
