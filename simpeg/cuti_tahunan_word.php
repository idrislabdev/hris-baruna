...
$PHPWord = new PHPWord();
$document = $PHPWord->loadTemplate('template-cuti/PENGAJUAN_CUTI.docx');
...
$document->save('template-cuti/suratPerintah'.$reqId.'.doc');
$file = 'template-cuti/suratPerintah'.$reqId.'.doc';

$down = 'template-cuti/suratPerintah'.$reqId.'.doc';
