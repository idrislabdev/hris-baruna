...
{
	$reqMode = "update";	
	$pangkat_perubahan_kode->selectByParams(array('PANGKAT_PERUBAHAN_KODE_ID'=>$reqId), -1, -1);
	$pangkat_perubahan_kode->firstRow();
	
	$tempKode= $pangkat_perubahan_kode->getField('KODE');
	$tempNama= $pangkat_perubahan_kode->getField('NAMA');
	$tempKeterangan= $pangkat_perubahan_kode->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/pangkat_perubahan_kode_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Pangkat Perubahan Kode</span>
    </div>
