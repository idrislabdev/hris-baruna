...
//$tempLokasi= $pegawai_pendidikan->getField("LOKASI_TERAKHIR");
//$tempNama= $pegawai_pendidikan->getField("KAPAL");
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/import_data_pendidikan.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Import Data Pendidikan</span>
    </div>
