...
$fname = tempnam("/tmp", "import_sertifikat_template.xls");
...
$worksheet->set_column(5, 5, 44.00);
...
$worksheet->write(0, 1, "NAMA_SERTIFIKAT", $text_format_line_bold);
$worksheet->write(0, 2, "TANGGAL_TERBIT", $text_format_line_bold);
$worksheet->write(0, 3, "TANGGAL_KADALUARSA", $text_format_line_bold);
$worksheet->write(0, 4, "GROUP", $text_format_line_bold);
$worksheet->write(0, 5, "KETERANGAN", $text_format_line_bold);
...
header("Content-Type: application/x-msexcel; name=\"import_sertifikat_template.xls\"");
header("Content-Disposition: inline; filename=\"import_sertifikat_template.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>