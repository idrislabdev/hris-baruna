...
{
	$reqMode = "update";	
	$universitas->selectByParams(array('UNIVERSITAS_ID'=>$reqId), -1, -1);
	$universitas->firstRow();
	
	$tempKode= $universitas->getField('KODE');
	$tempNama= $universitas->getField('NAMA');
	$tempKeterangan= $universitas->getField('KETERANGAN');
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-simpeg/universitas_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Universitas</span>
    </div>
