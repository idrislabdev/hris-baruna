...
if(varItem == 'pegawai_add_data'){
	...
	parent.mainFramePop.location.href='pegawai_non_add_data.php?reqId=<?=$reqId?>';
		...
		<td>
        	...
        	<div style="background-image:url(../WEB-INF/images/bg-identitas.png)">
                ...
                <div style="margin-top:5px; width:230px; margin-left:5px; float:left; position:relative; text-align:left;">
                    ...
                    <div style="float:left; position:relative; width:170px; border-bottom:1px dashed #FFF;"> 
                        ...
                        <div style="color:#FFF; font-size:12px; text-shadow:1px 1px 1px #000; line-height:20px;">NIS : <?=$tempNIS?></div>
                ...
                -&nbsp;<?=$tempKelasSekolah?> / <?=$tempJurusanSekolah?>&nbsp;-
                </div>
			</div>            
            <? }?>
            ...
            <div id="menu-kiri">
                ...
                <div class="menu-kiri-text">
                	<img src="../WEB-INF/images/icn-menu-sk-capeg.png" height="24" class="top" />Data Non Pegawai
                </div>
                </a>
            </div>
		</td>
