...
<!--#endif-->
    ...
    <link rel="stylesheet" href="../WEB-INF/lib/pdfjs/web/viewer.css"/>
<!--#if !PRODUCTION-->
    <link rel="resource" type="application/l10n" href="locale/locale.properties"/>
<!--#endif-->

<!--#if !(FIREFOX || MOZCENTRAL || CHROME)-->
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/compatibility.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/external/webL10n/l10n.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/shared/util.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/shared/colorspace.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/shared/pattern.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/shared/function.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/shared/annotation.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/display/api.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/display/metadata.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/display/canvas.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/src/display/font_loader.js"></script>
    <script type="text/javascript">PDFJS.workerSrc = '../WEB-INF/lib/pdfjs/src/worker_loader.js';</script>
<!--#endif-->
...
<!--#if !PRODUCTION-->
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/ui_utils.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/download_manager.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/page_view.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/thumbnail_view.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/text_layer_builder.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/pdf_find_bar.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/pdf_find_controller.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/pdf_history.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/secondary_toolbar.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/password_prompt.js"></script>
<!--#endif-->

    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/debugger.js"></script>
    <script type="text/javascript" src="../WEB-INF/lib/pdfjs/web/viewer.js"></script>
