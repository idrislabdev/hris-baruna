...
class jabatan_json extends CI_Controller {
	...
	function json()
	{
		...
		$aColumns = array("JABATAN_ID", "NAMA", "KELAS", "PPH", "STATUS");
		$aColumnsAlias = array("JABATAN_ID", "NAMA", "KELAS", "PPH", "STATUS");
	...
	function jabatan_p3_combo_json()
	{
		/* INCLUDE FILE */
		include_once("../WEB-INF/classes/utils/UserLogin.php");
		include_once("../WEB-INF/functions/string.func.php");
