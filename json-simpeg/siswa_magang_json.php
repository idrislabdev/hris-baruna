...
$aColumns = array("PEGAWAI_ID", "NIS", "NAMA", "JENIS_KELAMIN", "TEMPAT_LAHIR", "TANGGAL_LAHIR", "ALAMAT", "DEPARTEMEN","KELAS_SEKOLAH" );
$aColumnsAlias = array("PEGAWAI_ID", "NIS", "NAMA",  "JENIS_KELAMIN", "TEMPAT_LAHIR", "TANGGAL_LAHIR", "ALAMAT", "DEPARTEMEN","KELAS_SEKOLAH");
...
if($_GET['sSearch'] == "")
	...
	$allRecordFilter = $pegawai->getCountByParams(array("JENIS_PEGAWAI_ID" => 8), $statement." AND ((UPPER(A.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%') OR (UPPER(A.NIS) LIKE '%".strtoupper($_GET['sSearch'])."%')) ");

//echo $pegawai->query;
$pegawai->selectByParamsSiswa(array("JENIS_PEGAWAI_ID" => 8), $dsplyRange, $dsplyStart, $statement." AND ((UPPER(A.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%') OR (UPPER(A.NIS) LIKE '%".strtoupper($_GET['sSearch'])."%')) " , $sOrder);
