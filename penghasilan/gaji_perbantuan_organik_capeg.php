...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_perbantuan_organik_capeg_json.php?reqPeriode=<?=$reqPeriode?>&reqDepartemen=<?=$reqDepartemen?>&reqJenisPegawaiId=2&reqStatusPegawaiId=1,2,3,4,5",						  
			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
				 if($("#reqPeriode").val() == '<?=$arrPeriode[0]?>' && '<?=$lock_proses?>' == '0')
				 	 ...
				 	 $('.toggle').css({"display":"none"}); 
			  		oTable.fnReloadAjax("../json-gaji/gaji_perbantuan_organik_capeg_json.php?reqJenisPegawaiId=" + $("#reqJenisPegawai").val() + "&reqDepartemen="+$('#cc').combotree('getValue')+"&reqPeriode="+ $("#reqPeriode").val()+"&reqStatusPegawaiId="+ $("#reqStatusPegawai").val());
			  ...
			  $('#cc').combotree({
					onSelect: function(param){
						 oTable.fnReloadAjax("../json-gaji/gaji_perbantuan_organik_capeg_json.php?reqJenisPegawaiId=" + $("#reqJenisPegawai").val() + "&reqDepartemen="+param.id+"&reqPeriode="+ $("#reqPeriode").val()+"&reqStatusPegawaiId="+ $("#reqStatusPegawai").val());
					}
			  });
			  ...
			  $('#btnCetakBukuBesarOrganik').on('click', function () {
				...
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=BESAR&reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');				
			  });
		...
		/*	  $('#btnEkspor').on('click', function () {  
			  ...
			  $('#btnEksporPerbantuan').on('click', function () {  
			  	newWindow = window.open('gaji_perbantuan_cetak.php?reqJenisPegawaiId=2&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnEksporOrganik').on('click', function () {  
			  	newWindow = window.open('gaji_perbantuan_cetak.php?reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  			  
			  ...
			  $('#btnTaspen').on('click', function () {
				...
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=DAFTAR_TASPEN_PEGAWAI&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');					
			  });

			  $('#btnNotaDinasPembayaranGaji').on('click', function () {
			  	// old newWindow = window.open('nota_dinas_pembayaran_gaji_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow = window.open('nota_dinas_pembayaran_gaji_dt_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();			  });
			 ...
			 //newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=DAFTAR_IURAN_JAMSOSTEK&reqJenisPegawaiId=2&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');	
			  });
			  ...
			  $('#btnJamsostekOrganik').on('click', function () {
				...
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=DAFTAR_IURAN_JAMSOSTEK&reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');				
			  });
			  
			  $('#btnDaftarPengantarBankCSVMandiri').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_mandiri_csv.php?reqJenisPegawaiId=&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnDaftarPengantarBankCSVBNI').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_bni_csv.php?reqJenisPegawaiId=&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnDaftarPengantarBankCSVBRI').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_bri_csv.php?reqJenisPegawaiId=&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $('#btnPotonganExcel').on('click', function () {
			  	newWindow = window.open('potongan_excel.php?reqPeriode=<?=$reqPeriode?>&reqDepartemen='+$('#cc').combotree('getValue'), 'Cetak');
				newWindow.focus();
			  });			  
			  ...
			  $('#btnDanaPensiunExcel').on('click', function () {
			  	newWindow = window.open('dana_pensiun_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			
			  ...
			  $('#btnDaftarPengantarSemua').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_cetak_rpt.php?reqJenisPegawaiId=0&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $('#btnCetakSemuaOrganik').on('click', function () {
			  	newWindow = window.open('gaji_perbantuan_slip.php?reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $('#btnKirimJurnal').on('click', function () {
				  ...
				  //{
					window.parent.OpenDHTML('proses_gaji_set_lock.php?reqJenisProses=GAJI_PERBANTUAN_ORGANIK&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');							    
					/*
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Perbantuan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
			...
			?>
            <li><a href="#" title="Lihat" id="btnEdit" >&nbsp;Lihat</a></li>                    
            <li>
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
            ...
            <li><a href="#" id="btnDaftarPengantar">Daftar Pengantar</a>
                ...
                <li><a href="#" id="btnDaftarPengantarSemua">Semua</a></li>
                </ul>           
            </li>
            <li><a href="#" id="btnJamsostekPerbantuan">BPJS Ketenagakerjaan</a>
                <!--ul>
            ...
            <li><a href="#" id="btnNotaDinasPembayaranGaji">Nota Dinas Pembayaran Gaji</a>
            </li>         
        ...
        <ul id="flexmenu2" class="flexdropdownmenu">
            <li><a href="#" id="btnEksporPerbantuan">Monitoring Gaji</a>
                <!--ul>
                <li><a href="#" id="btnEksporPerbantuan">Perbantuan</a></li>
                <li><a href="#" id="btnEksporOrganik">Organik</a></li>
                </ul-->               
            </li>
            <li><a href="#" id="btnDaftarPengantarBankExcelPerbantuan">Daftar Pengantar</a>
                <!--ul>
            ...
            <li><a href="#" id="btnDanaPensiunExcel">Dana Pensiun</a></li>
        </ul> 
		<ul id="flexmenu3" class="flexdropdownmenu">

					<li><a href="#" id="">Daftar Pengantar (Semua)</a>
						<ul>
						<li><a href="#" id="btnDaftarPengantarBankCSVMandiri">Bank Mandiri</a></li>
						<li><a href="#" id="btnDaftarPengantarBankCSVBNI">Bank BNI</a></li>
                        <li><a href="#" id="btnDaftarPengantarBankCSVBRI">Bank BRI</a></li>
						</ul>                                    
					</li>
				</ul>		
    </div>
    ...
    <div style="position: absolute; margin-top:6px; margin-left:180px; z-index:9999; font-size:12px;">
        Departemen : <input id="cc" class="easyui-combotree" name="reqDepartemen" data-options="url:'../json-simpeg/departemen_combo_json.php'" style="width:250px;" value="<?=$reqDepartemen?>">&nbsp;&nbsp;
 		...
 		<select name="reqJenisPegawai" id="reqJenisPegawai" style="display:none">
    ...
    <div id="rightclickarea"> <!--RIGHT CLICK EVENT -->
        ...
        <thead>
        <tr>
            <th rowspan="2" class="th_like" width="10px">ID</th>
            <th rowspan="2" class="th_like" width="10px">Status</th>
            <th rowspan="2" class="th_like" width="10px">No</th>
            <th rowspan="2" class="th_like" width="80px">NRP</th>
            <th rowspan="2" class="th_like" width="80px">Nama</th>            
            <th rowspan="2" class="th_like" width="80px">Jabatan</th>          
            <th rowspan="2" class="th_like" width="80px">Bayar</th>  
