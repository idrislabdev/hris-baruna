...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\UANG_MAKAN_KAPAL.rpt";
$my_pdf		= $path."penghasilan\\report\\UANG_MAKAN_KAPAL.pdf";
...
$creport->RecordSelectionFormula="{UANG_MAKAN_KAPAL_REPORT.PERIODE}='".$reqPeriode."'";
//else
