...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		      
			  "sAjaxSource": "../json-gaji/lain_kondisi_jenis_pegawai_json.php",			  
			...
			sDeleteURL: "../json-gaji/delete.php?reqMode=lain_kondisi_jenis_pegawai",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('lain_kondisi_jenis_pegawai_edit.php?reqMode=update&reqId='+anSelectedId+'&reqKelompokId=' + anSelectedKelompokId + '&reqKelasId=' + anSelectedKelas, 'Office Management - Aplikasi Penghasilan', '900', '700');	
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('lain_kondisi_jenis_pegawai_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '900', '700');" title="Tambah">Tambah</a>
