...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/tpp_pms_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('tpp_pms_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Penghasilan', '600', '300');	
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-gaji/delete.php?reqMode=tpp_pms&id='+anSelectedId, function (data) 
					{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Tunjangan Kehadiran</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('tpp_pms_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="150px">Kelompok Pegawai</th> 
            <th width="50px">Kelas</th> 
            <th width="100px">Tunjangan Prestasi / bulan</th>  
            <th width="100px">Minimal Jam Mengajar</th>  
            <th width="100px">Tarif Kelebihan Jam Mengajar</th>                                            
            <th width="100px">Maks Kelebihan Jam Mengajar</th>                                            
            <th width="100px">Maks Potongan Tidak Mengajar</th>                                            
        </tr>
    </thead>
    </table> 
    </div> 
