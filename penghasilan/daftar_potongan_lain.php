...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/daftar_potongan_lain_json.php?reqPeriode=<?=$arrPeriode[0]?>&reqLainKondisi=<?=$reqLainKondisi?>",
			...
			/* Click event handler */
			  ...
			  $('#btnCetakPotongan').on('click', function () {
			  	newWindow = window.open('potongan_lain_terakhir_cetak_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $("#reqPeriode").change(function() { 
			  		oTable.fnReloadAjax("../json-gaji/daftar_potongan_lain_json.php?reqLainKondisi="+$('#ccLainKondisi').combotree('getValue')+"&reqPeriode="+ $("#reqPeriode").val());
			  });
			  
			  $('#ccLainKondisi').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/daftar_potongan_lain_json.php?reqLainKondisi="+param.id+"&reqPeriode="+ $("#reqPeriode").val());
					}
			  });			  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Daftar Potongan Lain-lain</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div style="position: absolute; margin-top:6px; margin-left:180px; z-index:9999; font-size:12px;">
        Paket : <input id="ccLainKondisi" class="easyui-combotree" name="reqLainKondisi" data-options="url:'../json-gaji/lain_kondisi_combo_json.php'" style="width:200px;" value="<?=$reqLainKondisi?>">&nbsp;&nbsp;&nbsp;
 		Periode Pelunasan Potongan Gaji : <select name="reqPeriode" id="reqPeriode">
        		  <?
