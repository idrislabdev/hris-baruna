...
<head>
	...
	<script type="text/javascript">
		$(function(){
			  $('#btnCetakBukuBesar').click('click', function () {
				<?
				if($reqJenisReport == "DAFTAR_IURAN_JAMSOSTEK")
					$link = "daftar_jamsostek_rpt_new.php";
				elseif($reqJenisReport == "DAFTAR_TASPEN_PEGAWAI")
					$link = "daftar_taspen_rpt_new.php";
				elseif($reqJenisReport == "GAJI_PREMI")
					$link = "gaji_premi_rpt_new.php";
				elseif($reqJenisReport == "PREMI_KHUSUS")
					$link = "gaji_premi_khusus_cetak_new.php";
				elseif($reqJenisReport == "REKAPITULASI_BANTUAN_PENDIDIKAN")
					$link = "gaji_bantuan_pendidikan_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_BONUS_TAHUNAN")
					$link = "gaji_tunjangan_bonus_tahunan_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_INSENTIF_MANAGER")
					$link = "gaji_insentif_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_MOBILITAS_MANAGER")
					$link = "gaji_uang_transport_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_PREMI_KAPAL")
					$link = "gaji_premi_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_UANG_MAKAN")
					$link = "gaji_uang_makan_rekap_rpt_new.php";
				elseif($reqJenisReport == "REKAPITULASI_THR")
					$link = "gaji_tunjangan_hari_raya_rekap_rpt_new.php";
				/*elseif($reqJenisReport == "BESAR_DIREKSI")
					$link = "gaji_perbantuan_buku_besar_new.php";*/
				elseif($reqJenisReport == "BESAR")
					$link = "gaji_perbantuan_buku_besar_ttd_new.php";
					
				?>
			  	newWindow = window.open('<?=$link?>?reqJenisPegawaiId=<?=$reqJenisPegawaiId?>&reqPeriode=<?=$reqPeriode?>&reqNama1='+ $("#reqNama1").val()+'&reqJabatan1='+ $("#reqJabatan1").val()+'&reqNama2='+ $("#reqNama2").val()+'&reqJabatan2='+ $("#reqJabatan2").val(), 'Cetak');
				newWindow.focus();
