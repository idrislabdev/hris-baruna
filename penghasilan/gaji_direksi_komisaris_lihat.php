...
$tempMobilitas = $json_gaji->{"MOBILITAS"}{0};
$tempPerumahan = $json_gaji->{"PERUMAHAN"}{0};
$tempBBM = $json_gaji->{"BBM"}{0};
$tempTelepon = $json_gaji->{"TELEPON"}{0};

$json_sumbangan = json_decode($gaji_awal_bulan->getField("SUMBANGAN_JSON"));
$tempSumbanganPPh = $json_sumbangan->{"POTONGAN_PPH21"}{0};

$tempJumlahKotor = $tempPenghasilan + $tempSumbanganPPh + $tempMobilitas + $tempPerumahan + $tempBBM + $tempTelepon;
...
$tempJumlahKotor = $tempPenghasilan + $tempSumbanganPPh + $tempMobilitas + $tempPerumahan + $tempBBM + $tempTelepon + $tempPembulatan;
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Form Data Gaji Direksi Komisaris</span>
    </div>
    <table>
        ...
        <tr>
            <td>Mobilitas</td>
            <td align="center">
                <input name="reqMobilitas" title="Mobilitas harus diisi" style="width:150px;" readonly type="text" value="<?=currencyToPage($tempMobilitas)?>" />&nbsp;&nbsp;
            </td> 
            <td>Bukopin</td>
            <td>
        ...
        <tr>
            <td>Perumahan</td>
            <td align="center">
                <input name="reqPerumahan" title="Perumahan harus diisi" style="width:150px;" readonly type="text" value="<?=currencyToPage($tempPerumahan)?>" />&nbsp;&nbsp;
            </td> 
            <td>B R I</td>
            <td>
        ...
        <tr>
            <td>BBM</td>
            <td align="center">
                <input name="reqBBM" title="BBM harus diisi" style="width:150px;" readonly type="text" value="<?=currencyToPage($tempBBM)?>" />&nbsp;&nbsp;
            </td> 
            <td>B T N</td>
            <td>
        ...
        <tr>
            <td>Telepon</td>
            <td align="center">
                <input name="reqTelepon" title="Telepon harus diisi" style="width:150px;" readonly type="text" value="<?=currencyToPage($tempTelepon)?>" />&nbsp;&nbsp;
            </td> 
            <td>B P D</td>
            <td>
