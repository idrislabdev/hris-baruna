...
if($reqMode == "delete")
{
	$gaji_periode_tengah_bulan->setField("GAJI_PERIODE_TENGAH_BULAN_ID", $reqId);
	if($gaji_periode_tengah_bulan->delete())
	{
...
if($reqMode == "update")
{
	/*$gaji_kondisi->selectByParams(array("GAJI_PERIODE_TENGAH_BULAN_ID" => $reqId));
...
?>
<script type="text/javascript">
	window.location.replace('gaji_periode_tengah_bulan.php?reqHeight=' + screen.height);
</script>
<?
}
?>
...
<script language="JavaScript" src="../jslib/displayElement.js"></script>  
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/gaji_periode_tengah_bulan_add.php',
				onSubmit:function(){
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Gaji Periode Tengah Bulan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <!--<a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('gaji_periode_tengah_bulan_add.php?reqMode=insert&reqId=0', 'Sistem Informasi Persuratan', '600', '300')" title="Tambah">Tambah</a>-->
            </li>        
        </ul>
    </div>
    <div class="scroll">
      ...
      <table class="example" id="sf">
            ...
            <tbody> 
                <tr>
					<?
                    $gaji_periode_tengah_bulan->selectByParams(array());
					while($gaji_periode_tengah_bulan->nextRow())
					{
					?>
                        <tr id="node-<?=$gaji_periode_tengah_bulan->getField('GAJI_PERIODE_TENGAH_BULAN_ID')?>">
                            <td class="jarak-tree-table padding5"><span class='file'><?=getNamePeriode($gaji_periode_tengah_bulan->getField('PERIODE'))?></span></td>
                        </tr>
                    <?
					}
                    ?>
                ...
                <tr>
                    <td>
					<?
						$bulan = substr($gaji_periode_tengah_bulan->getField('PERIODE'),0,2);
						$tahun = substr($gaji_periode_tengah_bulan->getField('PERIODE'),2,4);
						if($bulan == 12)
						{
            ...
            <?php
				unset($gaji_periode_tengah_bulan);
            ?>  
           </tbody>            
          </table>
    </form>                   
