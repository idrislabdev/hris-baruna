...
$worksheet->set_column(4, 4, 19.00);
...
$worksheet->write		(4, 1, "DAFTAR PENGANTAR PEMBAYARAN PENGHASILAN", $text_format_merge);
...
$worksheet->write(7, 1, "BANK : BANK BRI", $text_format);
$worksheet->write(8, 1, "ALAMAT : SURABAYA - CABANG  : TANJUNG PERAK", $text_format);

$worksheet->write(10, 1, "NO", $text_format_line_bold);
$worksheet->write(10, 2, "PEGAWAI ID", $text_format_line_bold);
$worksheet->write(10, 3, "NAMA", $text_format_line_bold);
$worksheet->write(10, 4, "NO REKENING BANK", $text_format_line_bold);
$worksheet->write(10, 5, "JUMLAH DITERIMA", $text_format_line_bold);

$worksheet->write(11, 1, "1", $text_format_line);
$worksheet->write(11, 2, "59002574", $text_format_line);
$worksheet->write(11, 3, "Adi Suprianto", $text_format_line_left);
$worksheet->write(11, 4, "03801019788504", $text_format_num);
$worksheet->write(11, 5, "983233", $uang_line);
