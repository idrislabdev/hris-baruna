...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/pegawai_potongan_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			  ...
			  $('#cc').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/pegawai_potongan_json.php?reqDepartemen="+param.id+"&reqJenisPegawai="+ $("#reqJenisPegawai").val());
					}
			  });	
			  
			  $("#reqJenisPegawai").change(function() { 
				oTable.fnReloadAjax("../json-gaji/pegawai_potongan_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawai="+ $("#reqJenisPegawai").val());
			  });			  
