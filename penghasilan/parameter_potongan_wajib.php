...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/parameter_potongan_wajib_json.php",						  
			...
			sDeleteURL: "../json-gaji/delete.php?reqMode=parameter_potongan_wajib",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */
			 ...
			 $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('parameter_potongan_wajib_add.php?reqMode=update&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, 'Office Management - Administrasi Master Data', '600', '300');	
			  });
			   ...
			   $('#btnHapus').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-gaji/delete.php?reqMode=parameter_potongan_wajib&reqId='+anSelectedId+'&reqRowId='+anSelectedRowId, function (data) 
					{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Potongan Wajib</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('parameter_potongan_wajib_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            <th width="100px">Jenis Potongan</th>
    ...
    <!--RIGHT CLICK EVENT -->
    <div class="vmenu">
    	<div class="first_li"><span>Tambah</span></div>
