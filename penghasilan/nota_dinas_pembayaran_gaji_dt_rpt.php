...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\NOTA_DINAS_GAJI_AWAL_BULAN_DT.rpt";
$my_pdf		= $path."penghasilan\\report\\NOTA_DINAS_GAJI_AWAL_BULAN_DT.pdf";
...
$statement = " (({GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 2 OR 
			   {GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 6 OR 
			   {GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 7) AND {GAJI_AWAL_BULAN_REKAP_ND_DT.PERIODE} = '".$reqPeriode."') OR 
			   (({GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 3 OR 
			   {GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 1 OR
			   {GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 12 OR
			   {GAJI_AWAL_BULAN_REKAP_ND_DT.JENIS_PEGAWAI_ID} = 5) AND {GAJI_AWAL_BULAN_REKAP_ND_DT.PERIODE} = '".$reqPeriodeSebelum."')
			   ";
