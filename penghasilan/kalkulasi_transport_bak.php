...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/kalkulasi_transport_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('pegawai_potongan_add.php?reqMode=insert&reqId='+anSelectedId, 'Office Management - Aplikasi Penghasilan', '1000', '515');	
			  });
			  ...
			  $('#cc').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/kalkulasi_transport_json.php?reqDepartemen="+param.id+"&reqJenisPegawai="+ $("#reqJenisPegawai").val());
					}
			  });	
			  
			  $("#reqJenisPegawai").change(function() { 
				oTable.fnReloadAjax("../json-gaji/kalkulasi_transport_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawai="+ $("#reqJenisPegawai").val());
			  });			  
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Pegawai Potongan</span>
            </div>            
            </td>
        </tr>
    </table>
