...
if($reqMode == "delete")
{
	$gaji_periode->setField("GAJI_PERIODE_ID", $reqId);
	if($gaji_periode->delete())
	{
...
if($reqMode == "update")
{
	/*$gaji_kondisi->selectByParams(array("GAJI_PERIODE_ID" => $reqId));
...
?>
<script type="text/javascript">
	window.location.replace('gaji_periode.php?reqHeight=' + screen.height);
</script>
<?
}
?>
...
<script language="JavaScript" src="../jslib/displayElement.js"></script>  
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/gaji_periode_add.php',
				onSubmit:function(){
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Gaji Periode</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div class="scroll">
      ...
      <table class="example" id="sf">
            ...
            <tbody> 
                <tr>
					<?
                    $gaji_periode->selectByParams(array());
					while($gaji_periode->nextRow())
					{
					?>
                        <tr id="node-<?=$gaji_periode->getField('GAJI_PERIODE_ID')?>">
                            <td class="jarak-tree-table padding5"><span class='file'><?=getNamePeriode($gaji_periode->getField('PERIODE'))?></span></td>
                        </tr>
                    <?
					}
                    ?>
                ...
                <tr>
                    <td>
					<?
						$bulan = substr($gaji_periode->getField('PERIODE'),0,2);
						$tahun = substr($gaji_periode->getField('PERIODE'),2,4);
						if($bulan == 12)
						{
