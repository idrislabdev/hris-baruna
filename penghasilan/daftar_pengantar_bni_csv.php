...
$statement .= " AND BANK = 'BANK BNI 1946'";
...
$csv->addRow(array($gaji_awal_bulan2->getField('TANGGAL_BUAT'),$gaji_awal_bulan2->getField('TOTAL') + 2,',,,,,,,,,,,,,,,,,'));
$csv->addRow(array('P',substr($reqPeriode,-4) . substr($reqPeriode,0,2) . '01','311220117',$gaji_awal_bulan2->getField('TOTAL'),$gaji_awal_bulan2->getField('SUM_GAJI'),',,,,,,,,,,,,,,'));
}
...
{	
	...
	*/
	$csv->addRow(array($gaji_awal_bulan->getField('REKENING_NO'), $gaji_awal_bulan->replaceSpecialCharacter($gaji_awal_bulan->getField('NAMA')), $jumlah_dibayar,',,,,,,,,,,,,,N,,,N'));
