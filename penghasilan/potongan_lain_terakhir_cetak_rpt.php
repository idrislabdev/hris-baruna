...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\DAFTAR_SELURUH_POTONGAN_TERAKHIR.rpt";
$my_pdf		= $path."penghasilan\\report\\DAFTAR_SELURUH_POTONGAN_TERAKHIR.pdf";
...
$creport->RecordSelectionFormula="{POTONGAN_LAIN_TERAKHIR_REPORT.PERIODE}='".$reqPeriode."' OR {POTONGAN_LAIN_TERAKHIR_REPORT.PERIODE}='".$reqPeriodeSebelum."'";
//else
