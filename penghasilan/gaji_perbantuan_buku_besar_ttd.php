...
if($reqJenisPegawaiId == "6")
{
	...
	$my_report	= $path."penghasilan\\report\\BESAR_DIREKSI_TTD.rpt";
	$my_pdf		= $path."penghasilan\\report\\BESAR_DIREKSI_TTD.pdf";
}
else
{
	...
	$my_report	= $path."penghasilan\\report\\BESAR_TTD.rpt";
	$my_pdf		= $path."penghasilan\\report\\BESAR_TTD.pdf";
}
