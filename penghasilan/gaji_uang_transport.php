...
$lock_proses = $proses_gaji_lock->getProsesGajiLock(array("PERIODE" => $reqPeriode, "JENIS_PROSES" => "GAJI_UANG_TRANSPORT"));
$lock_cetak = $proses_presensi_lock->getProsesPresensiLock(array("PERIODE" => $reqPeriode));


$jenis_pegawai->selectByParams();

$akses_app_penghasilan->selectByParamsAksesMenu(array("LINK_FILE" => "gaji_uang_transport.php", "AKSES_APP_PENGHASILAN_ID" => $userLogin->userAksesPenghasilan));
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_uang_transport_json.php?reqPeriode=<?=$reqPeriode?>",
			  ...
			  $("#reqJenisPegawai").change(function() { 
			  		oTable.fnReloadAjax("../json-gaji/gaji_uang_transport_json.php?reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
			  });
			  ...
			  $('#btnEkspor').on('click', function () {
				  ...
				  newWindow = window.open('gaji_uang_transport_excel.php?reqPeriode='+ $("#reqPeriode").val() + '&reqJenisPegawai='+ $("#reqJenisPegawai").val(), 'Cetak');
				  newWindow.focus();
				  
			  });

			$('#btnEksportCSVMandiri').on('click', function () {
				  /*if(anSelectedData == "")
					  return false;	*/			
				  
				  newWindow = window.open('gaji_uang_transport_mandiri_csv.php?reqPeriode='+ $("#reqPeriode").val() + '&reqJenisPegawai='+ $("#reqJenisPegawai").val(), 'Cetak');
				  newWindow.focus();
				  
			  });	
			  
			  $('#btnEksportCSVBNI').on('click', function () {
				  /*if(anSelectedData == "")
					  return false;	*/			
				  
				  newWindow = window.open('gaji_uang_transport_bni_csv.php?reqPeriode='+ $("#reqPeriode").val() + '&reqJenisPegawai='+ $("#reqJenisPegawai").val(), 'Cetak');
				  newWindow.focus();
				  
			  });	
			  
			  $('#btnEksportCSVBRI').on('click', function () {
				  /*if(anSelectedData == "")
					  return false;	*/			
				  
				  newWindow = window.open('gaji_uang_transport_bri_csv.php?reqPeriode='+ $("#reqPeriode").val() + '&reqJenisPegawai='+ $("#reqJenisPegawai").val(), 'Cetak');
				  newWindow.focus();
			  ...
			  $('#btnEksporRekap').on('click', function () {
				  ...
				  newWindow = window.open('gaji_uang_transport_rekap_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				  newWindow.focus();
			  ...
			  $('#btnCetakPerbantuan').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_rpt.php?reqJenisPegawaiId=2&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakOrganik').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_rpt.php?reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakCapeg').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_rpt.php?reqJenisPegawaiId=5&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakPKWT').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_rpt.php?reqJenisPegawaiId=3&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnRekapitulasi').on('click', function () {
			  	//newWindow = window.open('gaji_uang_transport_rekap_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=REKAPITULASI_MOBILITAS_MANAGER&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');
			  });			  

			  $('#btnCetakAwakKapal').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_awak_kapal_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnCetakDaftarPengantar').on('click', function () {
			  	newWindow = window.open('gaji_uang_transport_pengantar_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  
			  ...
			  $('#btnProses').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{ 
			  		oTable.fnReloadAjax("../json-gaji/gaji_uang_transport_json.php?reqMode=proses&reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
				}
				else
				{
			  ...
			  $('#btnKirimJurnal').on('click', function () {
				  ...
				  {
					$.getJSON("../json-gaji/proses_gaji_set_lock.php?reqJenisProses=GAJI_UANG_TRANSPORT&reqPeriode="+ $("#reqPeriode").val(),
					function(data){
					});	
					...
					*/
					window.parent.OpenDHTML('proses_gaji_set_lock.php?reqJenisProses=GAJI_UANG_TRANSPORT&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');
			  });	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Uang Transport</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
			...
			<li><a href="#" title="Ekspor" id="btnEkspor2"  data-flexmenu="flexmenu3">&nbsp;Export CSV</a></li>
        	<?
            if($akses == "A")
			{
			?>               		
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
          ...
          <li><a href="#" id="btnCetakAwakKapal">Awak Kapal</a></li>
          <li><a href="#" id="btnCetakDaftarPengantar">Daftar Pengantar</a></li>     
		  <li><a href="#" id="btnRekapitulasi">Rekapitulasi</a></li>  		  
        </ul>
        <ul id="flexmenu2" class="flexdropdownmenu">
          <li><a href="#" id="btnEkspor">Penerimaan</a></li>
          <li><a href="#" id="btnEksporRekap">Rekapitulasi</a></li>  
        </ul>
		<ul id="flexmenu3" class="flexdropdownmenu">
          <li><a href="#" id="btnEksportCSVMandiri">Bank Mandiri</a></li>
          <li><a href="#" id="btnEksportCSVBNI">Bank BNI</a></li>  
          <li><a href="#" id="btnEksportCSVBRI">Bank BRI</a></li>  
        </ul> 		
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="85px">Hari Kerja</th>
            <th width="85px">Masuk Kerja</th>
