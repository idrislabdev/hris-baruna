...
$akses_app_penghasilan->selectByParamsAksesMenu(array("LINK_FILE" => "gaji_direksi_komisaris.php", "AKSES_APP_PENGHASILAN_ID" => $userLogin->userAksesPenghasilan));
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_direksi_komisaris_json.php?reqPeriode=<?=$reqPeriode?>&reqDepartemen=<?=$reqDepartemen?>",						  
			  ...
			  $("#reqPeriode").change(function() { 
				 if($("#reqPeriode").val() == '<?=$arrPeriode[0]?>' && '<?=$lock_proses?>' == '0')
				 	 ...
				 	 $('.toggle').css({"display":"none"}); 
			  		oTable.fnReloadAjax("../json-gaji/gaji_direksi_komisaris_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqPeriode="+ $("#reqPeriode").val());
				 	 
			  });
			  
			  $('#cc').combotree({
					onSelect: function(param){
						 oTable.fnReloadAjax("../json-gaji/gaji_direksi_komisaris_json.php?reqDepartemen="+param.id+"&reqPeriode="+ $("#reqPeriode").val());
					}
			  });			  
			  ...
			  $('#btnLihat').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('gaji_direksi_komisaris_lihat.php?reqId='+anSelectedId+'&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '900', '600');	
			  });

			  $('#btnCetakBukuBesarDireksi').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{
					window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=BESAR&reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');					
				}
				else
				{
			  	...
			  	//newWindow = window.open('gaji_perbantuan_buku_besar.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
			  });

			  $('#btnCetakBukuBesarKomisaris').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{
					window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=BESAR&reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');				  
				}
				else
				{
					if(confirm('Daftar potongan belum di approve, data penghasilan mungkin tidak valid. Lanjutkan Cetak?'))
			  	...
			  	//newWindow = window.open('gaji_perbantuan_buku_besar.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
			  });


			  $('#btnEkspor').on('click', function () {
			  	newWindow = window.open('gaji_perbantuan_cetak.php?reqJenisPegawaiId=6,7&reqPeriode='+ $("#reqPeriode").val() +'&reqDepartemen='+$('#cc').combotree('getValue'), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnCetakPotonganLainDireksi').on('click', function () {
			  	newWindow = window.open('potongan_lain_cetak_rpt.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnCetakPotonganLainKomisaris').on('click', function () {
			  	newWindow = window.open('potongan_lain_cetak_rpt.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnDaftarPengantarDireksi').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_cetak_rpt.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnDaftarPengantarKomisaris').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_cetak_rpt.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  ...
			  $('#btnCetakSemua').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{
					newWindow = window.open('gaji_perbantuan_slip.php?reqJenisPegawaiId=6,7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				}
				else
				{
			  ...
			  $('#btnCetakPerOrang').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{
					newWindow = window.open('gaji_perbantuan_slip.php?reqJenisPegawaiId=6,7&reqId='+anSelectedId+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
					newWindow.focus();
				}
				else
				{
			  ...
			  $('#btnCetakPotongan').on('click', function () {
			  	newWindow = window.open('potongan_cetak_rpt.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  
			  
			  $('#btnPotonganExcelDireksi').on('click', function () {
			  	newWindow = window.open('potongan_excel.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnPotonganExcelKomisaris').on('click', function () {
			  	newWindow = window.open('potongan_excel.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnPotonganLainExcelDireksi').on('click', function () {
			  	newWindow = window.open('potongan_lain_excel.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnPotonganLainExcelKomisaris').on('click', function () {
			  	newWindow = window.open('potongan_lain_excel.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnDaftarPengantarBankExcelDireksi').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_bank_excel.php?reqJenisPegawaiId=6&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnDaftarPengantarBankExcelKomisaris').on('click', function () {
			  	newWindow = window.open('daftar_pengantar_bank_excel.php?reqJenisPegawaiId=7&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				newWindow.focus();
			  });	

			  $('#btnJamsostekExcelDireksi').on('click', function () {
			  	newWindow = window.open('jamsostek_excel.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnJamsostekExcelKomisaris').on('click', function () {
			  	newWindow = window.open('jamsostek_excel.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });

			  $('#btnJamsostekDireksi').on('click', function () {
			  	//newWindow = window.open('daftar_jamsostek_rpt.php?reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=DAFTAR_IURAN_JAMSOSTEK&reqJenisPegawaiId=6&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');				
			  });

			  $('#btnJamsostekKomisaris').on('click', function () {
			  	//newWindow = window.open('daftar_jamsostek_rpt.php?reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=DAFTAR_IURAN_JAMSOSTEK&reqJenisPegawaiId=7&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');								
			  });

			  $('#btnKirimJurnal').on('click', function () {
			  	  window.parent.OpenDHTML('proses_gaji_set_lock.php?reqJenisProses=GAJI_DIREKSI_KOMISARIS&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');							    
					/*
				  if(confirm('Kirim jurnal dan kunci proses bulan terpilih?'))
				  {
					$.getJSON("../json-gaji/proses_gaji_set_lock.php?reqJenisProses=GAJI_DIREKSI_KOMISARIS&reqPeriode="+ $("#reqPeriode").val(),
					function(data){
					});	
				  }
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Direksi, Komisaris</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
			...
			<li><a href="#" id="btnCetakBukuBesar">Buku Besar</a>
                <ul>
                <li><a href="#" id="btnCetakBukuBesarDireksi">Direksi</a></li>
                <li><a href="#" id="btnCetakBukuBesarKomisaris">Komisaris</a></li>
                </ul>                        
            </li>
            <li><a href="#" id="btnCetakPotongan">Potongan</a>
            <li><a href="#" id="btnCetakPotonganLain">Potongan Lain</a>
                <ul>
                <li><a href="#" id="btnCetakPotonganLainDireksi">Direksi</a></li>
                <li><a href="#" id="btnCetakPotonganLainKomisaris">Komisaris</a></li>
                </ul>                        
            </li>
            <li><a href="#" id="btnDaftarPengantar">Daftar Pengantar</a>
                <ul>
                <li><a href="#" id="btnDaftarPengantarDireksi">Direksi</a></li>
                <li><a href="#" id="btnDaftarPengantarKomisaris">Komisaris</a></li>
                </ul>            
            </li>
            <li><a href="#" id="btnJamsostek">BPJS Ketenagakerjaan</a>
                <ul>
                <li><a href="#" id="btnJamsostekDireksi">Direksi</a></li>
                <li><a href="#" id="btnJamsostekKomisaris">Komisaris</a></li>
                </ul>                                                
            </li>              
        </ul>   
        <ul id="flexmenu2" class="flexdropdownmenu">
            ...
            <li><a href="#" id="btnDaftarPengantarBankExcel">Daftar Pengantar</a>
                <ul>
                <li><a href="#" id="btnDaftarPengantarBankExcelDireksi">Direksi</a></li>
                <li><a href="#" id="btnDaftarPengantarBankExcelKomisaris">Komisaris</a></li>
                </ul>               
            </li>            
            <li><a href="#">Potongan</a>
                <ul>
                <li><a href="#" id="btnPotonganExcelDireksi">Direksi</a></li>
                <li><a href="#" id="btnPotonganExcelKomisaris">Komisaris</a></li>
                </ul>                                                
            </li>
			<li><a href="#">Potongan Lain</a>
                <ul>
                <li><a href="#" id="btnPotonganLainExcelDireksi">Direksi</a></li>
                <li><a href="#" id="btnPotonganLainExcelKomisaris">Komisaris</a></li>
                </ul>                                                
            </li> 			
            <li><a href="#" id="btnJamsostekExcel">BPJS Ketenagakerjaan</a>
                <ul>
                <li><a href="#" id="btnJamsostekExcelDireksi">Direksi</a></li>
                <li><a href="#" id="btnJamsostekExcelKomisaris">Komisaris</a></li>
                </ul>                                                
            </li>            
        </ul> 
    </div>
