...
//------  Variables ------
$my_report 	= $path."penghasilan\\report\\REKAPITULASI_INSENTIF_MANAGER_NEW.rpt";
$my_pdf 	= $path."penghasilan\\report\\REKAPITULASI_INSENTIF_MANAGER_NEW.pdf";
...
$creport->RecordSelectionFormula="{REKAP_INSENTIF_REPORT.PERIODE}='".$reqPeriode."'";
//else
