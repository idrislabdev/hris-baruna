...
<script type="text/javascript">
   ...
   $.fn.combotree.defaults = {
			...
			if(newValue == '<?=$reqDepartemen?>')
			{
				...
				document.location.href = 'gaji_organik.php?reqDepartemen=' + newValue + '&reqPeriode='+ $("#reqPeriode").val(); 
			}
	};
</script>
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "aoColumns": [ 
							 ...
							 null,
							 <?
							 for($i=0;$i<count($json_item_gaji->{'NAMA'}) -1;$i++)
						     {	
							 ?>							 								 
							 null,
							 <?
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_tengah_organik_json.php?reqPeriode=<?=$reqPeriode?>&reqDepartemen=<?=$reqDepartemen?>",						  
			  "sScrollY": ($(window).height() - <?=$tinggi?>),
			  "sScrollX": "100%",								  
			  "sScrollXInner": "100%",
			  "sPaginationType": "full_numbers"
			  }).makeEditable({
			pReloadTarget: "../json-gaji/gaji_organik_json.php?reqMode=proses&reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
				 if($("#reqPeriode").val() == '<?=$arrPeriode[0]?>')
			  		...
			  		oTable.fnReloadAjax("../json-gaji/gaji_organik_json.php?reqDepartemen=<?=$reqDepartemen?>&reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Organik</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="rightclickarea"> <!--RIGHT CLICK EVENT -->
        ...
        <tr>
            ...
            <th colspan="<?=count($json_item_gaji->{'NAMA'})?>" style="text-align:center">Gaji Tengah Bulan</th>
        </tr>
        <tr>
        <?
