...
//------  Variables ------
$my_report 	= $path."penghasilan\\report\\DAFTAR_PENGANTAR_INSENTIF.rpt";
$my_pdf 	= $path."penghasilan\\report\\DAFTAR_PENGANTAR_INSENTIF.pdf";
...
$creport->RecordSelectionFormula="{INSENTIF_REPORT.PERIODE}='".$reqPeriode."'".$statement;
//else
