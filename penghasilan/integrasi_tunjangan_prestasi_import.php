...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/integrasi_tunjangan_prestasi_import.php',
				onSubmit:function(){
        ...
        {
            window.open("import_tunjangan_prestasi_template_excel.php?reqDepartemen=<?=$reqDepartemen?>&reqJenisPegawai=<?=$reqJenisPegawai?>&reqPeriode=<?=$reqPeriode?>", '_blank');
        }
	</script>
