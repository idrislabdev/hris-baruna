...
if($reqMode == "update")
{
	$tunjangan_perbantuan_b->selectByParams(array("TUNJANGAN_PERBANTUAN_B_ID" => $reqId));
	$tunjangan_perbantuan_b->firstRow();
	$tempKelas = $tunjangan_perbantuan_b->getField("KELAS");
	$tempPeriode = $tunjangan_perbantuan_b->getField("PERIODE");	
	$tempJumlah = $tunjangan_perbantuan_b->getField("JUMLAH");
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-gaji/tunjangan_perbantuan_b_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Tambah Tunjangan Perbantuan B</span>
    </div>
