...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/integrasi_tunjangan_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 // else
			  		...
			  		oTable.fnReloadAjax("../json-gaji/integrasi_tunjangan_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawaiId="+$("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
				 	 
			  });
			  
			  $('#cc').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/integrasi_tunjangan_json.php?reqDepartemen="+param.id+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
					}
			  });	
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-gaji/delete.php?reqMode=integrasi_tunjangan&id='+anSelectedId, function (data) 
					{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Integrasi Tunjangan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnImport" onClick="window.parent.OpenDHTML('integrasi_tunjangan_import.php?reqMode=import', 'Office Management - Aplikasi Penghasilan', '600', '300');" title="Tambah">Import</a>
    ...
    <thead>
        <tr>
            ...
            <th width="250px">Jenis Tunjangan</th> 
