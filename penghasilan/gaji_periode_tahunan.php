...
if($reqMode == "delete")
{
	$gaji_periode_tahun->setField("GAJI_PERIODE_TAHUN_ID", $reqId);
	if($gaji_periode_tahun->delete())
	{
...
?>
<script type="text/javascript">
	window.location.replace('gaji_periode_tahunan.php?reqHeight=' + screen.height);
</script>
<?
}
?>
...
<script language="JavaScript" src="../jslib/displayElement.js"></script>  
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/gaji_periode_tahunan_add.php',
				onSubmit:function(){
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Gaji Periode Tahunan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <!--<a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('gaji_periode_tahun_add.php?reqMode=insert&reqId=0', 'Sistem Informasi Persuratan', '600', '300')" title="Tambah">Tambah</a>-->
            </li>        
        </ul>
    </div>
    <div class="scroll">
      ...
      <table class="example" id="sf">
            ...
            <tbody> 
                <tr>
					<?
                    $gaji_periode_tahun->selectByParams(array());
					while($gaji_periode_tahun->nextRow())
					{
					?>
                        <tr id="node-<?=$gaji_periode_tahun->getField('GAJI_PERIODE_TAHUN_ID')?>">
                            <td class="jarak-tree-table padding5"><span class='file'><?=$gaji_periode_tahun->getField('PERIODE')?></span></td>
                        </tr>
                    <?
					}
                    ?>
                ...
                <tr>
                    <td>
					<?
						$tempPeriode = $gaji_periode_tahun->getField('PERIODE') + 1;
					...
					?>
	                    <input name="reqPeriode" id="reqPeriode" class="easyui-validatebox" data-options="validType:['sameLength[\'4\']']" maxlength="4" style="width:80px" type="text" required="true" value="<?=$tempPeriode?>" />&nbsp;&nbsp;
                        <input type="hidden" name="reqId" value="<?=$reqId?>">
                        <input type="submit" value="Submit">                        
                    </td>
                </tr>
            <?php
				unset($gaji_periode_tahun);
            ?>  
           </tbody>            
          </table>
    </form>                   
