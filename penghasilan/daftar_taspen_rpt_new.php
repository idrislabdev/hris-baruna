...
$my_report 	= $path."penghasilan\\report\\DAFTAR_TASPEN_PEGAWAI_NEW.rpt";
$my_pdf 	= $path."penghasilan\\report\\DAFTAR_TASPEN_PEGAWAI_NEW.pdf";
...
$creport->RecordSelectionFormula="{IURAN_TASPEN_REPORT.PERIODE}='".$reqPeriode."'";
//else
