...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/integrasi_tunjangan_prestasi_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 // else
			  		...
			  		oTable.fnReloadAjax("../json-gaji/integrasi_tunjangan_prestasi_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
				 	 
			  });

			  $('#cc').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/integrasi_tunjangan_prestasi_json.php?reqDepartemen="+param.id+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
					}
			  });	
			  
			  $("#reqJenisPegawai").change(function() { 
				oTable.fnReloadAjax("../json-gaji/integrasi_tunjangan_prestasi_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawaiId="+$("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
			  });
...
<div id="wadah">
    ...
    <thead>
        <tr>
            ...
            <th width="50px">Jml.&nbsp;Mengajar</th>         
            <th width="50px">Jam&nbsp;Mengajar</th> 
            <th width="50px">Jml.&nbsp;Kelebihan</th>
            <th width="50px">Wajib&nbsp;Mengajar</th>     
            <th width="50px">Jml.&nbsp;Mangkir</th>        
            <th width="50px">Tarif&nbsp;Mengajar</th> 
            <th width="50px">Tarif&nbsp;Lebih</th> 
            <th width="50px">Tj&nbsp;Prestasi</th>          
        </tr>
    </thead>
    </table> 
    </div> 
    <!--RIGHT CLICK EVENT
     ...
     <th>Id</th>
            ...
            <th width="50px">Tarif Mengajar</th> 
            <th width="50px">Tarif Lebih</th> 
            <th width="50px">Jumlah Potongan</th>          
            <th width="50px">Pembagi Potongan</th>          
