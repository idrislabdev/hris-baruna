...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\REKAPITULASI_UANG_MAKAN_NEW.rpt";
$my_pdf		= $path."penghasilan\\report\\REKAPITULASI_UANG_MAKAN_NEW.pdf";
...
$creport->RecordSelectionFormula="{UANG_MAKAN_REKAP_REPORT.PERIODE}='".$reqPeriode."'".$statement;
//else
