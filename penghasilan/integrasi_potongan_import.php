...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/integrasi_potongan_import.php',
				onSubmit:function(){
        ...
        {
            window.open("import_potongan_template_excel.php?reqDepartemen=<?=$reqDepartemen?>&reqJenisPegawai=<?=$reqJenisPegawai?>&reqPeriode=<?=$reqPeriode?>", '_blank');
        }
	</script>
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Import Data Integrasi Potongan</span>
    </div>
    ...
    <table>
        ...
        <div>
            ...
            <input type="hidden" id="reqPeriode" name="reqPeriode" value="<?=$reqPeriode?>">
