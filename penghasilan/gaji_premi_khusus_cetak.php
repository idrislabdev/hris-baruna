...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\PREMI_KHUSUS.rpt";
$my_pdf		= $path."penghasilan\\report\\PREMI_KHUSUS.pdf";
...
$creport->RecordSelectionFormula="{PREMI_KHUSUS.PERIODE}='".$reqPeriode."'";
//else
