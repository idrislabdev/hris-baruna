...
for ($i=0; $i < 2; $i++)
{
	...
	if ($i==0)
	{
		...
		$worksheet->write(0, 1, "DEPARTEMEN _ID", $text_format_line_bold);
		$worksheet->write(0, 2, "DEPARTEMEN KELAS ID", $text_format_line_bold);
	...
	elseif($i==1)
	{
			...
			$worksheet->write(2, 2, "DEPARTEMEN SEKOLAH ID", $text_format_line_bold_top);
