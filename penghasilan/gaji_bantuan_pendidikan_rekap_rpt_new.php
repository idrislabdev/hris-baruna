...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\REKAPITULASI_BANTUAN_PENDIDIKAN_NEW.rpt";
$my_pdf 	= $path."penghasilan\\report\\REKAPITULASI_BANTUAN_PENDIDIKAN_NEW.pdf";
...
$creport->RecordSelectionFormula="{REKAP_BANTUAN_DIDIK_REPORT.PERIODE}='".$reqPeriode."'";
//else
