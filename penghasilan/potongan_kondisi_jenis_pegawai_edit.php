  ...
  while($child->nextRow())
  {
    ...
    echo "
        <tr id='node-".$child->getField('POTONGAN_KONDISI_ID')."' class='child-of-node-".$child->getField('POTONGAN_KONDISI_PARENT_ID')."'>
          ...
          <td>
          <div ".$style_rumus.">
            <select id=\"tt".$i.$j."\" class=\"easyui-combotree\" data-options=\"onCheck:onCheck".$i.$j.",url:'../json-gaji/potongan_kondisi_jenis_pegawai_combo_edit_json.php?reqId=".$child->getField('POTONGAN_KONDISI_ID')."&reqJenisPegawaiId=".$reqJenisPegawaiId."&reqKelasId=".$reqKelasId."&reqKelompokId=".$reqKelompokId."',onlyLeafCheck:true,checkbox:true,cascadeCheck:true\" multiple style=\"width:200px;\"></td>
          <script>
          ...
          <td>
            <div ".$style_rumus.">          
            <input type=\"text\" style=\"width:30px;\" name=\"reqProsentase[]\" value=\"".$child->getField('PROSENTASE')."\"></td>
          </div>
          <td>
            <div ".$style_rumus.">          
...
<div id="wadah">
    ...
    <table>
        <tr>
            ...
            <td>Kelompok</td>
            <td>
                <input id="reqKelompok" class="easyui-combotree" data-options="url:'../json-simpeg/kelompok_pegawai_combo_json.php'" name="reqKelompok" style="width:300px;" value="<?=$reqKelompokId?>">
            </td>
            <td>Kategori Pendidikan</td>
            <td>
               <input id="reqKelas" class="easyui-combotree" data-options="url:'../json-simpeg/kategori_sekolah_combo_json.php'" name="reqKelas" style="width:300px;" value="<?=$reqKelasId?>"> 
            </td>
            <!-- <td>Kelas</td>
            <td>
    ...
    $checkbox_index = 0;
      ...
      <script>
        ...
        <td align="center" style="display:none">
                ...
                <input type="hidden" id="idJumlah<?=$i?>" name="reqJumlah[]" value="<?=$potongan_kondisi->getField('ISI_JUMLAH')?>">       
