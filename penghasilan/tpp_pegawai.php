...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/tpp_pegawai_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('tpp_pegawai_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Penghasilan', '600', '300');	
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-gaji/delete.php?reqMode=tpp_pegawai&id='+anSelectedId, function (data) 
					{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data TPP Pegawai</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('tpp_pegawai_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '600', '300');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            ...
            <th width="50px" rowspan="2">Dibayarkan secara lumpsum/ bulan</th> 
            <th width="50px" rowspan="2">Dibayarkan sesuai jam TM/ bulan</th>                                            
            <th width="50px" rowspan="2">Minimal Jam Mengajar</th>                                            
            <th width="50px" colspan="2" style="text-align: center;">Tarif Jam</th>                                            
            <th width="50px" colspan="2" style="text-align: center;">Tarif Tambahan</th>                                            
            <th width="50px" colspan="2" style="text-align: center;">Tunjangan Dosen</th>                                            
            <th width="50px" colspan="2" style="text-align: center;">Tarif per Jam</th>                                            
        </tr>
        <tr>
        	<th>id</th>
        	<th>Wajib</th>
