...
$lock_proses = $proses_gaji_lock->getProsesGajiLock(array("PERIODE" => $reqPeriode, "JENIS_PROSES" => "GAJI_INSENTIF"));
$lock_cetak = $proses_presensi_lock->getProsesPresensiLock(array("JENIS_PROSES" => "KOREKSI_ABSEN_DARAT", "PERIODE" => $reqPeriode));
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_insentif_json.php?reqPeriode=<?=$reqPeriode?>",
			...
			/* Click event handler */
			  ...
			  $("#reqJenisPegawai").change(function() { 
			  		oTable.fnReloadAjax("../json-gaji/gaji_insentif_json.php?reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
			  });
			  
			  $('#btnCetakPerbantuan').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rpt.php?reqJenisPegawaiId=2&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakOrganik').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rpt.php?reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakCapeg').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rpt.php?reqJenisPegawaiId=5&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnCetakPKWT').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rpt.php?reqJenisPegawaiId=3&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	

			  $('#btnCetakKSO').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rpt.php?reqJenisPegawaiId=4&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	

			  $('#btnCetakRekapitulasi').on('click', function () {
			  	//newWindow = window.open('gaji_insentif_rekap_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				//newWindow.focus();
				window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=REKAPITULASI_INSENTIF_MANAGER&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');
			  });	
			  $('#btnKirimJurnal').on('click', function () {
				  /*
			  	  if(confirm('Kirim jurnal dan kunci proses bulan terpilih?'))
				  {
						$.getJSON("../json-gaji/proses_gaji_set_lock.php?reqJenisProses=GAJI_INSENTIF&reqPeriode="+ $("#reqPeriode").val(),
					function(data){
					});	
					...
					*/
				window.parent.OpenDHTML('proses_gaji_set_lock.php?reqJenisProses=GAJI_INSENTIF&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');
					
			  });							  

			  $('#btnEksporPerbantuan').on('click', function () {
			  	newWindow = window.open('gaji_insentif_excel.php?reqJenisPegawaiId=2&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	

			  $('#btnEksporOrganik').on('click', function () {
			  	newWindow = window.open('gaji_insentif_excel.php?reqJenisPegawaiId=1&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnEksporCapeg').on('click', function () {
			  	newWindow = window.open('gaji_insentif_excel.php?reqJenisPegawaiId=5&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });			  

			  $('#btnEksporPKWT').on('click', function () {
			  	newWindow = window.open('gaji_insentif_excel.php?reqJenisPegawaiId=3&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });		

			  $('#btnEksporKSO').on('click', function () {
			  	newWindow = window.open('gaji_insentif_excel.php?reqJenisPegawaiId=4&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });		
			  
			  $('#btnEksporSemua').on('click', function () {
			  	newWindow = window.open('gaji_insentif_semua_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });	
			  
			  $('#btnEksporRekapitulasi').on('click', function () {
			  	newWindow = window.open('gaji_insentif_rekap_excel.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnEksporMandiriCSV').on('click', function () {
			  	newWindow = window.open('gaji_insentif_mandiri_csv.php?reqPeriode='+ $("#reqPeriode").val()  + "&reqJenisPegawai="+ $("#reqJenisPegawai").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnEksporBNICSV').on('click', function () {
			  	newWindow = window.open('gaji_insentif_bni_csv.php?reqPeriode='+ $("#reqPeriode").val()  + "&reqJenisPegawai="+ $("#reqJenisPegawai").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnEksporBRICSV').on('click', function () {
			  	newWindow = window.open('gaji_insentif_bri_csv.php?reqPeriode='+ $("#reqPeriode").val()  + "&reqJenisPegawai="+ $("#reqJenisPegawai").val(), 'Cetak');
				newWindow.focus();
			  });
			  
			  $('#btnCetakDaftarPengantar').on('click', function () {
			  	newWindow = window.open('gaji_insentif_pengantar_rpt.php?reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				newWindow.focus();
			  });				  	  
			  ...
			  $('#btnProses').on('click', function () {
				if(<?=$lock_cetak?> == 1)
				{ 
			  		oTable.fnReloadAjax("../json-gaji/gaji_insentif_json.php?reqMode=proses&reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
				}
				else
				{
					if(confirm('Daftar presensi belum di approve, data penghasilan mungkin tidak valid. Lanjutkan proses?'))
					{ 
			  		oTable.fnReloadAjax("../json-gaji/gaji_insentif_json.php?reqMode=proses&reqPeriode=" + $("#reqPeriode").val() + "&reqJenisPegawai="+ $("#reqJenisPegawai").val());
					}
				}					  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Insentif</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
			...
			<li><a href="#" title="Ekspor" id="btnEkspor" data-flexmenu="flexmenu3">&nbsp;Export CSV</a></li>  
        ...
        <ul id="flexmenu1" class="flexdropdownmenu">
          ...
          <li><a href="#" id="btnCetakKSO">KSO</a></li> 
          <li><a href="#" id="btnCetakDaftarPengantar">Daftar Pengantar</a></li>        
          <li><a href="#" id="btnCetakRekapitulasi">Rekapitulasi</a></li>        
        </ul> 
        <ul id="flexmenu2" class="flexdropdownmenu">
          <li><a href="#" id="btnEksporPerbantuan">Perbantuan</a></li>
          <li><a href="#" id="btnEksporOrganik">Organik</a></li>
          <li><a href="#" id="btnEksporCapeg">Capeg</a></li>
          <li><a href="#" id="btnEksporPKWT">PKWT</a></li>
          <li><a href="#" id="btnEksporKSO">KSO</a></li>
          <li><a href="#" id="btnEksporSemua">Semua Jenis Pegawai</a></li>
          <li><a href="#" id="btnEksporRekapitulasi">Rekapitulasi</a></li>
        </ul>  
    ...
    <thead>
        <tr>
            ...
            <th width="85px">% Potongan</th>
            <th width="85px">Jumlah Potongan</th>
            <th width="85px">Jumlah Bersih</th>
            <th width="85px">% PPH21</th>
            <th width="85px">Jumlah PPH21</th>
            <th width="85px">Dibayarkan</th>
        </tr>
    </thead>
    </table>
    </div>    
