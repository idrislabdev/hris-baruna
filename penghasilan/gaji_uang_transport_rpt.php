...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\UANG_TRANSPORT.rpt";
$my_pdf		= $path."penghasilan\\report\\UANG_TRANSPORT.pdf";
...
$creport->RecordSelectionFormula="{UANG_TRANSPORT_REPORT.PERIODE}=\"".$reqPeriode."\"".$statement;
//else
