...
//------  Variables ------
$my_report 	= $path."penghasilan\\report\\GAJI_PREMI_NEW.rpt";
$my_pdf 	= $path."penghasilan\\report\\GAJI_PREMI_NEW.pdf";
...
$creport->RecordSelectionFormula="{PREMI_REPORT.PERIODE}='".$reqPeriode."'";
//else
