...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\REKAPITULASI_MOBILITAS_MANAGER_NEW.rpt";
$my_pdf		= $path."penghasilan\\report\\REKAPITULASI_MOBILITAS_MANAGER_NEW.pdf";
...
$creport->RecordSelectionFormula="{REKAP_UANG_TRANSPORT_REPORT.PERIODE}='".$reqPeriode."'";
//else
