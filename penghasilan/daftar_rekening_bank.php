...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/daftar_rekening_bank_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('daftar_rekening_bank_add.php?reqMode=update&jenis='+anSelectedId+'&refid='+anSelectedId2, 'Office Management - Aplikasi Penghasilan', '600', '450');	
			  });
			  $('#btnDeleteRow').on('click', function () {
					if(anSelectedData == "")
						...
						{
							$.getJSON("../json-gaji/delete.php?reqMode=daftar_rekening_bank&id="+anSelectedId,
							  function(data){
									  oTable.fnReloadAjax("../json-gaji/daftar_rekening_bank_json.php");
							});
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Rekening</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('daftar_rekening_bank_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '600', '450');" title="Tambah">Tambah</a>
