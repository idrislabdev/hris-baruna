...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/integrasi_potongan_json.php?reqPeriode=<?=$reqPeriode?>",						  
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anPotonganKondisiId = element[element.length-1];
			  });
			  ...
			  $('#btnImport').on('click', function () {
				  window.parent.OpenDHTML("integrasi_potongan_import.php?reqMode=import&reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');	
			  });
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 // else
			  		...
			  		oTable.fnReloadAjax("../json-gaji/integrasi_potongan_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
				 	 
			  });
			  	
			  $('#cc').combotree({
					onSelect: function(param){ 
			  			oTable.fnReloadAjax("../json-gaji/integrasi_potongan_json.php?reqDepartemen="+param.id+"&reqJenisPegawai="+ $("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
					}
			  });	
			  
			  $("#reqJenisPegawai").change(function() { 
				oTable.fnReloadAjax("../json-gaji/integrasi_potongan_json.php?reqDepartemen="+$('#cc').combotree('getValue')+"&reqJenisPegawaiId="+$("#reqJenisPegawai").val()+"&reqPeriode="+ $("#reqPeriode").val());
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-gaji/delete.php?reqMode=integrasi_potongan&id='+anSelectedId+'&reqKondisiId='+anPotonganKondisiId+'&reqPeriode='+ $("#reqPeriode").val(), function (data) 
					{
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Integrasi Potongan</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            ...
            <th width="250px">Jenis Potongan</th> 
