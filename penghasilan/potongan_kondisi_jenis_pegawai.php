...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		      
			  "sAjaxSource": "../json-gaji/potongan_kondisi_jenis_pegawai_json.php",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('potongan_kondisi_jenis_pegawai_edit.php?reqMode=update&reqId='+anSelectedId+'&reqKelompokId=' + anSelectedKelompokId + '&reqKelasId=' + anSelectedKelas, 'Office Management - Aplikasi Penghasilan', '900', '500');	
			  });
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Potongan per Jenis Pegawai</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('potongan_kondisi_jenis_pegawai_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '900', '500');" title="Tambah">Tambah</a>
