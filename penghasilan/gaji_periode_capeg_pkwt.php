...
if($reqMode == "delete")
{
	$gaji_periode_capeg_pkwt->setField("GAJI_PERIODE_CAPEG_PKWT_ID", $reqId);
	if($gaji_periode_capeg_pkwt->delete())
	{
...
if($reqMode == "update")
{
	/*$gaji_kondisi->selectByParams(array("gaji_periode_capeg_pkwt_ID" => $reqId));
...
?>
<script type="text/javascript">
	window.location.replace('gaji_periode_capeg_pkwt.php?reqHeight=' + screen.height);
</script>
<?
}
?>
...
<script language="JavaScript" src="../jslib/displayElement.js"></script>  
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-gaji/gaji_periode_capeg_pkwt_add.php',
				onSubmit:function(){
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Gaji Periode Capeg/PKWT</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <!--<a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('gaji_periode_capeg_pkwt_add.php?reqMode=insert&reqId=0', 'Sistem Informasi Persuratan', '600', '300')" title="Tambah">Tambah</a>-->
            </li>        
        </ul>
    </div>
    <div class="scroll">
      ...
      <table class="example" id="sf">
            ...
            <tbody> 
                <tr>
					<?
                    $gaji_periode_capeg_pkwt->selectByParams(array());
					while($gaji_periode_capeg_pkwt->nextRow())
					{
					?>
                        <tr id="node-<?=$gaji_periode_capeg_pkwt->getField('gaji_periode_capeg_pkwt_ID')?>">
                            <td class="jarak-tree-table padding5"><span class='file'><?=getNamePeriode($gaji_periode_capeg_pkwt->getField('PERIODE'))?></span></td>
                        </tr>
                    <?
					}
                    ?>
                ...
                <tr>
                    <td>
					<?
						$bulan = substr($gaji_periode_capeg_pkwt->getField('PERIODE'),0,2);
						$tahun = substr($gaji_periode_capeg_pkwt->getField('PERIODE'),2,4);
						if($bulan == 12)
						{
