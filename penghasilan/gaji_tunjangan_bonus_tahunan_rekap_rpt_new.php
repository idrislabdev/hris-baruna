...
//------  Variables ------
$my_report 	= $path."penghasilan\\report\\REKAPITULASI_BONUS_TAHUNAN_NEW.rpt";
$my_pdf 	= $path."penghasilan\\report\\REKAPITULASI_BONUS_TAHUNAN_NEW.pdf";
...
//$creport->RecordSelectionFormula="{REKAP_THR_REPORT.PERIODE}='".$reqPeriode."'".$statement;
//else
