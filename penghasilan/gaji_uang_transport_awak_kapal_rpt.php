...
//------  Variables ------
$my_report	= $path."penghasilan\\report\\UANG_TRANSPORT_KAPAL.rpt";
$my_pdf		= $path."penghasilan\\report\\UANG_TRANSPORT_KAPAL.pdf";
...
$creport->RecordSelectionFormula="{UANG_TRANSPORT_KAPAL_REPORT.PERIODE}='".$reqPeriode."'";
//else
