...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/gaji_premi_khusus_json.php",
			...
			/* Click event handler */
			  ...
			  $('#btnLihat').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('gaji_premi_khusus_lihat.php?reqId='+anSelectedId+'&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '980', '530');	
			  });
			  
			  $('#btnCetak').on('click', function () {
				  
				  //newWindow = window.open('gaji_premi_khusus_cetak?reqId='+anSelectedId+'&reqPeriode='+ $("#reqPeriode").val(), 'Cetak');
				  //newWindow.focus();
				  window.parent.OpenDHTML('report_penanda_tangan.php?reqJenisReport=PREMI_KHUSUS&reqId='+anSelectedId+'&reqPeriode='+ $("#reqPeriode").val(), 'Office Management - Aplikasi Penghasilan', '600', '300');
			  });
			  ...
			  $("#reqPeriode").change(function() { 
				 ...
				 //fnReloadAjax("../json-gaji/gaji_premi_khusus_json.php?reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Premi Khusus</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            <th width="85px">KAPAL_PEKERJAAN_ID</th>
            <th width="85px">Nama Kapal</th>
            <th width="85px">Lokasi</th>
            <th width="85px">No Kontrak</th>
            <th width="85px">Nama Pekerjaan</th>
            <th width="85px">Tanggal Awal</th>
            <th width="85px">Tanggal Akhir</th>
            <th width="85px">Nilai Kontrak</th>
            <th width="85px">Total Premi</th>
        </tr>
    </thead>
    </table>
    </div>    
