...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/tunjangan_mengajar_json.php",						  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Honorium Mengajar</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="50px">Kelompok Pegawai</th> 
            <th width="50px">Kelompok Pendidik</th> 
            <th width="50px">Periode</th> 
            <th width="50px">Jumlah Mengajar Intra</th> 
            <th width="50px">Jumlah Mengajar Ekstra</th> 
            <th width="250px">Jumlah Jam Lebih</th>          
        </tr>
    </thead>
    </table> 
    </div> 
