...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-gaji/premi_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('premi_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Penghasilan', '600', '450');	
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('premi_add.php?reqMode=insert', 'Office Management - Aplikasi Penghasilan', '600', '450');" title="Tambah">Tambah</a>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Jenis Kapal</th> 
            <th width="100px">Jabatan</th>
            <th width="100px">Produksi Normal</th>
            <th width="100px">Produksi Maksimal</th>
            <th width="100px">Interval Produksi</th>
            <th width="100px">Tarif Normal</th>
            <th width="100px">Tarif Maksimal</th>                                            
        </tr>
    </thead>
    </table> 
    </div> 
