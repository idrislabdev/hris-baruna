...
else
{
	...
	$reqIdUserLogin = $user_login->getField("USER_LOGIN_ID_WEBSITE");	
...
<head>
	...
	<script type="text/javascript">
			...
			$('#ff').form({
				...
				success:function(data){
					...
					if(temp[1] != 0){
						...
						$.messager.alert('Info', temp[0], 'info');
						$('#rst_form').click();
		...
		function OptionSet(id, nrp,nama, jabatan, email, telepon){
			...
			document.getElementById('reqUserLogin').value = nrp.substring(4, 9);
			document.getElementById('reqUserPassword').value = nrp.substring(4, 9);	
...
<div id="wadah">
    ...
    <table>
        ...
        <tr>
            <td>Email</td>
            <td>
                <input id="reqEmail" name="reqEmail" class="easyui-validatebox" data-options="validType:'email'" size="50" type="text" value="<?=$tempEmail?>" />
            </td>
        </tr>
        <tr>
            <td>Telepon</td>
        ...
        <div>
            ...
            <input type="hidden" name="reqIdUserLogin" value="<?=$reqIdUserLogin?>">
