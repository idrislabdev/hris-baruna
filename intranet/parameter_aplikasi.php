...
<link rel="stylesheet" type="text/css" href="../WEB-INF/lib/DataTables-1.10.6/media/css/jquery.dataTables.css">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/parameter_aplikasi_json.php",			  
			...
			sDeleteURL: "../json-keuangan/delete.php?reqMode=parameter_aplikasi",
			sAddHttpMethod: "GET",
			"aoColumns": [
				{ 	cssclass: "required" },
				{
			...
			/* Click event handler */ 
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('parameter_aplikasi_add.php?reqMode=update&reqId='+anSelectedId, 'IMASYS - Aplikasi Keuangan', '600', '300');	
			  });
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li><a href="#" id="btnEdit" title="Edit">Tambah</a></li>
            <li><a href="#" id="btnEdit" title="Ubah">Ubah</a></li>
            <li><a href="#" id="btnEdit" title="Hapus">Hapus</a></li>
        </ul>
    </div>
