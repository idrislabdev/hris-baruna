...
<link rel="stylesheet" type="text/css" href="../WEB-INF/lib/DataTables-1.10.6/media/css/jquery.dataTables.css">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-intranet/user_group_json.php",						  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('user_group_add.php?reqMode=edit&reqId='+ anSelectedId, 'Office Management - Administrasi Intranet', '900', '580');	
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-intranet/delete.php?reqMode=user_group&id='+anSelectedId, function (data) 
					{
			  ...
			  $('#btnCopy').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('user_group_add.php?reqMode=copy&reqId='+anSelectedId, 'Office Management - Administrasi Intranet', '900', '580');	
			  });			  
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Data Group User</span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('user_group_add.php?reqMode=add', 'Office Management - Administrasi Intranet', '900', '580');" title="Tambah">Tambah</a>
            <a href="#" id="btnEdit" title="Edit">Ubah</a>
            <a href="#" id="btnDeleteRow" title="Hapus">Hapus</a>
            <a href="#" id="btnCopy" title="Copy">Copy Group</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr> 
            ...
            <th width="150px">App Operasional</th> 
            <th width="150px">App Kepegawaian</th>                                            
            <th width="150px">App Penghasilan</th>                                            
            <th width="150px">App Presensi</th>                                            
            <th width="150px">App Penilaian</th>                                            
            <th width="150px">App Backup</th>                                             
            <th width="150px">App Komersial</th>                                             
            <th width="150px">Adm Website</th>                                            
            <th width="150px">Adm Intranet</th> 
            <th width="150px">App Survey</th> 
            <th width="50px">Publish</th> 
            <th width="100px">File Manager</th> 
            <th width="100px">SMS Gateway</th> 
            <th width="100px">Arsip</th> 
            <th width="100px">Inventaris</th> 
            <th width="100px">SPPD</th> 
            <th width="100px">Hukum</th> 
            <th width="100px">Keuangan</th>
            <th width="100px">Dokumen Hukum</th>
            <th width="100px">App Notifikasi</th>
            <th width="100px">App Galangan</th>
            <th width="100px">App Anggaran</th>
        </tr>
    </thead>
    </table> 
    </div> 
    ...
    <div class="vmenu">
        ...
        <div class="first_li"><span>Baca</span></div>
