        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.OpenDHTML('hasil_rapat_add.php?reqId='+anSelectedId, 'Office Management - Administrasi Intranet', '800', '580');	
			  });
			  ...
			  $('#btnDeleteRow').on('click', function () {
				...
				if ( confirm( "Apakah anda yakin, menghapus data ini ?" ) ) {
					$.getJSON('../json-intranet/delete.php?reqMode=hasil_rapat&id='+anSelectedId, function (data) 
					{
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('hasil_rapat_add.php', 'Office Management - Administrasi Intranet', '800', '580');" title="Tambah">Tambah</a>
