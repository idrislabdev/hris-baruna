...
{
	$reqMode = "update";	
	$kalender_kerja->selectByParams(array("KALENDER_KERJA_ID" => $reqId));
	$kalender_kerja->firstRow();
	$tempDepartemen = $kalender_kerja->getField("DEPARTEMEN_ID");
	$tempNama = $kalender_kerja->getField("NAMA");
	$tempTanggalAwal = dateToPageCheck($kalender_kerja->getField("TANGGAL_AWAL"));
	$tempTanggalAkhir = dateToPageCheck($kalender_kerja->getField("TANGGAL_AKHIR"));
	$tempWarna = $kalender_kerja->getField("WARNA");	
	if($tempDepartemen == "")
		$tempDepartemen = "NULL";
}
?>
...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-intranet/kalender_kerja_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Kalender Kerja</span>
    </div>
	<?
        ...
        <tr>
            ...
            <td>
                ...
                <select name="reqWarna">
                    ...
                    <option value="<?=$kalender_kerja->getField("WARNA")?>" <? if($kalender_kerja->getField("WARNA") == $tempWarna) echo "selected"; ?>></option>
                </select>
            </p>
            </div>               
            </td>
