...
<script type="text/javascript" src="../WEB-INF/js/jquery-1.7.min.js"></script>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-intranet/pegawai_json.php?reqDepartemen=<?=$reqDepartemen?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					...
					anSelectedEmail 	= element[element.length-1];
					anSelectedTelepon = element[element.length-2];
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSet(anSelectedId, anSelectedNRP, anSelectedNama, anSelectedJabatan, anSelectedEmail, anSelectedTelepon);	
				  window.parent.divwin.close();
	
			  });
			  
			  $("#reqJenisPegawai").change(function() { 
				 fnReloadAjax("../json-simpeg/pegawai_json.php?reqDepartemen=<?=$reqDepartemen?>&reqJenisPegawai="+ $("#reqJenisPegawai").val());				 	 
			  });
...
<div id="wadah">
    ...
    <thead>
        <tr>
            ...
            <th width="90px">Status Kawin</th> 
            <th width="90px">Status Pegawai</th> 
            <th width="110px">Golongan Darah</th> 
