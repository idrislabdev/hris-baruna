...
if($reqMode == "update")
{
	$kata_mutiara->selectByParams(array("KATA_MUTIARA_ID" => $reqId));
	$kata_mutiara->firstRow();
	$tempNama = $kata_mutiara->getField("NAMA");
	$tempKeterangan = $kata_mutiara->getField("KETERANGAN");	
}
?>
...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#ff').form({
				url:'../json-intranet/kata_mutiara_add.php',
				onSubmit:function(){
...
<div id="wadah">
    ...
    <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png">Tambah Data Kata Mutiara</span>
    </div>
