...
<div id="wadah">
    ...
    <thead>
        <tr> 
			...
			<th width="20px">App Kepegawaian</th>                                            
            <th width="20px">App Penghasilan</th>                                            
            <th width="20px">App Presensi</th>                                            
            <th width="20px">App Keuangan</th>                                            
            <th width="20px">App Fixed Asset</th>                                             
            <th width="20px">App Pembayaran</th>                                             
            <th width="20px">App Pengaturan</th>
        </tr>
    </thead>
    </table> 
    </div> 
