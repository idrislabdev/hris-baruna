...
$aColumns = array("INVENTARIS", "INVENTARIS_RUANGAN_ID", "NOMOR", "PEROLEHAN_PERIODE", "KONDISI_FISIK_PROSENTASE", "JAN", "FEB", "MAR", "APR", "MEI", "JUN", "JUL", "AGT", "SEP", "OKT", "NOV", "DES");
$aColumnsAlias = array("INVENTARIS", "INVENTARIS_RUANGAN_ID", "NOMOR", "PEROLEHAN_PERIODE", "KONDISI_FISIK_PROSENTASE", "JAN", "FEB", "MAR", "APR", "MEI", "JUN", "JUL", "AGT", "SEP", "OKT", "NOV", "DES");
...
$inventaris_ruangan->selectByParamsPengendalian(array("A.LOKASI_ID" => $reqId), $dsplyRange, $dsplyStart, $statement." AND (UPPER(B.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%')", $sOrder, $reqTahun);     		
//echo $inventaris_ruangan->query;
