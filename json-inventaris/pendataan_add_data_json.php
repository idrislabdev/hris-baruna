...
$aColumns = array("INVENTARIS_RUANGAN_ID", "NOMOR", "BARCODE", "PEROLEHAN_PERIODE", "PEROLEHAN_HARGA", "KETERANGAN", "FILE_GAMBAR");
$aColumnsAlias = array("INVENTARIS_RUANGAN_ID", "NOMOR", "BARCODE", "PEROLEHAN_PERIODE","PEROLEHAN_HARGA", "KETERANGAN", "FILE_GAMBAR");
...
$inventaris_ruangan->selectByParamsDetil(array("A.LOKASI_ID" => $reqId), $dsplyRange, $dsplyStart, $statement." AND (UPPER(B.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%')", $sOrder, $reqTahun);     		
...
while($inventaris_ruangan->nextRow())
{
	...
	{
		if($aColumns[$i] == "PEROLEHAN_TANGGAL")
