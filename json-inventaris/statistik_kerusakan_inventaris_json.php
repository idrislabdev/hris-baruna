...
$jumlah_inventaris = $report->getCountKerusakanInventaris();

if($reqJenisInventaris == "")
	$report->selectByParamsKerusakan($statement);
else
	$report->selectByParamsKerusakanChild(" AND A.JENIS_INVENTARIS_PARENT_ID = '".$reqJenisInventaris."' ");
