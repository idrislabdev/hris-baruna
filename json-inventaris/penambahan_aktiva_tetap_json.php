...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY HEADER asc, HEADER asc" )
	{
		...
		*/
		$sOrder = " ORDER BY KODE_HEADER, TANGGAL_PEROLEHAN ASC";
...
$statement_privacy .= " AND TANGGAL_PEROLEHAN BETWEEN TO_DATE('".$reqPeriodeAwal."', 'MMYYYY') AND LAST_DAY(TO_DATE('".$reqPeriodeAkhir."', 'MMYYYY'))";
