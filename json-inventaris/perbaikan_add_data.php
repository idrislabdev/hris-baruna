...
if($reqMode == "insert")
{
	...
	$inventaris_perbaikan->setField("LAST_CREATE_USER", $userLogin->nama);
	$inventaris_perbaikan->setField("LAST_CREATE_DATE", "CURRENT_DATE");	
	
	if($inventaris_perbaikan->insert())
	{
		$id=$inventaris_perbaikan->id;
