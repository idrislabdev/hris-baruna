...
$allRecord = $kalkulas_penyusutan->getCountByParamsRekapKelompok(array(), $statement_privacy);	
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else	
	$allRecordFilter = $kalkulas_penyusutan->getCountByParamsRekapKelompok(array(), " AND (UPPER(NAMA_HEADER) LIKE '%".strtoupper($_GET['sSearch'])."%')".$statement_privacy);

$kalkulas_penyusutan->selectByParamsRekapKelompokPeriode(array(), $dsplyRange, $dsplyStart, " AND (UPPER(NAMA_HEADER) LIKE '%".strtoupper($_GET['sSearch'])."%')".$statement_privacy, $sOrder);     		
