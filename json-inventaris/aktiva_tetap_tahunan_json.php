...
$kalkulas_penyusutan->selectByParamsRekapKelompokTahun(array(), $dsplyRange, $dsplyStart, " AND (UPPER(NAMA_HEADER) LIKE '%".strtoupper($_GET['sSearch'])."%')".$statement_privacy, $sOrder);     		
