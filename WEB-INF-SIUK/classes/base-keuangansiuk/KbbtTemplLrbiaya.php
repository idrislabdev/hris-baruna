...
***************************************************************************************************** */
  ...
  /***
  * EntitySIUK-base class untuk mengimplementasikan tabel KBBT_TEMPL_LRBIAYA.
  * 
  ***/
  include_once("../WEB-INF-SIUK/classes/db/Entity.php");

  class KbbtTemplLrbiaya extends EntitySIUK{ 

	var $query;
    /**
    * Class constructor.
    **/
    function KbbtTemplLrbiaya()
	{
      $this->EntitySIUK(); 
    }
	...
	function insert()
	{
		...
		$this->setField("KBBT_TEMPL_LRBIAYA_ID", $this->getNextId("KBBT_TEMPL_LRBIAYA_ID","KBBT_TEMPL_LRBIAYA")); 		
		//'".$this->getField("FOTO")."',  FOTO,
		$str = "
				INSERT INTO KBBT_TEMPL_LRBIAYA (
		...
		$this->id = $this->getField("KBBT_TEMPL_LRBIAYA_ID");
		$this->query = $str;
    ...
    function update()
	{
		$str = "
				...
				WHERE  KBBT_TEMPL_LRBIAYA_ID = '".$this->getField("KBBT_TEMPL_LRBIAYA_ID")."'
	...
	function delete()
	{
        $str = "DELETE FROM KBBT_TEMPL_LRBIAYA
                WHERE 
                  KBBT_TEMPL_LRBIAYA_ID = ".$this->getField("KBBT_TEMPL_LRBIAYA_ID").""; 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		...
		$str .= $statement." ORDER BY KBBT_TEMPL_LRBIAYA_ID ASC";
		$this->query = $str;
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(KBBT_TEMPL_LRBIAYA_ID) AS ROWCOUNT FROM KBBT_TEMPL_LRBIAYA
		        WHERE KBBT_TEMPL_LRBIAYA_ID IS NOT NULL ".$statement; 
