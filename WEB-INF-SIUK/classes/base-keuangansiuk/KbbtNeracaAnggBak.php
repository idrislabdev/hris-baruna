  ...
  class KbbtNeracaAngg extends EntitySIUK{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("KBBT_NERACA_ANGG_ID", $this->getNextId("KBBT_NERACA_ANGG_ID","KBBT_NERACA_ANGG")); 		
		//'".$this->getField("FOTO")."',  FOTO,
		$str = "
				INSERT INTO KBBT_NERACA_ANGG@KEUANGAN (
				...
				VALUES ('".$this->getField("KD_CABANG")."', '".$this->getField("THN_BUKU")."', '".$this->getField("KD_BUKU_BESAR")."',
							...
							'".$this->getField("ANGG_TAHUNAN")."', '".$this->getField("MUTA_TAHUNAN")."', '".$this->getField("P01_ANGG")."',
							'".$this->getField("P01_MUTA")."', '".$this->getField("P02_ANGG")."', '".$this->getField("P02_MUTA")."',
							'".$this->getField("P03_ANGG")."', '".$this->getField("P03_MUTA")."', '".$this->getField("P04_ANGG")."',
							'".$this->getField("P04_MUTA")."', '".$this->getField("P05_ANGG")."', '".$this->getField("P05_MUTA")."',
							'".$this->getField("P06_ANGG")."', '".$this->getField("P06_MUTA")."', '".$this->getField("P07_ANGG")."',
							'".$this->getField("P07_MUTA")."', '".$this->getField("P08_ANGG")."', '".$this->getField("P08_MUTA")."',
							'".$this->getField("P09_ANGG")."', '".$this->getField("P09_MUTA")."', '".$this->getField("P10_ANGG")."',
							'".$this->getField("P10_MUTA")."', '".$this->getField("P11_ANGG")."', '".$this->getField("P11_MUTA")."',
							'".$this->getField("P12_ANGG")."', '".$this->getField("P12_MUTA")."', '".$this->getField("P13_ANGG")."',
							'".$this->getField("P13_MUTA")."', '".$this->getField("P14_ANGG")."', '".$this->getField("P14_MUTA")."',
    ...
    function update()
	{
		$str = "
				...
				WHERE  KBBT_NERACA_ANGG_ID = '".$this->getField("KBBT_NERACA_ANGG_ID")."'
    ...
    **/ 
	...
	{
		$str = "
				SELECT A.THN_BUKU, A.KD_BUKU_BESAR || ' - ' || B.NM_BUKU_BESAR KD_BUKU_BESAR, A.KD_SUB_BANTU, A.KD_BUKU_PUSAT || ' - ' || C.NM_BUKU_BESAR KD_BUKU_PUSAT, 
