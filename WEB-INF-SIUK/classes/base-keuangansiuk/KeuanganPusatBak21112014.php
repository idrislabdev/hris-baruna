  ...
  ***/
  ...
  class KeuanganPusat extends EntitySIUK{ 
    ...
    **/ 
	...
	{
		$str = "
				SELECT NOMOR,INDEKS,JUN,KDBB01,KDBB02,KDBB03,RLBB01,RLBB02,RLBB03,
	...
	{
		$str = "
				SELECT KD_BUKU_BESAR, TGL_ENTRY, NOMOR_BUKTI, NO_POSTING, KET_TAMBAH, RP_DEBET, RP_KREDIT, RINCIAN_KETERANGAN FROM
                              (     
								SELECT DISTINCT B.KD_BUKU_BESAR   KD_BUKU_BESAR,
								...
								AND    E.ID_REF_FILE = 'URUT JURNAL'
								AND    E.ID_REF_DATA = D.KD_JURNAL )
