...
***************************************************************************************************** */
	...
	function dateToDBCheckImport($_date){
		...
		$arrDate = explode("-", $_date);
		$_date = generateZeroDate($arrDate[0], 2);
		return "TO_DATE('".$_date."', 'YYYYMMDD')";
	}
...
//		$_date = $arrDate[0]."-".$arrDate[1]."-".$arrDate[2];
	...
	function getNameTahunAjaran($periode) {
		$tahun1 = substr($periode, 0,2);
		$tahun2 = substr($periode, 2,4);
		 
		return getNameAjaran((int)$tahun1)."-".getNameAjaran((int)$tahun2);
	}

	function getNamePeriodeKeu($periode) {
		$bulan = substr($periode, 0,2);
		$tahun = substr($periode, 2,4);
		...
		return getNameMonthKeu((int)$bulan)." ".$tahun;
	}
	...
	function getNameAjaran($number) {
		$arrMonth = array("18"=>"2018", "19"=>"2019", "20"=>"2020", "21"=>"2021", "22"=>"2022", 
						  "23"=>"2023", "24"=>"2024", "25"=>"2025", "26"=>"2026", "27"=>"2027", 
						  "28"=>"2028", "29"=>"2029");
	...
	function getNameMonthKeu($number) {
		$arrMonth = array("1"=>"Juli", "2"=>"Agustus", "3"=>"September", "4"=>"Oktober", 
						  "5"=>"November", "6"=>"Desember", "7"=>"Januari", "8"=>"Februari", "9"=>"Maret", "10"=>"April", "11"=>"Mei", 
						  "12"=>"Juni");
		return $arrMonth[$number];
	}
