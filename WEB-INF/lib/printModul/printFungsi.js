var qz;   // Our main applet
	  ...
	  function panjangString(varId)
	  {
		  var tempPanjang= parseInt(String(varId).length);
		  return tempPanjang;
	  }
	  
	  function fillStringCompletor(varId, digitGroup, digitCompletor, extra)
	  {
		var newId = "";
		
		var lengthZero = parseInt(digitGroup) - parseInt(String(varId).length);
