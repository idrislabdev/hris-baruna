...
(function ($) {
    ...
    $.fn.makeEditable = function (options) {
		...
		oEditEntryKeluarRowButton, oEditKatalogRowButton, oSuratKeluarRowButton, oConfirmRowAddingButton, oCancelRowAddingButton, oEditArsipRowButton, oPublishArsipRowButton, oPilihArsipRowButton, oEditJenisHukumanButtonId, oEditTingkatHukumanButtonId, oEditPeraturanButtonId;
...
//			alert(mySplitResult[6]+'--');
			
			if(mySplitResult[1]=='Final')
				alert('Data Final, Tidak Bisa Di Revisi');
			else{
				var mySplitResult = mySplitResult[2].split("#");
				//alert(mySplitResult[0]+'--'+mySplitResult[2]+'-xxx-'+mySplitResult[5]);
				
				if(mySplitResult[6]=='banget')
        ...
        function _fnOnRowBaca(event) {
			...
			opWidth = 950;
			opHeight = 550;
			opUrl    = 'edit.php.php?reqMode=baca';
		...
		function _fnOnEditGajiPokok(event) {
			var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 550;
			opHeight = 150;
			opUrl    = 'gaji_pokok_edit.php?reqId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();
		...
		function _fnOnRowEditNew(event) {
			...
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'agama_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditPangkat(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'pangkat_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditEselon(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'eselon_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditPendidikan(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'pendidikan_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditJurusanPendidikan(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'jurusan_pendidikan_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditPejabatPenetap(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'pejabat_penetap_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditJabatanFungsional(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'jabatan_fungsional_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditDiklat(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 350;
			opHeight = 150;
			opUrl    = 'diklat_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditJenisHukuman(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 550;
			opHeight = 150;
			opUrl    = 'master_jenis_hukuman_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditTingkatHukuman(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 550;
			opHeight = 150;
			opUrl    = 'master_tingkat_hukuman_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditPeraturan(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 550;
			opHeight = 150;
			opUrl    = 'master_peraturan_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }				
		function _fnOnRowEditUser(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 450;
			opHeight = 250;
			opUrl    = 'user_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        }
		function _fnOnRowEditUserGroup(event) {
            var id = fnGetCellID($('tr.' + properties.sSelectedRowClass + ' td', oTable)[0]);
			opWidth = 450;
			opHeight = 250;
			opUrl    = 'user_group_edit.php?reqJsonId='+id;
			var left = (screen.width/2)-(opWidth/2);
			var top = (screen.height/2)-(opHeight/2);
			newWindow = window.open(opUrl, "", "width = " + opWidth + "px, height = " + opHeight + "px, resizable = 1, scrollbars, top="+top+", left="+left);
			newWindow.focus();			
        ...
        */
        ...
        var defaults = {
            ...
            sEditPangkatButtonId: "btnEditPangkat",
            sEditEselonButtonId: "btnEditEselon",
            sEditPendidikanButtonId: "btnEditPendidikan",
            sEditJurusanPendidikanButtonId: "btnEditJurusanPendidikan",
            sEditPejabatPenetapButtonId: "btnEditPejabatPenetap",
			sEditJabatanFungsionalButtonId: "btnEditJabatanFungsional",
            sEditDiklatButtonId: "btnEditDiklat",
			sEditJenisHukumanButtonId: "btnEditJenisHukuman",
            sEditTingkatHukumanButtonId: "btnEditTingkatHukuman",
			sEditPeraturanButtonId: "btnEditPeraturan",
        ...
        return this.each(function () {
			...
			oUpdateRefRowButton = $('#' + properties.sUpdateRefRowButtonId);// tak huapus
			...
			oEditPangkatButtonId = $('#' + properties.sEditPangkatButtonId);
            if (oEditPangkatButtonId.length != 0)
			{
                oEditPangkatButtonId.click(_fnOnRowEditPangkat);
			}
            else {
                oEditPangkatButtonId = null;
            }
			
			oEditEselonButtonId = $('#' + properties.sEditEselonButtonId);
            if (oEditEselonButtonId.length != 0)
			{
                oEditEselonButtonId.click(_fnOnRowEditEselon);
			}
            else {
                oEditEselonButtonId = null;
            }
			
			oEditPendidikanButtonId = $('#' + properties.sEditPendidikanButtonId);
            if (oEditPendidikanButtonId.length != 0)
			{
                oEditPendidikanButtonId.click(_fnOnRowEditPendidikan);
			}
            else {
                oEditPendidikanButtonId = null;
            }
			
			oEditJurusanPendidikanButtonId = $('#' + properties.sEditJurusanPendidikanButtonId);
            if (oEditJurusanPendidikanButtonId.length != 0)
			{
                oEditJurusanPendidikanButtonId.click(_fnOnRowEditJurusanPendidikan);
			}
            else {
                oEditJurusanPendidikanButtonId = null;
            }
			
			oEditPejabatPenetapButtonId = $('#' + properties.sEditPejabatPenetapButtonId);
            if (oEditPejabatPenetapButtonId.length != 0)
			{
                oEditPejabatPenetapButtonId.click(_fnOnRowEditPejabatPenetap);
			}
            else {
                oEditPejabatPenetapButtonId = null;
            }
			oEditJabatanFungsionalButtonId = $('#' + properties.sEditJabatanFungsionalButtonId);
            if (oEditJabatanFungsionalButtonId.length != 0)
			{
                oEditJabatanFungsionalButtonId.click(_fnOnRowEditJabatanFungsional);
			}
            else {
                oEditJabatanFungsionalButtonId = null;
            }
			
			oEditDiklatButtonId = $('#' + properties.sEditDiklatButtonId);
            if (oEditDiklatButtonId.length != 0)
			{
                oEditDiklatButtonId.click(_fnOnRowEditDiklat);
			}
            else {
                oEditDiklatButtonId = null;
            }
			
			oEditJenisHukumanButtonId = $('#' + properties.sEditJenisHukumanButtonId);
            if (oEditJenisHukumanButtonId.length != 0)
			{
                oEditJenisHukumanButtonId.click(_fnOnRowEditJenisHukuman);
			}
            else {
                oEditJenisHukumanButtonId = null;
            }
			
			oEditTingkatHukumanButtonId = $('#' + properties.sEditTingkatHukumanButtonId);
            if (oEditTingkatHukumanButtonId.length != 0)
			{
                oEditTingkatHukumanButtonId.click(_fnOnRowEditTingkatHukuman);
			}
            else {
                oEditTingkatHukumanButtonId = null;
            }
			
			oEditPeraturanButtonId = $('#' + properties.sEditPeraturanButtonId);
            if (oEditPeraturanButtonId.length != 0)
			{
                oEditPeraturanButtonId.click(_fnOnRowEditPeraturan);
			}
            else {
                oEditPeraturanButtonId = null;
            }									
			
			oEditUserButtonId = $('#btnEditUser');
            if (oEditUserButtonId.length != 0)
			{
                oEditUserButtonId.click(_fnOnRowEditUser);
			}
            else {
                oEditUserButtonId = null;
            }
			
			oEditUserGroupButtonId = $('#btnEditUserGroup');
            if (oEditUserGroupButtonId.length != 0)
			{
                oEditUserGroupButtonId.click(_fnOnRowEditUserGroup);
			}
            else {
                oEditUserGroupButtonId = null;
            }
			...
			oEditGajiPokokButton = $('#btnEditGajiPokok');
            if (oEditGajiPokokButton.length != 0)
            {
                oEditGajiPokokButton.click(_fnOnEditGajiPokok);
            }
            else {
                oEditGajiPokokButton = null;
            }
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				if (oBacaRowButton == null && properties.sBacaRowButtonId != "") {
					//oAddDeleteToolbar.append("<button id='" + properties.sBacaRowButtonId + "' class='baca_row'>Baca</button>");
                    oBacaRowButton = $("#" + properties.sBacaRowButtonId);
                    oBacaRowButton.click(_fnOnRowBaca);				
				}
