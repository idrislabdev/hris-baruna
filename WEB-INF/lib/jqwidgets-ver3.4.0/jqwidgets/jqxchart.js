...
(function (a) {
    ...
    a.extend(a.jqx._jqxChart.prototype, {
        ...
        _showLabel: function (u, r, d, b, m, f, c) {
            ...
            var n = this.renderer.text(o, j + b.x + s.x, i + b.y + s.y, p.width, p.height, e, {}, e != 0, "bottom", "bottom");
            this.renderer.attr(n, {
                "class": q
            });
            if (this._isVML) {
        ...
        _renderLineSeries: function (d, E) {
            var w = this.seriesGroups[d];
            if (!w.series || w.series.length == 0) {
                return
            }
            var k = w.type.indexOf("area") != -1;
            var A = w.type.indexOf("stacked") != -1;
            var b = A && w.type.indexOf("100") != -1;
            var S = w.type.indexOf("spline") != -1;
            var l = w.type.indexOf("step") != -1;
            var C = w.type.indexOf("range") != -1;
            if (l && S) {
                return
            }
            var p = this._getDataLen(d);
            var Q = E.width / p;
            var U = w.orientation == "horizontal";
            ...
            var G = this._alignValuesWithTicks(d);
            for (var M = w.series.length - 1; M >= 0; M--) {
                var J = t.xoffsets.first;
                var v = J;
                do {
                    var K = [];
                    var I = [];
                    ...
                    var H = this._getAnimProps(d, M);
                    var B = H.enabled && t.xoffsets.length < 10000 && this._isVML != true ? H.duration : 0;
                    var n = J;
                    var m = false;
                    for (var R = J; R <= t.xoffsets.last; R++) {
                        J = R;
                        var L = t.xoffsets.data[R];
                        if (L == undefined) {
                            continue
                        }
                        var g = t.offsets[M][R].to;
                        var P = t.offsets[M][R].from;
                        if (isNaN(g) || isNaN(P)) {
                            J++;
                            m = true;
                            break
                    ...
                    this._animatePath(undefined, z, B == 0 ? 1 : 0);
                    var j = this;
                    this._enqueueAnimation("series", undefined, undefined, B, function (s, i, V) {
                        j._animatePath(s, i, V)
                    }, z)
                } while (J < t.xoffsets.length - 1 || m)
            }
        },
        _animatePath: function (e, b, h) {
            var j = this._calculateLine(b.pointsArray, b.yBase, h, b.isArea, b.swapXY);
            var d = b.pointsArray.length;
            if (!b.isArea) {
                d = Math.round(d * h)
            }
            if (j != "") {
                j = this._buildLineCmd(j, b.isRange, b.left, b.right, b.pyStart, b.pyEnd, b.yBase, b.isArea, d > 3 && b.isSpline, b.swapXY)
            } else {
                j = "M 0 0"
            }
            var g = b.element;
            if (!g) {
                var f = this._getSerieSettings(b.groupIndex, b.seriesIndex);
                g = this.renderer.path(j, {
                    "stroke-width": f.stroke,
                    stroke: f.colors.lineColor,
                    "fill-opacity": f.opacity,
                    "stroke-dasharray": f.dashStyle,
                    fill: b.isArea ? f.colors.fillColor : "none"
                });
                b.element = g
            }
            this.renderer.attr(g, {
                d: j
            });
            if (h == 1) {
                var f = this._getSerieSettings(b.groupIndex, b.seriesIndex);
                for (var c = 0; c < b.pointsArray.length; c++) {
                    this._showLabel(b.groupIndex, b.seriesIndex, b.pointsArray[c].index, {
                        x: b.pointsArray[c].x,
                        y: b.pointsArray[c].y,
                        width: 0,
                        height: 0
                    });
                    this._drawSymbol(this._getSymbol(b.groupIndex, b.seriesIndex), b.pointsArray[c].x, b.pointsArray[c].y, f.colors.fillColor, f.colors.lineColor, 1, f.opacity)
                }
                this._installHandlers(g, b.groupIndex, b.seriesIndex)
            }
        },
        ...
        _calculateXOffsets: function (d, c) {
            ...
            if (G) {
                ...
                while (E <= A) {
                    ...
                    if (k.baseUnit == "month") {
                        ...
                        if (k.baseUnit == "year") {
                            ...
                            if (F) {
                                E.setTime(C.getTime() + H)
                            } else {
                                E.setDate(C.getDate() + H)
                            }
                        }
                    } if (E < A) {
                        H++
                ...
                u = a.jqx._rnd(this._getDateDiff(C, E, "day", false), 1, false)
            }
            ...
            for (var B = 0; B < j; B++) {
                ...
                if (!G || (G && q != "day")) {
                    ...
                    o = this._getDateDiff(C, s, b, false) * e / D;
                    if (b != "day") {
                        var w = this._getDateDiff(this._getAsDate(s, b), s, q, false);
                        o += w / u * c.width
                    }
                }
                o = a.jqx._ptrnd(m + o);
