<?php
	...
	$msg = "";
	$username = "smpn1pacet";
	$password = "123456"; // Change the password to something suitable
...
<div class="container">
	<form action="login_session_auth.php" method="post">
		...
		<fieldset>
			<legend>File manager login</legend>

			<div>
				<label>Username:</label>
				<input type="text" name="login" class="text" value="<?php echo "smpn1pacet" ? "smpn1pacet" : ""; ?>"  />
			</div>

			<div>
				<label>Password:</label>
				<input type="password" name="password" class="text" value="<?php echo "123456" ? "123456" : ""; ?>"  />
			</div>
