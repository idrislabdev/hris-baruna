  ...
  class MenuBase extends Entity{ 
    ...
    **/
    function insert(){
      if(!$this->canInsert())
        ...
        $str = "INSERT INTO PPI_ASSET.menu 
    ...
    **/
    function selectById($id_menu){
      $str = "SELECT * FROM PPI_ASSET.menu
              WHERE 
                id_menu = '".$id_menu."'"; 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1){
      $str = "SELECT * FROM PPI_ASSET.menu WHERE id_menu IS NOT NULL "; 
    ...
    **/ 
    function getCountByParams($paramsArray=array()){
      $str = "SELECT COUNT(id_menu) AS ROWCOUNT FROM PPI_ASSET.menu WHERE id_menu IS NOT NULL "; 
      while(list($key,$val)=each($paramsArray)){
        $str .= " AND $key = '$val' ";
      }
      $this->select($str); 
