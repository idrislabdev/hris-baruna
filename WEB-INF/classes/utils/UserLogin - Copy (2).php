...
include_once("../WEB-INF/classes/entities/GroupAccess.php");
  ...
  class UserLogin{
    ...
    function UserLogin(){
		...
		session_register("ssUsr_userAksesPemeliharaan");
    ...
    function emptyUsrSessions(){
		...
		$_SESSION["ssUsr_userAksesPemeliharaan"] = "";
    ...
    function setProps(){
		...
		$this->userAksesPemeliharaan = $_SESSION["ssUsr_userAksesPemeliharaan"];	
    ...
    function verifyUserLogin($usrLogin,$password){			
		...
		if($usr->firstRow()){
			...
			$_SESSION["ssUsr_userAksesPemeliharaan"] = $usr->getField("AKSES_PEMELIHARAAN");	
