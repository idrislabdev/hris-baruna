  ...
  class UserLogin{
    ...
    function verifyUserLogin($usrLogin,$password){			
		...
		if($usr->firstRow()){
			...
			$_SESSION["ssUsr_userAksesPegawai"] = $usr->getField("AKSES_LOGIN_KEPEGAWAIAN");
			$_SESSION["ssUsr_userAksesPenghasilan"] = $usr->getField("AKSES_LOGIN_PENGHASILAN");
			$_SESSION["ssUsr_userPresensi"] = $usr->getField("AKSES_LOGIN_PRESENSI");
			$_SESSION["ssUsr_userAksesKeuangan"] = $usr->getField("AKSES_LOGIN_KEUANGAN");
			$_SESSION["ssUsr_userAksesFixedAsset"] = $usr->getField("AKSES_LOGIN_FIXED_ASSET");
			$_SESSION["ssUsr_userAksesPembayaran"] = $usr->getField("AKSES_LOGIN_PEMBAYARAN");
			$_SESSION["ssUsr_userAksesPengaturan"] = $usr->getField("AKSES_LOGIN_PENGATURAN");
	...
	function retrieveUserInfo(){
		...
		$this->userNPWP = $_SESSION["ssUsr_userNPWP"];
		$this->idLevel = $_SESSION["ssUsr_idLevel"];
		$this->aksesPegawai = $_SESSION["ssUsr_userAksesPegawai"];
		$this->aksesPenghasilan = $_SESSION["ssUsr_userAksesPenghasilan"];
		$this->aksesPresensi = $_SESSION["ssUsr_userPresensi"];
		$this->aksesKeuangan = $_SESSION["ssUsr_userAksesKeuangan"];
		$this->aksesFixedAsset = $_SESSION["ssUsr_userAksesFixedAsset"];
		$this->aksesPembayaran = $_SESSION["ssUsr_userAksesPembayaran"];
		$this->aksesPengaturan = $_SESSION["ssUsr_userAksesPengaturan"];
	}
