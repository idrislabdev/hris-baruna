...
***************************************************************************************************** */
  ...
  ***/
  ...
  class PegawaiStatusPegawai extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function PegawaiStatusPegawai()
	{
      $this->Entity(); 
    }
	...
	function insert()
	{
		...
		$this->setField("PEGAWAI_STATUS_PEGAWAI_ID", $this->getNextId("PEGAWAI_STATUS_PEGAWAI_ID","PPI_SIMPEG.PEGAWAI_STATUS_PEGAWAI"));

		$str = "
				INSERT INTO PPI_SIMPEG.PEGAWAI_STATUS_PEGAWAI (
				   PEGAWAI_STATUS_PEGAWAI_ID, PEJABAT_PENETAP_ID, PEGAWAI_ID, NO_SK, 
				   TMT_SK, TANGGAL_SK, STATUS_PEGAWAI_ID, LAST_CREATE_USER, LAST_CREATE_DATE
				   ) 
 			  	VALUES (
				  ".$this->getField("PEGAWAI_STATUS_PEGAWAI_ID").",
				...
				echo $str;
		$this->id = $this->getField("PEGAWAI_STATUS_PEGAWAI_ID");
		$this->query = $str;
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $order="ORDER BY TMT_SK DESC")
	{
		$str = "
				SELECT 
				   PEGAWAI_STATUS_PEGAWAI_ID, PEGAWAI_ID, PEJABAT_PENETAP_ID, 
				   NO_SK, TMT_SK, TANGGAL_SK, 
				   DEPARTEMEN_ID_LAMA, DEPARTEMEN_ID_BARU
				FROM PPI_SIMPEG.PEGAWAI_STATUS_PEGAWAI
				"; 
