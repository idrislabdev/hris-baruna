	...
	*/	$str .= " GROUP BY PEGAWAI_ID, NRP, NIPP, NAMA, JABATAN, DEPARTEMEN_ID, NO_URUT, STATUS_PEGAWAI_ID, KELAS, JENIS_PEGAWAI_ID, KELOMPOK ".$sOrder;
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $sOrder="")
	{
		$str = "
                ...
                TO_CHAR(TANGGAL_LAHIR, 'DD MONTH YYYY', 'NLS_DATE_LANGUAGE = INDONESIAN') AS TANGGAL_LAHIR_TEK, A.LOKASI_ID, TANGGAL_MASUK  
                FROM PPI_SIMPEG.PEGAWAI A 
    ...
    function selectByParamsGetInfo($paramsArray=array(),$limit=-1,$from=-1, $statement="", $sOrder="")
	{
		$str = "
				...
				TANGGAL_PENSIUN, TANGGAL_MUTASI_KELUAR, TANGGAL_WAFAT, TANGGAL_MPP, NO_MPP, STATUS_KELUARGA_ID, PPI_SIMPEG.AMBIL_JENIS_PEGAWAI_PERIODE(TO_CHAR(SYSDATE, 'MMYYYY'), A.PEGAWAI_ID) JENIS_PEGAWAI_ID, HOBBY, TANGGAL_NPWP, A.NIS, TANGGAL_MASUK  
                FROM PPI_SIMPEG.PEGAWAI A 
                LEFT JOIN PPI_SIMPEG.AGAMA C ON A.AGAMA_ID = C.AGAMA_ID
