	...
	*/	$str .= " GROUP BY PEGAWAI_ID, NRP, NIPP, NAMA, JABATAN, DEPARTEMEN_ID, NO_URUT, STATUS_PEGAWAI_ID, KELAS, JENIS_PEGAWAI_ID, KELOMPOK ".$sOrder;
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $sOrder="")
	{
		$str = "
                ...
                TO_CHAR(TANGGAL_LAHIR, 'DD MONTH YYYY', 'NLS_DATE_LANGUAGE = INDONESIAN') AS TANGGAL_LAHIR_TEK, A.LOKASI_ID, TANGGAL_MASUK  ,BIDANG_STUDI , LINERITAS , SPESIFIKASI_PRESTASI_KARYA , TUGAS_PEMBIMBINGAN  
                FROM PPI_SIMPEG.PEGAWAI A 
