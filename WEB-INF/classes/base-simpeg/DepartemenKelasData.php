...
***************************************************************************************************** */
  ...
  ***/
  ...
  class DepartemenKelasData extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function DepartemenKelasData()
	{
      $this->Entity(); 
    }
 ...
 //    }
	...
	{
		$str = "
				SELECT DEPARTEMEN_ID, SEKOLAH, DEPARTEMEN_KELAS_ID, KELAS
				FROM PPI_SIMPEG.DEPARTEMEN_KELAS_DATA			
				WHERE 1 = 1
			    "; 
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(DEPARTEMEN_ID) AS ROWCOUNT FROM PPI_SIMPEG.DEPARTEMEN_KELAS_DATA
