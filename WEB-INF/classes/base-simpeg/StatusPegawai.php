  ...
  class StatusPegawai extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("STATUS_PEGAWAI_ID", $this->getNextId("STATUS_PEGAWAI_ID","PPI_SIMPEG.STATUS_PEGAWAI")); 		
		$str = "
				INSERT INTO PPI_SIMPEG.STATUS_PEGAWAI (
				   STATUS_PEGAWAI_ID, NAMA, KETERANGAN, LAST_CREATE_USER, LAST_CREATE_DATE)  
 			  	VALUES (
	...
	{
		$str = "
				UPDATE PPI_SIMPEG.STATUS_PEGAWAI
				SET    
	...
	function delete()
	{
        $str = "DELETE FROM PPI_SIMPEG.STATUS_PEGAWAI
                WHERE 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $order="")
	{
		$str = "
				...
				FROM PPI_SIMPEG.STATUS_PEGAWAI
				WHERE 1 = 1
				"; 
		//, FOTO
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(STATUS_PEGAWAI_ID) AS ROWCOUNT FROM PPI_SIMPEG.STATUS_PEGAWAI
