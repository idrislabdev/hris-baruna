	...
	function insert()
	{
		...
		$str = "
				INSERT INTO PPI_SIMPEG.PEGAWAI (
				   ...
				   JAMSOSTEK_NO, JAMSOSTEK_TANGGAL, HOBBY, FINGER_ID, TANGGAL_NPWP, TINGGI, BERAT_BADAN, KTP_NO, TGL_NON_AKTIF
				   ) 
 			  	VALUES (
	...
	*/	$str .= " GROUP BY PEGAWAI_ID, NRP, NIPP, NAMA, JABATAN, DEPARTEMEN_ID, NO_URUT, STATUS_PEGAWAI_ID, KELAS, JENIS_PEGAWAI_ID, KELOMPOK ".$sOrder;
    ...
    function selectByParamsGetInfo($paramsArray=array(),$limit=-1,$from=-1, $statement="", $sOrder="")
	{
		$str = "
				...
				TANGGAL_PENSIUN, TANGGAL_MUTASI_KELUAR, TANGGAL_WAFAT, TANGGAL_MPP, NO_MPP, STATUS_KELUARGA_ID, PPI_SIMPEG.AMBIL_JENIS_PEGAWAI_PERIODE(TO_CHAR(SYSDATE, 'MMYYYY'), A.PEGAWAI_ID) JENIS_PEGAWAI_ID, HOBBY, TANGGAL_NPWP, A.NIS
                FROM PPI_SIMPEG.PEGAWAI A 
                LEFT JOIN PPI_SIMPEG.AGAMA C ON A.AGAMA_ID = C.AGAMA_ID
