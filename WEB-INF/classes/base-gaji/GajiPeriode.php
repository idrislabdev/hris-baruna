...
***************************************************************************************************** */
  ...
  ***/
  ...
  class GajiPeriode extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function GajiPeriode()
	{
      $this->Entity(); 
    }
	...
	function insert()
	{
		...
		$this->setField("GAJI_PERIODE_ID", $this->getNextId("GAJI_PERIODE_ID","PPI_GAJI.GAJI_PERIODE")); 
		$str = "
				INSERT INTO PPI_GAJI.GAJI_PERIODE(
				   GAJI_PERIODE_ID, PERIODE) 
 			  	VALUES (
				  ".$this->getField("GAJI_PERIODE_ID").",
				  '".$this->getField("PERIODE")."'
				)"; 
		$this->id = $this->getField("GAJI_PERIODE_ID");
		$this->query = $str;
    ...
    **/ 
    ...
    function getPeriodeAkhir()
	{
		$str = "
				...
				GAJI_PERIODE_ID, PERIODE
				FROM PPI_GAJI.GAJI_PERIODE
				WHERE 1 = 1 ORDER BY GAJI_PERIODE_ID DESC
				"; 
		$this->select($str);
		if($this->firstRow()) 
