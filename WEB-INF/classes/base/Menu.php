  ...
  class Menu extends Entity{ 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $akses_adm_intranet_id="", $table="", $order="ORDER BY A.MENU_ID ASC")
	{
		$str = "
                SELECT 
				A.MENU_ID, MENU_PARENT_ID, MENU_GROUP_ID, A.NAMA MENU, KETERANGAN, LINK_FILE, NVL(B.AKSES, 'A') AKSES, C.NAMA , AMBIL_MENU(A.MENU_ID) MENU_LENGKAP
				FROM MENU A 
	...
	{
		$str = "
				SELECT A.MENU_ID, NAMA, NVL(LINK_FILE, '#') LINK_FILE, AKSES,
