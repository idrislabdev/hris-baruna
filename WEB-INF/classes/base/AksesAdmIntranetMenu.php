...
***************************************************************************************************** */
  ...
  ***/
  ...
  class AksesAdmIntranetMenu extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function AksesAdmIntranetMenu()
	{
      $this->Entity(); 
    }
	...
	function insert()
	{
		...
		$this->setField("AKSES_ADM_INTRANET_MENU_ID", $this->getNextId("AKSES_ADM_INTRANET_MENU_ID","AKSES_ADM_INTRANET_MENU")); 
		$str = "
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		$str = "
				SELECT 
				AKSES_ADM_INTRANET_MENU_ID, AKSES_ADM_INTRANET_ID, MENU_ID, AKSES
				FROM AKSES_ADM_INTRANET_MENU		
				WHERE 1 = 1
				"; 
		...
		$str .= $statement." ORDER BY AKSES_ADM_INTRANET_MENU_ID DESC";
		$this->query = $str;
	...
	function selectByParamsLike($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		...
		$this->query = $str;
		$str .= $statement." ORDER BY AKSES_ADM_INTRANET_MENU_ID ASC";
		return $this->selectLimit($str,$limit,$from); 
    }	
    /** 
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(AKSES_ADM_INTRANET_MENU_ID) AS ROWCOUNT FROM AKSES_ADM_INTRANET_MENU WHERE AKSES_ADM_INTRANET_MENU_ID IS NOT NULL ".$statement; 
