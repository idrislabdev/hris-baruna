  ...
  ***/
  ...
  class KontrakTowing extends Entity{ 
	...
	function insert()
	{
		...
		$str = "
				INSERT INTO PPI_OPERASIONAL.KONTRAK_TOWING (
				   ...
				   LAST_CREATE_USER, LAST_CREATE_DATE, PROSENTASE_PREMI, SATUAN, LOKASI_ID, TANGGAL_AWAL, TANGGAL_AKHIR, TANGGAL_TANDA_TANGAN, DOKUMEN_ID) 
 			  	VALUES (
    ...
    **/ 
	...
	{
		$str = "
				  SELECT A.KONTRAK_TOWING_ID, A.LOKASI_ID, B.NAMA LOKASI, DOKUMEN_ID,
