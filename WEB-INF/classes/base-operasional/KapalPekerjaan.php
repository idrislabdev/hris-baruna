  ...
  ***/
  ...
  class KapalPekerjaan extends Entity{ 
	...
	function insert()
	{
		...
		$str = "
				INSERT INTO PPI_OPERASIONAL.KAPAL_PEKERJAAN (
				   ...
				   LAST_CREATE_USER, LAST_CREATE_DATE, KAPAL_PEKERJAAN_DITANGANI_ID, PROSENTASE_PREMI, DOKUMEN_ID) 
 			  	VALUES (
    ...
    **/ 
	...
	{
		$str = "
				  SELECT A.KAPAL_PEKERJAAN_ID, A.KAPAL_ID, C.NAMA KAPAL_NAMA, A.LOKASI_ID, B.NAMA LOKASI_NAMA, NO_KONTRAK, A.NAMA, DOKUMEN_ID,
