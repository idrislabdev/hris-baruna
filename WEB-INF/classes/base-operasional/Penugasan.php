  ...
  ***/
  ...
  class Penugasan extends Entity{ 
	...
	function insert()
	{
		...
		$str = "
				INSERT INTO PPI_OPERASIONAL.PENUGASAN (
				   ...
				   LAST_CREATE_USER, LAST_CREATE_DATE, PROSENTASE_PREMI, TANGGAL_AWAL_REALISASI, TANGGAL_AKHIR_REALISASI, LOKASI_ID, MIL, DOKUMEN_ID) 
 			  	VALUES (
    ...
    **/ 
	...
	{
		$str = "
				  SELECT A.PENUGASAN_ID, A.KAPAL_ID, C.NAMA KAPAL_NAMA, A.KETERANGAN, NOMOR, A.NAMA, A.LOKASI_ID, B.NAMA LOKASI, DOKUMEN_ID,
