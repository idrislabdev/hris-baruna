...
***************************************************************************************************** */
  ...
  ***/
  ...
  class DaftarJagaKapalReal extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$str = "
				INSERT INTO PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI (
	...
	{
		$str = "
				UPDATE PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI
				SET    
	...
	function delete()
	{
        $str = "DELETE FROM PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI
                WHERE 
                  KAPAL_ID = ".$this->getField("KAPAL_ID")."
				  AND TO_CHAR(TANGGAL, 'MMYYYY') = '".$this->getField("PERIODE")."' "; 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $order="ORDER BY NAMA ASC")
	{
		$str = "
                ...
                FROM PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI A LEFT JOIN PPI_OPERASIONAL.LOKASI B 
	   ...
	   function selectByParamsHeader($paramsArray=array(),$limit=-1,$from=-1, $statement="", $order="ORDER BY NAMA ASC")
		{
			$str = "
					...
					from PPI_operasional.KRU_JADWAL_PIKET_REALISASI a, PPI_operasional.kapal b
	...
	function selectByParamsLike($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		$str = "	
                ...
                FROM PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI A INNER JOIN PPI_OPERASIONAL.LOKASI B 
                ON A.LOKASI_ID = B.LOKASI_ID
                WHERE 0=0
	...
	{
		$str = "SELECT COUNT(PKT_ID) AS ROWCOUNT FROM PPI_OPERASIONAL.KRU_JADWAL_PIKET_REALISASI
		        WHERE 0=0 ".$statement; 
	...
	function callLoadRencana($periode)
	{

        $str = "CALL PPI_OPERASIONAL.LOAD_RENCANA_PIKET_KAPAL('". $periode ."')";
