...
$kbbt_jur_bb_tmp->setField("", $reqValutaNama);
...
$kbbt_jur_bb_tmp->setField("", $reqNoPosting);
...
{	
	...
	$kbbt_jur_bb_tmp->setField("TIPE_TRANS", "JRR-KBB-06");
	...
	$kbbt_jur_bb_tmp->setField("TGL_VALUTA", dateToDBCheck($reqTanggalTransaksi));
	...
	$kbbt_jur_bb_tmp->setField("NOREK_BANK", "");
	$kbbt_jur_bb_tmp->setField("NO_CEK_NOTA", "");
	$kbbt_jur_bb_tmp->setField("NO_POSTING", $reqNoPosting);
