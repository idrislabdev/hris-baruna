...
<head>
	...
	<script type="text/javascript">
			  $('#btnCetak').live('click', function () {
				newWindow = window.open('report_sppd_rpt.php?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqNama1='+ $("#reqNama1").val()+'&reqJabatan1='+ $("#reqJabatan1").val()+'&reqNama2='+ $("#reqNama2").val()+'&reqJabatan2='+ $("#reqJabatan2").val(), 'Cetak');
				newWindow.focus();
