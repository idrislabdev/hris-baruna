...
$aColumnsAlias = array("A.NO_NOTA", "A.NO_NOTA", "NO_REF3", "TGL_TRANS", "NM_AGEN_PERUSH", "KD_VALUTA", "KURS_VALUTA", "JML_RP_TRANS", "A.NO_POSTING", "TGL_POSTING", "KET_TAMBAH");
...
$allRecord = $kbbt_jur_bb->getCountByParams(array("A.KD_SUBSIS"=>"KUT", "JEN_JURNAL" => "JPB"), $statement);
...
if($_GET['sSearch'] == "")
	...
	$allRecordFilter = $kbbt_jur_bb->getCountByParams(array("A.KD_SUBSIS"=>"KUT", "JEN_JURNAL" =>  "JPB"), $statement.$searchJson);

$kbbt_jur_bb->selectByParams(array("A.KD_SUBSIS"=>"KUT", "JEN_JURNAL" => "JPB"), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);        		
