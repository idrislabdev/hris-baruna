...
$reqKdPengganti = $_POST["reqKdPengganti"];
...
$kptt_nota->setField('TIPE_TRANS', "JRR-KPT-02");
$kptt_nota->setField('NO_NOTA', $reqNoBukti);
...
if($kptt_nota->insert())
{
	...
	{
		$arrPengganti = explode("-", $reqKdPengganti[$i]);
		$reqPengganti = $arrPengganti[0];
		$reqNotaPengganti = $arrPengganti[1];
		...
		$kptt_nota_d->setField('NO_REF2', $reqPengganti);
		$kptt_nota_d->setField('NO_REF3', $reqNoRef3);
		$kptt_nota_d->setField('REF_PEMBATALAN', $reqNotaPengganti);
		...
		$kptt_nota_d->setField('SISA', dotToNo($reqSisaBayar[$i]));
		...
		$kptt_nota_d_update->setField("NO_REF_PELUNASAN", $reqNoRef3);
		$kptt_nota_d_update->setField('KD_SUB_BANTU', $reqNoPpkb[$i]);		
		$kptt_nota_d_update->updateBatalPelunasanKarenaDiganti();
		
		unset($kptt_nota_d_update);
		$kptt_nota_d_update = new KpttNotaD();
		
		$kptt_nota_d_update->setField("NO_REF_PELUNASAN", $reqNoBukti);
		$kptt_nota_d_update->setField("NO_NOTA", $reqNotaPengganti);
		$kptt_nota_d_update->setField('KD_SUB_BANTU', $reqPengganti);		
	...
	$kptt_nota_d_update->updateBatalPelunasanKoreksi();
