...
$allRecord = $pajak->getCountByParamsPph15(array("THN_BUKU || BLN_BUKU" => $reqPeriode));
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else	
	$allRecordFilter = $pajak->getCountByParamsPph15(array("THN_BUKU || BLN_BUKU" => $reqPeriode), " AND (UPPER(JKM) LIKE '%".strtoupper($_GET['sSearch'])."%')");

$pajak->selectByParamsPph15(array("THN_BUKU || BLN_BUKU" => $reqPeriode), $dsplyRange, $dsplyStart, " AND (UPPER(JKM) LIKE '%".strtoupper($_GET['sSearch'])."%')",$sOrder);
