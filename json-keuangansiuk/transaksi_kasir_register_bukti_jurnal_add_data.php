...
$reqJKM= httpFilterPost("reqJKM");
$reqNoJKM= httpFilterPost("reqNoJKM");
$reqJKK= httpFilterPost("reqJKK");
$reqNoJKK= httpFilterPost("reqNoJKK");
$reqValutaNama= httpFilterPost("reqValutaNama");
$reqNoDokumen= httpFilterPost("reqNoDokumen");
$reqNoDokumenLain= httpFilterPost("reqNoDokumenLain");
...
{
	$reqTipeTrans = ("JKM-KBB-01");
}
else
{
	$reqTipeTrans = ("JKK-KBB-01");
}
...
{	
	...
	$kbbt_jur_bb->setField("TIPE_TRANS", $reqTipeTrans);
	$kbbt_jur_bb->setField("NO_NOTA", $reqNoDokumen);
	$kbbt_jur_bb->setField("JEN_JURNAL", $reqNoDokumenLain);
	$kbbt_jur_bb->setField("NO_REF1", "");
	$kbbt_jur_bb->setField("NO_REF2", "");
	$kbbt_jur_bb->setField("NO_REF3", "");
