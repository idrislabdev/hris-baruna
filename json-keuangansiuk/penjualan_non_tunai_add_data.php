...
if($reqMode == "insert")
{
	...
	$kptt_nota->setField('NO_NOTA', $reqNoValuta);
	...
	$kptt_nota->setField('JML_RP_TRANS', dotToNo($reqJumlahTagihan));
	$kptt_nota->setField('TANDA_TRANS', "+");
	$kptt_nota->setField('KD_BB_PAJAK1', "");
	$kptt_nota->setField('PPN1_PERSEN', $reqKursPajak);	
	...
	$kptt_nota->setField('JML_VAL_BAYAR', dotToNo($reqJumlahTagihan));	
	$kptt_nota->setField('SISA_VAL_BAYAR', "");
	$kptt_nota->setField('KD_BANK', $reqKodeBank);
	$kptt_nota->setField('REK_BANK', $reqBank);
	...
	$kptt_nota->setField('KURS_VAL_PAJAK', $reqKursPajak);
	
	if($kptt_nota->insert())
		echo $reqNoValuta."-Data berhasil disimpan.";
