...
{	
	...
	$kptt_nota = new KpttNota();
	$kptt_nota->setField("NO_NOTA_JPJ", $reqNoPpkb[0]);
...
$kptt_nota->setField('TIPE_TRANS', "JRR-KPT-03");
$kptt_nota->setField('NO_NOTA', $reqNoBukti);
...
if($kptt_nota->insert())
{
	for($i=0; $i<count($reqNoPpkb); $i++)
	{
		...
		$kptt_nota_d->setField('TIPE_TRANS', "JRR-KPT-03");
		$kptt_nota_d->setField('NO_NOTA', $reqNoBukti);
		...
		$kptt_nota_d->setField('PROGRAM_NAME', "KPTT_EKAS_PELUNASAN_UTIP_IMAIS");
