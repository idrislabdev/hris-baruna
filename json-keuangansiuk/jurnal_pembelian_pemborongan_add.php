...
if($reqNoBukti == "")	
	$reqNoBukti = $kbbt_jur_bb->getKode("JPB", dateToDBCheck($reqTanggalTransaksi));
else
{	
...
$kbbt_jur_bb->setField("KD_SUBSIS", "KUT");
$kbbt_jur_bb->setField("TIPE_TRANS", "KUT-JPB-01");
$kbbt_jur_bb->setField("NO_NOTA", $reqNoBukti);
$kbbt_jur_bb->setField("JEN_JURNAL", "JPB");
...
$kbbt_jur_bb->setField("PROGRAM_NAME", "KUT_ENTRY_JUR_JPB_IMAIS");
...
if($kbbt_jur_bb->insert())
{
	...
	{			   
		...
		if(substr($reqBukuBesar[$i], 0, 3) == "110")
			$klas_trans = "PERSEDIAAN";
		else
			$klas_trans = "HUTANG";
		...
		$kbbt_jur_bb_d->setField('KD_SUBSIS', "KUT");
		$kbbt_jur_bb_d->setField('KD_JURNAL', "JPB");
		$kbbt_jur_bb_d->setField('TIPE_TRANS', "KUT-JPB-01");
		...
		$kbbt_jur_bb_d->setField('PROGRAM_NAME', "KBB_ENTRY_JUR_JPB_IMAIS");
