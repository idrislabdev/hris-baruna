...
$kptt_nota->setField('TIPE_TRANS', "JRR-KPT-22");
$kptt_nota->setField('NO_NOTA', $reqNoBukti);
...
if($kptt_nota->insert())
{
	...
	{
		if($reqKdPengganti[$i] == $reqNoPpkb[$i])
		{}
		else
		{
			$kptt_nota_d = new KpttNotaD();
			...
			$kptt_nota_d->setField('TIPE_TRANS', "JRR-KPT-22");
			$kptt_nota_d->setField('NO_NOTA', $reqNoBukti);
			...
			$kptt_nota_d->setField('KD_SUB_BANTU', $reqKdPengganti[$i]);	
