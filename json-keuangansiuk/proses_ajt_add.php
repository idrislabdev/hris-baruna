...
$kbbt_jur_bb->setField("PROGRAM_NAME", "KBB_ENTRY_JUR_JRR_AJT_IMAIS");
...
if($kbbt_jur_bb->insert())
{
	...
	{			   
		...
		$kbbt_jur_bb_d->setField('TIPE_TRANS', "JRR-KBB-14");
		...
		$kbbt_jur_bb_d->setField('PROGRAM_NAME', "KBB_ENTRY_JUR_JRR_AJT_IMAIS");
