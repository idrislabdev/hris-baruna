...
{	
	...
	$kptt_nota->setField('JML_VAL_TRANS', dotToNo(""));
	$kptt_nota->setField('JML_RP_TRANS', dotToNo(""));
	...
	$kptt_nota->setField('JML_VAL_BAYAR', dotToNo(""));	
