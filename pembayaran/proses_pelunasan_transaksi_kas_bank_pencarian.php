...
$namaPelanggan = $safm_pelanggan->getPelanggan(array("MPLG_KODE" => $reqId));
...
<title>pelanggan pencarian</title>
...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-pembayaran/proses_pelunasan_transaksi_kas_bank_pencarian_json.php?reqId=<?=$reqId?>&reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  var anSelectedId = '';
			  var anSelectedNama = '';
			  var anSelectedAlamat = '';
			  var anSelectedNPWP = '';
			  var anSelectedPosition = '';	
			  var anSelectedBadanUsaha = '';
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedKasId = element[1];
					  anSelectedKas = element[2];
					  anSelectedTgl = element[3];
					  anSelectedTagihan = element[4];
					  anSelectedJenis = element[5];
					  anSelectedPeriode = element[7];
					  anSelectedBB = element[9];
			  });
			  
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPPKB(anSelectedId, anSelectedKasId, anSelectedKas, anSelectedTgl, anSelectedPeriode, anSelectedBB, anSelectedTagihan, anSelectedJenis, '<?=$namaPelanggan?>');	
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data Transaksi <?=$namaPelanggan?></span>
            </div>            
            </td>
            <td style="text-align:right;">
            <span><b>Apabila data tidak muncul, Posting JPJ terlebih dahulu!</b></span>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    ...
    <thead>
        <tr>	
            ...
            <th width="70px">id</th>  
            <th width="20px"></th>  
            <th width="70px">No.&nbsp;Nota</th>  
            <th width="70px">Tgl Trans</th>  
            <th width="170px">Kelas</th>       
			<th width="70px">Kode Piutang</th>
            <th width="70px">Tagihan</th>
            <th width="70px">Sisa&nbsp;Tagihan</th>
        </tr>
    </thead>
    </table> 
    </div> 
