...
if ($userLogin->checkUserLogin()) { 
	...
	if ($userLogin->aksesPembayaran == 'NO') { 
			...
			array(
			  ...
			  "accordion_content" => 
				array(
					array(
						"nama" => "Pembayaran",
						"link" => "pembayaran_spp.php"
					),
					array(
						"nama" => "Uang Titipan",
						"link" => "pembayaran_titipan.php"
					),
					array(
						"nama" => "Posting Jurnal",
						"link" => "pembayaran_spp_posting.php"
                    ),
                    array(
						"nama" => "Jurnal Pembayaran",
						"link" => "../keuangan/proses_pelunasan_kas_tunai.php"
					),
                    array(
						"nama" => "Koreksi Pembayaran",
						"link" => "pembayaran_koreksi.php"
					)
				)
			),
			array(
				...
				"accordion_content" => 
				  	array(
						array(
							"nama" => "Rekap Pembayaran",
							"link" => "pembayaran_spp_report.php"
						)
				  	)
			  	),
			);
