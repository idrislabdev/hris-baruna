...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-pembayaran/pembayaran_spp_json.php?reqMode=view&reqTanggalAwal=<?=$reqTanggalAwal?>&reqTanggalAkhir=<?=$reqTanggalAkhir?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					...
					{
						$.getJSON('../json-pembayaran/hapus_data_json.php?reqSource=KOREKSI&reqId='+anSelectedId,
						function(data){
							if(data.HASIL == 1)
							{
								alert('Data berhasil dihapus.');
								oTable.fnReloadAjax("../json-pembayaran/pembayaran_spp_json.php?reqMode=view");
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnEdit" title="Edit">Koreksi</a>
            </li>        
        </ul>
    </div>
