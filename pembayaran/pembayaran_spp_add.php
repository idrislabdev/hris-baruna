...
<head>
	...
	<script type="text/javascript">
			...
			$('#ff').form({
				...
				success:function(data){
					...
					{		
						...
						document.location.href = 'pembayaran_spp_add.php?reqId='+data.id;
		...
		function OptionSetPPKB(anSelectedId, anSelectedKasId, anSelectedKas, anSelectedTgl, anSelectedPeriode, anSelectedBB, anSelectedTagihan, anSelectedJenis, anSelectedNama){

			
			$("#reqNoRef2").val(anSelectedJenis);
			...
			$("#reqKeterangan").val("Pembayaran "+ anSelectedJenis +" " + anSelectedId + " Periode " + anSelectedPeriodeArr[1] + " " + anSelectedPeriodeArr[2]);
			...
			var isi = `
              ...
              <tr id="node-<?=$i?>">
                  ...
                  <td>
                    <input type="text" name="reqJumlahBayar[]"  style="text-align:right;"  id="reqJumlahBayar<?=$checkbox_index?>"  OnFocus="FormatAngka('reqJumlahBayar<?=$checkbox_index?>')" OnKeyUp="FormatUang('reqJumlahBayar<?=$checkbox_index?>'); hitungJumlahTotal();" OnBlur="FormatUang('reqJumlahBayar<?=$checkbox_index?>')"  value="`+anSelectedTagihan+`">
                  </td>
                  <td align="center">
                  <label>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
            	...
            	<input id="reqNoRef2" name="reqNoRef2" style="width:140px; background-color:#f0f0f0"  value="<?=$reqNoRef2?>" readonly/>
                &nbsp;          
            </td>
