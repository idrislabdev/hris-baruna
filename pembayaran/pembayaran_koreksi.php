...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-pembayaran/pembayaran_koreksi_json.php?reqTanggalAwal=<?=$reqTanggalAwal?>&reqTanggalAkhir=<?=$reqTanggalAkhir?>",			  
	...
	{
 		oTable.fnReloadAjax("../json-pembayaran/pembayaran_koreksi_json.php");
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Koreksi Transaksi Pembayaran </span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pembayaran_koreksi_add.php?reqMode=insert', 'Office Management - Aplikasi Pembayaran', '600', '300');" title="Tambah">Tambah</a>
            </li>        
        </ul>
    </div>
