...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-pembayaran/pembayaran_titipan_json.php?reqTanggalAwal=<?=$reqTanggalAwal?>&reqTanggalAkhir=<?=$reqTanggalAkhir?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnView').on('click', function () {
			   ...
			   $('#btnCetak').on('click', function () {
				   if(anSelectedData == "")
						return false;	
						  window.parent.OpenDHTML('invoice_titipan_pdf.php?reqNoBukti='+ anSelectedId, 'Office Management - Aplikasi Pembayaran', '600', '300');				  
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedNoPosting == '')
				  	window.parent.OpenDHTML('pembayaran_titipan_add.php?reqMode=update&reqId='+anSelectedId, 'Office Management - Aplikasi Pembayaran', '600', '300');
			  	  else
							...
							if(data.HASIL == 1)
							{
								alert('Data berhasil dihapus.');
									...
									var selesai = $('#reqTanggalAkhir').datebox('getValue');
							 		...
							 		oTable.fnReloadAjax("../json-pembayaran/pembayaran_titipan_json.php?reqTanggalAwal=" + mulai + "&reqTanggalAkhir=" + selesai);
			  ...
			  $("#reqPeriode").change(function() { 
				 oTable.fnReloadAjax("../json-pembayaran/pembayaran_titipan_json.php?reqPeriode="+ $("#reqPeriode").val());
...
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Transaksi Uang Titipan </span>
            </div>            
            </td>
        </tr>
    </table>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(../WEB-INF/css/media/bluetab.gif);">    
        <ul>
            <li>
            <a href="#" id="btnAdd" onClick="window.parent.OpenDHTML('pembayaran_titipan_add.php?reqMode=insert', 'Office Management - Aplikasi Pembayaran', '600', '300');" title="Tambah">Tambah</a>
