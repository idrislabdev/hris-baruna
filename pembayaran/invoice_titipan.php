...
<table style="width: 80%;" align="center">
	<tr>
      ...
      <td align="center">
        	<h2 style="margin-bottom: 0px;">SURAT TANDA BUKTI UANG TITIPAN</h2>
...
<table style="width: 80%;" align="center">
  ...
  <?
  if(!empty($kptt_nota_spp->getField("DEPARTEMEN_KELAS")))
  {
  ?>
	<tr>
    	<td style="width: 180px;">Unit Sekolah</td>
        <td style="width: 10px;">:</td>
        <td colspan="2"><span><?=strtoupper($kptt_nota_spp->getField("DEPARTEMEN_KELAS"))?></span></td>
        <td>&nbsp;</td>
    </tr>
  <?
  }
