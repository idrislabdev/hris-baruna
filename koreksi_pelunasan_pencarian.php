...
<style type="text/css" media="screen">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "../json-keuangansiuk/koreksi_pelunasan_pencarian_json.php?reqId=<?=$reqId?>&reqKdValuta=<?=$reqKdValuta?>",
			...
			/* Click event handler */
			  ...
			  $('#example tbody').on( 'click', 'tr', function () {
					if ( $(this).hasClass('selected') ) {
					  ...
					  anSelectedKdBank = element[1];
					  anSelectedBbBank = element[2];
			  ...
			  $('#btnPilih').on('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSetPembayaran(anSelectedId, anSelectedKdBank, anSelectedBbBank, anSelectedNama);	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <div id="judul-halaman">
                <span><img src="../WEB-INF/images/panah-judul.png"> Data JKM Pelunasan</span>
            </div>            
            </td>
            <td style="text-align:right;">
            <span><b>Apabila data tidak muncul, artinya JKM Pelunasan belum diposting</b></span>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
